...
namespace Loqui.Generation
{
    public class Array2DType : ContainerType
    {
        ...
        {
            fg.AppendLine($"{accessorPrefix}.{this.GetName(protectedMembers, false)}.SetTo({rhsAccessorPrefix}.{this.Name}{(this.isLoquiSingle ? ".Select((s) => s.Copy())" : string.Empty)}, {cmdsAccessor});");
        }
