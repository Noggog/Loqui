...
namespace Loqui.Generation
{
    public class LoquiType : PrimitiveType
    {
            ...
            string defaultFallbackAccessor)
        {
            ...
            {
                using (var args = new ArgsWrapper(fg,
                    $"{this._TargetObjectGeneration.CommonClassName(LoquiInterfaceType.ISetter, MaskType.Normal, MaskType.Copy)}{this.GetGenericTypes(getter: false, MaskType.Normal, MaskType.Copy)}.CopyFieldsFrom"))
                {
        ...
        public override void GenerateForInterface(FileGeneration fg, bool getter, bool internalInterface)
        {
            if (getter)
            {
                fg.AppendLine($"{this.TypeName(getter: true)} {this.Name} {{ get; }}");
