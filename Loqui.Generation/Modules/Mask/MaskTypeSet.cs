...
namespace Loqui.Generation
{
    public class MaskTypeSet : IEquatable<MaskTypeSet>
    {
        ...
        public MaskTypeSet(LoquiInterfaceType interfaceType, IEnumerable<MaskType> types, bool acceptAll)
        {
        ...
        public bool Applicable(LoquiInterfaceType interfaceType, params MaskType[] maskTypes)
        {
