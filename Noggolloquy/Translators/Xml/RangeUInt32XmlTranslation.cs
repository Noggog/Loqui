...
{
    public class RangeUInt32XmlTranslation : TypicalXmlTranslation<RangeUInt32>
    {
        public readonly static RangeUInt32XmlTranslation Instance = new RangeUInt32XmlTranslation();
        public const string MIN = "Min";
        public const string MAX = "Max";

        protected override bool WriteValue(XmlWriter writer, string name, RangeUInt32? item, bool doMasks, out object maskObj)
        {
            maskObj = null;
