...
{
    #region Class
    public partial class TestObject_ReadOnly : 
        ITestObject_ReadOnly,
        ILoquiObject<TestObject_ReadOnly>,
        ILoquiObjectSetter,
        IEquatable<TestObject_ReadOnly>
    {
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.BoolN] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.Bool] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.CharN] = false;
            CharN = default(Char?);
        }
        #endregion
        #region Char
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.Char] = false;
            Char = default(Char);
        }
        #endregion
        #region DateTimeNull
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.DateTimeNull] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.DateTime] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.DoubleN] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.Double] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.FloatN] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.Float] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.Int16N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.Int16] = false;
            Int16 = default(Int16);
        }
        #endregion
        #region Int16_Ranged
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.Int32N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.Int32] = false;
            Int32 = default(Int32);
        }
        #endregion
        #region Int32_Ranged
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.Int64N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.Int64] = false;
            Int64 = default(Int64);
        }
        #endregion
        #region Int64_Ranged
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.Int8N] = false;
            Int8N = default(SByte?);
        }
        #endregion
        #region Int8N_Ranged
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.Int8] = false;
            Int8 = default(SByte);
        }
        #endregion
        #region Int8_Ranged
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.Unsafe] = false;
            Unsafe = default(bool);
        }
        #endregion
        #region UnsafeLoqui
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.UnsafeLoqui] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.UnsafeNull] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.P2IntN] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.P2Int] = false;
            P2Int = default(P2Int);
        }
        #endregion
        #region P3DoubleN
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.P3DoubleN] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.P3Double] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.P3IntN] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.P3Int] = false;
            P3Int = default(P3Int);
        }
        #endregion
        #region PercentN
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.PercentN] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.Percent] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.RangeInt8N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.RangeInt8] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.RangeInt16N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.RangeInt16] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.RangeInt32N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.RangeInt32] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.RangeInt64N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.RangeInt64] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.RangeUInt8N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.RangeUInt8] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.RangeUInt16N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.RangeUInt16] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.RangeUInt32N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.RangeUInt32] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.RangeUInt64N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.RangeUInt64] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.String] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.FilePath] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.FilePathNull] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.DirectoryPath] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.DirectoryPathNull] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.UDoubleN] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.UDouble] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.UInt16N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.UInt16] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.UInt32N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.UInt32] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.UInt64N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.UInt64] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.UInt8N] = false;
            UInt8N = default(Byte?);
        }
        #endregion
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.UInt8] = false;
            UInt8 = default(Byte);
        }
        #endregion
        #region UInt8_Ranged
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.Enum] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_ReadOnly_FieldIndex.EnumNull] = false;
        ...
        Object ITestObject_ReadOnlyGetter.WildCardLoqui => this.WildCardLoqui;
        #endregion
        #region WildCardNull
        ...
        Object ITestObject_ReadOnlyGetter.WildCardNull => this.WildCardNull;
        #endregion
        #region Ref
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IObservableSetList<Boolean> ITestObject_ReadOnlyGetter.List => _List;
        #endregion
        ...
        #region Interface Members
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IObservableSetList<ObjectToRef> ITestObject_ReadOnlyGetter.RefList => _RefList;
        #endregion
        ...
        #region Interface Members
        IObservableSetCache<ObjectToRef, Int32> ITestObject_ReadOnlyGetter.DictKeyedValue => _DictKeyedValue;
        #endregion
        ...
        IMask<bool> IEqualsMask<TestObject_ReadOnly>.GetEqualsMask(TestObject_ReadOnly rhs, EqualsMaskHelper.Include include) => TestObject_ReadOnlyCommon.GetEqualsMask(this, rhs, include);
        IMask<bool> IEqualsMask<ITestObject_ReadOnlyGetter>.GetEqualsMask(ITestObject_ReadOnlyGetter rhs, EqualsMaskHelper.Include include) => TestObject_ReadOnlyCommon.GetEqualsMask(this, rhs, include);
        #region To String
        public override string ToString()
        {
            return TestObject_ReadOnlyCommon.ToString(this, printMask: null);
        }

        public string ToString(
            string name = null,
            TestObject_ReadOnly_Mask<bool> printMask = null)
        {
            return TestObject_ReadOnlyCommon.ToString(this, name: name, printMask: printMask);
        }
        ...
        public void ToString(
            ...
            string name = null)
        {
            TestObject_ReadOnlyCommon.ToString(this, fg, name: name, printMask: null);
        }

        #endregion

        IMask<bool> ILoquiObjectGetter.GetHasBeenSetMask() => this.GetHasBeenSetMask();
        public TestObject_ReadOnly_Mask<bool> GetHasBeenSetMask()
        {
            return TestObject_ReadOnlyCommon.GetHasBeenSetMask(this);
        }
        ...
        public static TestObject_ReadOnly Create_Xml(
            XElement node,
            TestObject_ReadOnly_TranslationMask translationMask = null)
        {
            return Create_Xml(
                node: node,
                errorMask: null,
            ...
            TestObject_ReadOnly_TranslationMask translationMask = null)
        {
            ...
            var ret = Create_Xml(
                ...
                translationMask: translationMask.GetCrystal());
            errorMask = TestObject_ReadOnly_ErrorMask.Factory(errorMaskBuilder);
            return ret;
        }
            ...
            TranslationCrystal translationMask)
        {
            ...
            try
            {
                foreach (var elem in node.Elements())
                {
                    ...
                    TestObject_ReadOnlyCommon.FillPublicElement_Xml(
                        item: ret,
                        node: elem,
                        name: elem.Name.LocalName,
                        errorMask: errorMask,
        ...
        protected void CopyIn_Xml_Internal(
            ...
            NotifyingFireParameters cmds = null)
        {
            LoquiXmlTranslation<TestObject_ReadOnly>.Instance.CopyIn(
                node: node,
                item: this,
                skipProtected: true,
                errorMask: errorMask,
        ...
        public void CopyIn_Xml(
            string path,
            out TestObject_ReadOnly_ErrorMask errorMask,
            TestObject_ReadOnly_TranslationMask translationMask,
            NotifyingFireParameters cmds = null,
            bool doMasks = true)
        {
            var node = XDocument.Load(path).Root;
            ...
            TranslationCrystal translationMask)
        {
            ...
            {
                case "ByteArray":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.ByteArray) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.ByteArray);
                    ...
                    break;
                case "ByteArrayNull":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.ByteArrayNull) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.ByteArrayNull);
                            if (ByteArrayXmlTranslation.Instance.Parse(
                                node: node,
                ...
                case "ByteArrayNotNull":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.ByteArrayNotNull) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.ByteArrayNotNull);
                            if (ByteArrayXmlTranslation.Instance.Parse(
                                node: node,
                ...
                case "ByteArraySingleton":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.ByteArraySingleton) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.ByteArraySingleton);
                            if (ByteArrayXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "BoolN":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.BoolN) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.BoolN);
                    ...
                    break;
                case "Bool":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Bool) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.Bool);
                            if (BooleanXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "CharN":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.CharN) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.CharN);
                    ...
                    break;
                case "Char":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Char) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.Char);
                            if (CharXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "DateTimeNull":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.DateTimeNull) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.DateTimeNull);
                    ...
                    break;
                case "DateTime":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.DateTime) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.DateTime);
                            if (DateTimeXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "DoubleN":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.DoubleN) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.DoubleN);
                    ...
                    break;
                case "DoubleN_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.DoubleN_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.DoubleN_Ranged);
                            if (DoubleXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Double":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Double) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.Double);
                            if (DoubleXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Double_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Double_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.Double_Ranged);
                            if (DoubleXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "FloatN":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.FloatN) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.FloatN);
                    ...
                    break;
                case "FloatN_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.FloatN_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.FloatN_Ranged);
                            if (FloatXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Float":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Float) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.Float);
                            if (FloatXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Float_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Float_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.Float_Ranged);
                            if (FloatXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Int16N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int16N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.Int16N);
                    ...
                    break;
                case "Int16N_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int16N_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.Int16N_Ranged);
                            if (Int16XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Int16":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int16) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.Int16);
                            if (Int16XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Int16_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int16_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.Int16_Ranged);
                            if (Int16XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Int32N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int32N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.Int32N);
                    ...
                    break;
                case "Int32N_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int32N_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.Int32N_Ranged);
                            if (Int32XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Int32":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int32) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.Int32);
                            if (Int32XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Int32_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int32_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.Int32_Ranged);
                            if (Int32XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Int64N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int64N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.Int64N);
                    ...
                    break;
                case "Int64N_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int64N_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.Int64N_Ranged);
                            if (Int64XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Int64":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int64) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.Int64);
                            if (Int64XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Int64_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int64_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.Int64_Ranged);
                            if (Int64XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Int8N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int8N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.Int8N);
                    ...
                    break;
                case "Int8N_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int8N_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.Int8N_Ranged);
                            if (Int8XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Int8":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int8) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.Int8);
                            if (Int8XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Int8_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int8_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.Int8_Ranged);
                            if (Int8XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Unsafe":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Unsafe) ?? true))
                    {
                        item.Unsafe = WildcardXmlTranslation.Instance.Parse(
                            root: node,
                            fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Unsafe,
                            errorMask: errorMask,
                            translationMask: translationMask).Bubble<bool>(i => (bool)i).GetOrDefault(item.Unsafe);
                    }
                    break;
                case "UnsafeLoqui":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UnsafeLoqui) ?? true))
                    {
                        item.UnsafeLoqui = WildcardXmlTranslation.Instance.Parse(
                            root: node,
                            fieldIndex: (int)TestObject_ReadOnly_FieldIndex.UnsafeLoqui,
                            errorMask: errorMask,
                            translationMask: translationMask).Bubble<ObjectToRef>(i => (ObjectToRef)i).GetOrDefault(item.UnsafeLoqui);
                    }
                    break;
                case "UnsafeNull":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UnsafeNull) ?? true))
                    {
                        item.UnsafeNull = WildcardXmlTranslation.Instance.Parse(
                            root: node,
                            fieldIndex: (int)TestObject_ReadOnly_FieldIndex.UnsafeNull,
                            errorMask: errorMask,
                            translationMask: translationMask).Bubble<ObjectToRef>(i => (ObjectToRef)i).GetOrDefault(item.UnsafeNull);
                    }
                    break;
                case "P2IntN":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.P2IntN) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.P2IntN);
                    ...
                    break;
                case "P2Int":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.P2Int) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.P2Int);
                            if (P2IntXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "P3DoubleN":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.P3DoubleN) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.P3DoubleN);
                    ...
                    break;
                case "P3Double":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.P3Double) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.P3Double);
                            if (P3DoubleXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "P3IntN":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.P3IntN) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.P3IntN);
                    ...
                    break;
                case "P3Int":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.P3Int) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.P3Int);
                            if (P3IntXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "PercentN":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.PercentN) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.PercentN);
                    ...
                    break;
                case "Percent":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Percent) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.Percent);
                            if (PercentXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "RangeInt8N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeInt8N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.RangeInt8N);
                    ...
                    break;
                case "RangeInt8":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeInt8) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.RangeInt8);
                            if (RangeInt8XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "RangeInt16N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeInt16N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.RangeInt16N);
                    ...
                    break;
                case "RangeInt16":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeInt16) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.RangeInt16);
                            if (RangeInt16XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "RangeInt32N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeInt32N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.RangeInt32N);
                    ...
                    break;
                case "RangeInt32":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeInt32) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.RangeInt32);
                            if (RangeInt32XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "RangeInt64N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeInt64N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.RangeInt64N);
                    ...
                    break;
                case "RangeInt64":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeInt64) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.RangeInt64);
                            if (RangeInt64XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "RangeUInt8N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeUInt8N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.RangeUInt8N);
                    ...
                    break;
                case "RangeUInt8":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeUInt8) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.RangeUInt8);
                            if (RangeUInt8XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "RangeUInt16N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeUInt16N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.RangeUInt16N);
                    ...
                    break;
                case "RangeUInt16":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeUInt16) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.RangeUInt16);
                            if (RangeUInt16XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "RangeUInt32N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeUInt32N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.RangeUInt32N);
                    ...
                    break;
                case "RangeUInt32":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeUInt32) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.RangeUInt32);
                            if (RangeUInt32XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "RangeUInt64N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeUInt64N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.RangeUInt64N);
                    ...
                    break;
                case "RangeUInt64":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeUInt64) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.RangeUInt64);
                            if (RangeUInt64XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "String":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.String) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.String);
                    ...
                    break;
                case "FilePath":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.FilePath) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.FilePath);
                    ...
                    break;
                case "FilePathNull":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.FilePathNull) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.FilePathNull);
                            if (FilePathXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "DirectoryPath":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.DirectoryPath) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.DirectoryPath);
                ...
                case "DirectoryPathNull":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.DirectoryPathNull) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.DirectoryPathNull);
                            if (DirectoryPathXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UDoubleN":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UDoubleN) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.UDoubleN);
                ...
                case "UDoubleN_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UDoubleN_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.UDoubleN_Ranged);
                            if (UDoubleXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UDouble":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UDouble) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.UDouble);
                            if (UDoubleXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UDouble_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UDouble_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.UDouble_Ranged);
                            if (UDoubleXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UInt16N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt16N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.UInt16N);
                    ...
                    break;
                case "UInt16N_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt16N_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.UInt16N_Ranged);
                            if (UInt16XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UInt16":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt16) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.UInt16);
                            if (UInt16XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UInt16_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt16_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.UInt16_Ranged);
                            if (UInt16XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UInt32N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt32N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.UInt32N);
                    ...
                    break;
                case "UInt32N_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt32N_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.UInt32N_Ranged);
                            if (UInt32XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UInt32":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt32) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.UInt32);
                            if (UInt32XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UInt32_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt32_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.UInt32_Ranged);
                            if (UInt32XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UInt64N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt64N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.UInt64N);
                    ...
                    break;
                case "UInt64N_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt64N_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.UInt64N_Ranged);
                            if (UInt64XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UInt64":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt64) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.UInt64);
                            if (UInt64XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UInt64_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt64_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.UInt64_Ranged);
                            if (UInt64XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UInt8N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt8N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.UInt8N);
                    ...
                    break;
                case "UInt8N_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt8N_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.UInt8N_Ranged);
                            if (ByteXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UInt8":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt8) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.UInt8);
                            if (ByteXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UInt8_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt8_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.UInt8_Ranged);
                            if (ByteXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Enum":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Enum) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.Enum);
                    ...
                    break;
                case "EnumNull":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.EnumNull) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.EnumNull);
                            if (EnumXmlTranslation<TestEnum>.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "WildCard":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.WildCard) ?? true))
                    {
                        item.WildCard = WildcardXmlTranslation.Instance.Parse(
                            root: node,
                            fieldIndex: (int)TestObject_ReadOnly_FieldIndex.WildCard,
                            errorMask: errorMask,
                            translationMask: translationMask).Bubble<Object>(i => (Object)i).GetOrDefault(item.WildCard);
                    }
                    break;
                case "WildCardLoqui":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.WildCardLoqui) ?? true))
                    {
                        item.WildCardLoqui = WildcardXmlTranslation.Instance.Parse(
                            root: node,
                            fieldIndex: (int)TestObject_ReadOnly_FieldIndex.WildCardLoqui,
                            errorMask: errorMask,
                            translationMask: translationMask).Bubble<Object>(i => (Object)i).GetOrDefault(item.WildCardLoqui);
                    }
                    break;
                case "WildCardNull":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.WildCardNull) ?? true))
                    {
                        item.WildCardNull = WildcardXmlTranslation.Instance.Parse(
                            root: node,
                            fieldIndex: (int)TestObject_ReadOnly_FieldIndex.WildCardNull,
                            errorMask: errorMask,
                            translationMask: translationMask).Bubble<Object>(i => (Object)i).GetOrDefault(item.WildCardNull);
                    }
                    break;
                case "Ref":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Ref) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.Ref);
                            if (LoquiXmlTranslation<ObjectToRef>.Instance.Parse(
                                node: node,
                                item: out ObjectToRef RefParse,
                                errorMask: errorMask,
                                translationMask: translationMask?.GetSubCrystal((int)TestObject_ReadOnly_FieldIndex.Ref)))
                            {
                                item.Ref = RefParse;
                            }
                            else
                    ...
                    break;
                case "Ref_NotNull":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Ref_NotNull) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.Ref_NotNull);
                            if (LoquiXmlTranslation<ObjectToRef>.Instance.Parse(
                                node: node,
                                item: out ObjectToRef Ref_NotNullParse,
                                errorMask: errorMask,
                                translationMask: translationMask?.GetSubCrystal((int)TestObject_ReadOnly_FieldIndex.Ref_NotNull)))
                            {
                    ...
                    break;
                case "Ref_Singleton":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Ref_Singleton) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.Ref_Singleton);
                    ...
                    break;
                case "RefGetter":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RefGetter) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.RefGetter);
                            if (LoquiXmlTranslation<ObjectToRef>.Instance.Parse(
                                node: node,
                                item: out ObjectToRef RefGetterParse,
                                errorMask: errorMask,
                                translationMask: translationMask?.GetSubCrystal((int)TestObject_ReadOnly_FieldIndex.RefGetter)))
                            {
                ...
                case "RefGetter_NotNull":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RefGetter_NotNull) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.RefGetter_NotNull);
                            if (LoquiXmlTranslation<ObjectToRef>.Instance.Parse(
                                node: node,
                                item: out ObjectToRef RefGetter_NotNullParse,
                                errorMask: errorMask,
                                translationMask: translationMask?.GetSubCrystal((int)TestObject_ReadOnly_FieldIndex.RefGetter_NotNull)))
                            {
                ...
                case "RefGetter_Singleton":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RefGetter_Singleton) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.RefGetter_Singleton);
                    ...
                    break;
                case "RefSetter":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RefSetter) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.RefSetter);
                            if (LoquiXmlTranslation<ObjectToRef>.Instance.Parse(
                                node: node,
                                item: out ObjectToRef RefSetterParse,
                                errorMask: errorMask,
                                translationMask: translationMask?.GetSubCrystal((int)TestObject_ReadOnly_FieldIndex.RefSetter)))
                            {
                ...
                case "RefSetter_NotNull":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RefSetter_NotNull) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.RefSetter_NotNull);
                            if (LoquiXmlTranslation<ObjectToRef>.Instance.Parse(
                                node: node,
                                item: out ObjectToRef RefSetter_NotNullParse,
                                errorMask: errorMask,
                                translationMask: translationMask?.GetSubCrystal((int)TestObject_ReadOnly_FieldIndex.RefSetter_NotNull)))
                            {
                ...
                case "RefSetter_Singleton":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RefSetter_Singleton) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.RefSetter_Singleton);
                    ...
                    break;
                case "List":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.List) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.List);
                    ...
                    break;
                case "RefList":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RefList) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.RefList);
                    ...
                    break;
                case "Dict":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Dict) ?? true))
                    {
                        DictXmlTranslation<String, Boolean>.Instance.ParseInto(
                            node: node,
                            item: item.Dict,
                            fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Dict,
                            errorMask: errorMask,
                            translationMask: translationMask,
                    ...
                    break;
                case "RefDict":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RefDict) ?? true))
                    {
                        DictXmlTranslation<ObjectToRef, ObjectToRef>.Instance.ParseInto(
                            node: node,
                            item: item.RefDict,
                            fieldIndex: (int)TestObject_ReadOnly_FieldIndex.RefDict,
                            errorMask: errorMask,
                            translationMask: translationMask,
                            keyTransl: (XElement r, int dictIndex, ErrorMaskBuilder dictErrMask, MaskItem<bool, ObjectToRef_TranslationMask> dictTranslMask) =>
                            {
                                try
                                {
                                    ...
                                    if (LoquiXmlTranslation<ObjectToRef>.Instance.Parse(
                                        ...
                                        errorMask: dictErrMask,
                                        translationMask: dictTranslMask?.GetSubCrystal((int)TestObject_ReadOnly_FieldIndex.)))
                                    {
                                        return  = Parse;
                                    }
                                    else
                    ...
                    break;
                case "KeyRefDict":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.KeyRefDict) ?? true))
                    {
                        DictXmlTranslation<ObjectToRef, Boolean>.Instance.ParseInto(
                            node: node,
                            item: item.KeyRefDict,
                            fieldIndex: (int)TestObject_ReadOnly_FieldIndex.KeyRefDict,
                            errorMask: errorMask,
                            translationMask: translationMask,
                            keyTransl: (XElement r, int dictIndex, ErrorMaskBuilder dictErrMask, bool dictTranslMask) =>
                            {
                    ...
                    break;
                case "ValRefDict":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.ValRefDict) ?? true))
                    {
                        DictXmlTranslation<String, ObjectToRef>.Instance.ParseInto(
                            node: node,
                            item: item.ValRefDict,
                            fieldIndex: (int)TestObject_ReadOnly_FieldIndex.ValRefDict,
                            errorMask: errorMask,
                            translationMask: translationMask,
                            keyTransl: (XElement r, int dictIndex, ErrorMaskBuilder dictErrMask, MaskItem<bool, ObjectToRef_TranslationMask> dictTranslMask) =>
                            {
                    ...
                    break;
                case "DictKeyedValue":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.DictKeyedValue) ?? true))
                    {
                        KeyedDictXmlTranslation<Int32, ObjectToRef>.Instance.ParseInto(
                            node: node,
                            item: item.DictKeyedValue,
                            fieldIndex: (int)TestObject_ReadOnly_FieldIndex.DictKeyedValue,
                            errorMask: errorMask,
                            translationMask: translationMask,
        ...
        {
            switch ((TestObject_ReadOnly_FieldIndex)index)
            {
            ...
            ITestObject_ReadOnlyGetter def = null)
        {
            ...
            {
                ret = (TestObject_ReadOnly)System.Activator.CreateInstance(item.GetType());
            }
            ret.CopyFieldsFrom(
                item,
                copyMask: copyMask,
        ...
        public static TestObject_ReadOnly Copy_ToLoqui(
        ...
        {
            this.CopyFieldsFrom(
                rhs: (ITestObject_ReadOnlyGetter)rhs,
                def: null,
                doMasks: false,
        ...
        public static TestObject_ReadOnly Create(IEnumerable<KeyValuePair<ushort, object>> fields)
        {
            ...
            {
                CopyInInternal_TestObject_ReadOnly(ret, pair);
            }
            return ret;
        }

        protected static void CopyInInternal_TestObject_ReadOnly(TestObject_ReadOnly obj, KeyValuePair<ushort, object> pair)
        {
            if (!EnumExt.TryParse(pair.Key, out TestObject_ReadOnly_FieldIndex enu))
            {
    ...
    #region Interface
    public partial interface ITestObject_ReadOnly : ITestObject_ReadOnlyGetter, ILoquiClass<ITestObject_ReadOnly, ITestObject_ReadOnlyGetter>, ILoquiClass<TestObject_ReadOnly, ITestObject_ReadOnlyGetter>
    {
    }

    public partial interface ITestObject_ReadOnlyGetter : ILoquiObject
    {
        #region ByteArray
        Byte[] ByteArray { get; }
...
namespace Loqui.Tests.Generated.Internals
{
    ...
    #region Registration
    public class TestObject_ReadOnly_Registration : ILoquiRegistration
    {
        ...
        public static readonly Type GetterType = typeof(ITestObject_ReadOnlyGetter);

        public static readonly Type SetterType = typeof(ITestObject_ReadOnly);

        public static readonly Type CommonType = typeof(TestObject_ReadOnlyCommon);

        public const string FullName = "Loqui.Tests.Generated.TestObject_ReadOnly";
        ...
        public static ushort? GetNameIndex(StringCaseAgnostic str)
        {
            ...
            {
                case "BYTEARRAY":
                    return (ushort)TestObject_ReadOnly_FieldIndex.ByteArray;
                case "BYTEARRAYNULL":
                    return (ushort)TestObject_ReadOnly_FieldIndex.ByteArrayNull;
                case "BYTEARRAYNOTNULL":
                    return (ushort)TestObject_ReadOnly_FieldIndex.ByteArrayNotNull;
                case "BYTEARRAYSINGLETON":
                    return (ushort)TestObject_ReadOnly_FieldIndex.ByteArraySingleton;
                case "BOOLN":
                ...
                case "UNSAFELOQUI":
                    return (ushort)TestObject_ReadOnly_FieldIndex.UnsafeLoqui;
                case "UNSAFENULL":
                    return (ushort)TestObject_ReadOnly_FieldIndex.UnsafeNull;
                case "P2INTN":
                ...
                case "RANGEINT8N":
                    return (ushort)TestObject_ReadOnly_FieldIndex.RangeInt8N;
                case "RANGEINT8":
                    return (ushort)TestObject_ReadOnly_FieldIndex.RangeInt8;
                case "RANGEINT16N":
                    return (ushort)TestObject_ReadOnly_FieldIndex.RangeInt16N;
                case "RANGEINT16":
                    return (ushort)TestObject_ReadOnly_FieldIndex.RangeInt16;
                case "RANGEINT32N":
                    return (ushort)TestObject_ReadOnly_FieldIndex.RangeInt32N;
                case "RANGEINT32":
                    return (ushort)TestObject_ReadOnly_FieldIndex.RangeInt32;
                case "RANGEINT64N":
                    return (ushort)TestObject_ReadOnly_FieldIndex.RangeInt64N;
                case "RANGEINT64":
                    return (ushort)TestObject_ReadOnly_FieldIndex.RangeInt64;
                case "RANGEUINT8N":
                    return (ushort)TestObject_ReadOnly_FieldIndex.RangeUInt8N;
                case "RANGEUINT8":
                    return (ushort)TestObject_ReadOnly_FieldIndex.RangeUInt8;
                case "RANGEUINT16N":
                    return (ushort)TestObject_ReadOnly_FieldIndex.RangeUInt16N;
                case "RANGEUINT16":
                    return (ushort)TestObject_ReadOnly_FieldIndex.RangeUInt16;
                case "RANGEUINT32N":
                    return (ushort)TestObject_ReadOnly_FieldIndex.RangeUInt32N;
                case "RANGEUINT32":
                    return (ushort)TestObject_ReadOnly_FieldIndex.RangeUInt32;
                case "RANGEUINT64N":
                    return (ushort)TestObject_ReadOnly_FieldIndex.RangeUInt64N;
                case "RANGEUINT64":
                    return (ushort)TestObject_ReadOnly_FieldIndex.RangeUInt64;
                case "STRING":
                    return (ushort)TestObject_ReadOnly_FieldIndex.String;
                case "FILEPATH":
                    return (ushort)TestObject_ReadOnly_FieldIndex.FilePath;
                case "FILEPATHNULL":
                    return (ushort)TestObject_ReadOnly_FieldIndex.FilePathNull;
                case "DIRECTORYPATH":
                    return (ushort)TestObject_ReadOnly_FieldIndex.DirectoryPath;
                case "DIRECTORYPATHNULL":
                    return (ushort)TestObject_ReadOnly_FieldIndex.DirectoryPathNull;
                case "UDOUBLEN":
                ...
                case "ENUMNULL":
                    return (ushort)TestObject_ReadOnly_FieldIndex.EnumNull;
                case "WILDCARD":
                    return (ushort)TestObject_ReadOnly_FieldIndex.WildCard;
                case "WILDCARDLOQUI":
                    return (ushort)TestObject_ReadOnly_FieldIndex.WildCardLoqui;
                case "WILDCARDNULL":
                    return (ushort)TestObject_ReadOnly_FieldIndex.WildCardNull;
                case "REF":
    ...
    #region Extensions
    public static partial class TestObject_ReadOnlyCommon
    {
            ...
            TestObject_ReadOnly_Mask<bool> printMask = null)
        {
            if (name == null)
            {
                fg.AppendLine($"{nameof(TestObject_ReadOnly)} =>");
            }
            else
            {
                fg.AppendLine($"{name} ({nameof(TestObject_ReadOnly)}) =>");
            }
            fg.AppendLine("[");
        ...
        public static bool HasBeenSet(
            this ITestObject_ReadOnlyGetter item,
            TestObject_ReadOnly_Mask<bool?> checkMask)
        {
        ...
        public static TestObject_ReadOnly_Mask<bool> GetHasBeenSetMask(ITestObject_ReadOnlyGetter item)
        {
            var ret = new TestObject_ReadOnly_Mask<bool>();
            ret.ByteArray = true;
        ...
        public static void Write_Xml(
            ...
            string name = null)
        {
            var elem = new XElement(name ?? "Loqui.Tests.Generated.TestObject_ReadOnly");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Loqui.Tests.Generated.TestObject_ReadOnly");
            }
            WriteToNode_Xml(
                item: item,
                node: elem,
            ...
            TranslationCrystal translationMask)
        {
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.ByteArray) ?? true))
            {
                ByteArrayXmlTranslation.Instance.Write(
                    ...
                    item: item.ByteArray,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.ByteArray,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.ByteArrayNull) ?? true))
            {
                ByteArrayXmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.ByteArrayNull,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.ByteArrayNotNull) ?? true))
            {
                ByteArrayXmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.ByteArrayNotNull,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.ByteArraySingleton) ?? true))
            {
                ByteArrayXmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.ByteArraySingleton,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.BoolN) ?? true))
            {
                BooleanXmlTranslation.Instance.Write(
                    ...
                    item: item.BoolN,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.BoolN,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Bool) ?? true))
            {
                BooleanXmlTranslation.Instance.Write(
                    ...
                    item: item.Bool,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Bool,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.CharN) ?? true))
            {
                CharXmlTranslation.Instance.Write(
                    ...
                    item: item.CharN,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.CharN,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Char) ?? true))
            {
                CharXmlTranslation.Instance.Write(
                    ...
                    item: item.Char,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Char,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.DateTimeNull) ?? true))
            {
                DateTimeXmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.DateTimeNull,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.DateTime) ?? true))
            {
                DateTimeXmlTranslation.Instance.Write(
                    ...
                    item: item.DateTime,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.DateTime,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.DoubleN) ?? true))
            {
                DoubleXmlTranslation.Instance.Write(
                    ...
                    item: item.DoubleN,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.DoubleN,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.DoubleN_Ranged) ?? true))
            {
                DoubleXmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.DoubleN_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Double) ?? true))
            {
                DoubleXmlTranslation.Instance.Write(
                    ...
                    item: item.Double,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Double,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Double_Ranged) ?? true))
            {
                DoubleXmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Double_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.FloatN) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    ...
                    item: item.FloatN,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.FloatN,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.FloatN_Ranged) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.FloatN_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Float) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    ...
                    item: item.Float,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Float,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Float_Ranged) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Float_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int16N) ?? true))
            {
                Int16XmlTranslation.Instance.Write(
                    ...
                    item: item.Int16N,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Int16N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int16N_Ranged) ?? true))
            {
                Int16XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Int16N_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int16) ?? true))
            {
                Int16XmlTranslation.Instance.Write(
                    ...
                    item: item.Int16,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Int16,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int16_Ranged) ?? true))
            {
                Int16XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Int16_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int32N) ?? true))
            {
                Int32XmlTranslation.Instance.Write(
                    ...
                    item: item.Int32N,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Int32N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int32N_Ranged) ?? true))
            {
                Int32XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Int32N_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int32) ?? true))
            {
                Int32XmlTranslation.Instance.Write(
                    ...
                    item: item.Int32,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Int32,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int32_Ranged) ?? true))
            {
                Int32XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Int32_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int64N) ?? true))
            {
                Int64XmlTranslation.Instance.Write(
                    ...
                    item: item.Int64N,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Int64N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int64N_Ranged) ?? true))
            {
                Int64XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Int64N_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int64) ?? true))
            {
                Int64XmlTranslation.Instance.Write(
                    ...
                    item: item.Int64,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Int64,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int64_Ranged) ?? true))
            {
                Int64XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Int64_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int8N) ?? true))
            {
                Int8XmlTranslation.Instance.Write(
                    ...
                    item: item.Int8N,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Int8N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int8N_Ranged) ?? true))
            {
                Int8XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Int8N_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int8) ?? true))
            {
                Int8XmlTranslation.Instance.Write(
                    ...
                    item: item.Int8,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Int8,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Int8_Ranged) ?? true))
            {
                Int8XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Int8_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Unsafe) ?? true))
            {
            ...
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.P2IntN) ?? true))
            {
                P2IntXmlTranslation.Instance.Write(
                    ...
                    item: item.P2IntN,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.P2IntN,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.P2Int) ?? true))
            {
                P2IntXmlTranslation.Instance.Write(
                    ...
                    item: item.P2Int,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.P2Int,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.P3DoubleN) ?? true))
            {
                P3DoubleXmlTranslation.Instance.Write(
                    ...
                    item: item.P3DoubleN,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.P3DoubleN,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.P3Double) ?? true))
            {
                P3DoubleXmlTranslation.Instance.Write(
                    ...
                    item: item.P3Double,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.P3Double,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.P3IntN) ?? true))
            {
                P3IntXmlTranslation.Instance.Write(
                    ...
                    item: item.P3IntN,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.P3IntN,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.P3Int) ?? true))
            {
                P3IntXmlTranslation.Instance.Write(
                    ...
                    item: item.P3Int,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.P3Int,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.PercentN) ?? true))
            {
                PercentXmlTranslation.Instance.Write(
                    ...
                    item: item.PercentN,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.PercentN,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Percent) ?? true))
            {
                PercentXmlTranslation.Instance.Write(
                    ...
                    item: item.Percent,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Percent,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeInt8N) ?? true))
            {
                RangeInt8XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.RangeInt8N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeInt8) ?? true))
            {
                RangeInt8XmlTranslation.Instance.Write(
                    ...
                    item: item.RangeInt8,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.RangeInt8,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeInt16N) ?? true))
            {
                RangeInt16XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.RangeInt16N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeInt16) ?? true))
            {
                RangeInt16XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.RangeInt16,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeInt32N) ?? true))
            {
                RangeInt32XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.RangeInt32N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeInt32) ?? true))
            {
                RangeInt32XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.RangeInt32,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeInt64N) ?? true))
            {
                RangeInt64XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.RangeInt64N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeInt64) ?? true))
            {
                RangeInt64XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.RangeInt64,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeUInt8N) ?? true))
            {
                RangeUInt8XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.RangeUInt8N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeUInt8) ?? true))
            {
                RangeUInt8XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.RangeUInt8,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeUInt16N) ?? true))
            {
                RangeUInt16XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.RangeUInt16N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeUInt16) ?? true))
            {
                RangeUInt16XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.RangeUInt16,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeUInt32N) ?? true))
            {
                RangeUInt32XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.RangeUInt32N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeUInt32) ?? true))
            {
                RangeUInt32XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.RangeUInt32,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeUInt64N) ?? true))
            {
                RangeUInt64XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.RangeUInt64N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RangeUInt64) ?? true))
            {
                RangeUInt64XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.RangeUInt64,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.String) ?? true))
            {
                StringXmlTranslation.Instance.Write(
                    ...
                    item: item.String,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.String,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.FilePath) ?? true))
            {
                FilePathXmlTranslation.Instance.Write(
                    ...
                    item: item.FilePath,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.FilePath,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.FilePathNull) ?? true))
            {
                FilePathXmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.FilePathNull,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.DirectoryPath) ?? true))
            {
                DirectoryPathXmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.DirectoryPath,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.DirectoryPathNull) ?? true))
            {
                DirectoryPathXmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.DirectoryPathNull,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UDoubleN) ?? true))
            {
                UDoubleXmlTranslation.Instance.Write(
                    ...
                    item: item.UDoubleN,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.UDoubleN,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UDoubleN_Ranged) ?? true))
            {
                UDoubleXmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.UDoubleN_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UDouble) ?? true))
            {
                UDoubleXmlTranslation.Instance.Write(
                    ...
                    item: item.UDouble,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.UDouble,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UDouble_Ranged) ?? true))
            {
                UDoubleXmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.UDouble_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt16N) ?? true))
            {
                UInt16XmlTranslation.Instance.Write(
                    ...
                    item: item.UInt16N,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.UInt16N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt16N_Ranged) ?? true))
            {
                UInt16XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.UInt16N_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt16) ?? true))
            {
                UInt16XmlTranslation.Instance.Write(
                    ...
                    item: item.UInt16,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.UInt16,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt16_Ranged) ?? true))
            {
                UInt16XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.UInt16_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt32N) ?? true))
            {
                UInt32XmlTranslation.Instance.Write(
                    ...
                    item: item.UInt32N,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.UInt32N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt32N_Ranged) ?? true))
            {
                UInt32XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.UInt32N_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt32) ?? true))
            {
                UInt32XmlTranslation.Instance.Write(
                    ...
                    item: item.UInt32,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.UInt32,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt32_Ranged) ?? true))
            {
                UInt32XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.UInt32_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt64N) ?? true))
            {
                UInt64XmlTranslation.Instance.Write(
                    ...
                    item: item.UInt64N,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.UInt64N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt64N_Ranged) ?? true))
            {
                UInt64XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.UInt64N_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt64) ?? true))
            {
                UInt64XmlTranslation.Instance.Write(
                    ...
                    item: item.UInt64,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.UInt64,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt64_Ranged) ?? true))
            {
                UInt64XmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.UInt64_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt8N) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    ...
                    item: item.UInt8N,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.UInt8N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt8N_Ranged) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.UInt8N_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt8) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    ...
                    item: item.UInt8,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.UInt8,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.UInt8_Ranged) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.UInt8_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Enum) ?? true))
            {
                EnumXmlTranslation<TestEnum>.Instance.Write(
                    ...
                    item: item.Enum,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Enum,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.EnumNull) ?? true))
            {
                EnumXmlTranslation<TestEnum>.Instance.Write(
                    ...
                    item: item.EnumNull,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.EnumNull,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.WildCard) ?? true))
            {
            ...
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Ref) ?? true))
            {
                LoquiXmlTranslation<ObjectToRef>.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Ref,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_ReadOnly_FieldIndex.Ref));
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Ref_NotNull) ?? true))
            {
                LoquiXmlTranslation<ObjectToRef>.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Ref_NotNull,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_ReadOnly_FieldIndex.Ref_NotNull));
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.Ref_Singleton) ?? true))
            {
                LoquiXmlTranslation<ObjectToRef>.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.Ref_Singleton,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_ReadOnly_FieldIndex.Ref_Singleton));
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RefGetter) ?? true))
            {
                LoquiXmlTranslation<ObjectToRef>.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.RefGetter,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_ReadOnly_FieldIndex.RefGetter));
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RefGetter_NotNull) ?? true))
            {
                LoquiXmlTranslation<ObjectToRef>.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.RefGetter_NotNull,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_ReadOnly_FieldIndex.RefGetter_NotNull));
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RefGetter_Singleton) ?? true))
            {
                LoquiXmlTranslation<ObjectToRef>.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.RefGetter_Singleton,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_ReadOnly_FieldIndex.RefGetter_Singleton));
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RefSetter) ?? true))
            {
                LoquiXmlTranslation<ObjectToRef>.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.RefSetter,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_ReadOnly_FieldIndex.RefSetter));
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RefSetter_NotNull) ?? true))
            {
                LoquiXmlTranslation<ObjectToRef>.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.RefSetter_NotNull,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_ReadOnly_FieldIndex.RefSetter_NotNull));
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RefSetter_Singleton) ?? true))
            {
                LoquiXmlTranslation<ObjectToRef>.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.RefSetter_Singleton,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_ReadOnly_FieldIndex.RefSetter_Singleton));
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.List) ?? true))
            {
                ListXmlTranslation<Boolean>.Instance.Write(
                    ...
                    item: item.List,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.List,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_ReadOnly_FieldIndex.List),
            ...
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.RefList) ?? true))
            {
                ListXmlTranslation<ObjectToRef>.Instance.Write(
                    ...
                    item: item.RefList,
                    fieldIndex: (int)TestObject_ReadOnly_FieldIndex.RefList,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_ReadOnly_FieldIndex.RefList),
            ...
            if ((translationMask?.GetShouldTranslate((int)TestObject_ReadOnly_FieldIndex.DictKeyedValue) ?? true))
            {
                try
                {
                    errorMask?.PushIndex((int)TestObject_ReadOnly_FieldIndex.DictKeyedValue);
    ...
    #region Modules
    #region Mask
    public class TestObject_ReadOnly_Mask<T> : IMask<T>, IEquatable<TestObject_ReadOnly_Mask<T>>
    {
        #region Ctors
        public TestObject_ReadOnly_Mask()
        {
        }

        public TestObject_ReadOnly_Mask(T initialValue)
        {
        ...
        public override bool Equals(object obj)
        {
            if (!(obj is TestObject_ReadOnly_Mask<T> rhs)) return false;
            return Equals(rhs);
        }

        public bool Equals(TestObject_ReadOnly_Mask<T> rhs)
        {
            if (rhs == null) return false;
        ...
        #region Translate
        public TestObject_ReadOnly_Mask<R> Translate<R>(Func<T, R> eval)
        {
            var ret = new TestObject_ReadOnly_Mask<R>();
            this.Translate_InternalFill(ret, eval);
            return ret;
        }

        protected void Translate_InternalFill<R>(TestObject_ReadOnly_Mask<R> obj, Func<T, R> eval)
        {
        ...
        public string ToString(TestObject_ReadOnly_Mask<bool> printMask = null)
        {
            var fg = new FileGeneration();
        ...
        public void ToString(FileGeneration fg, TestObject_ReadOnly_Mask<bool> printMask = null)
        {
            fg.AppendLine($"{nameof(TestObject_ReadOnly_Mask<T>)} =>");
            fg.AppendLine("[");
            using (new DepthWrapper(fg))
            {
                if (printMask?.ByteArray ?? true)
    ...
    public class TestObject_ReadOnly_ErrorMask : IErrorMask, IErrorMask<TestObject_ReadOnly_ErrorMask>
    {
        #region Members
        ...
        {
            fg.AppendLine("TestObject_ReadOnly_ErrorMask =>");
            fg.AppendLine("[");
            using (new DepthWrapper(fg))
            {
        ...
        #region Combine
        public TestObject_ReadOnly_ErrorMask Combine(TestObject_ReadOnly_ErrorMask rhs)
        {
            var ret = new TestObject_ReadOnly_ErrorMask();
        ...
        public static TestObject_ReadOnly_ErrorMask Combine(TestObject_ReadOnly_ErrorMask lhs, TestObject_ReadOnly_ErrorMask rhs)
        {
        ...
        #region Factory
        public static TestObject_ReadOnly_ErrorMask Factory(ErrorMaskBuilder errorMask)
        {
            if (errorMask?.Empty ?? true) return null;
            return new TestObject_ReadOnly_ErrorMask();
        }
        #endregion
    ...
    {
        public TestObject_ReadOnly_CopyMask()
        {
        }

        public TestObject_ReadOnly_CopyMask(bool defaultOn, CopyOption deepCopyOption = CopyOption.Reference)
        {
    ...
    public class TestObject_ReadOnly_TranslationMask : ITranslationMask
    {
        #region Members
        ...
        #region Ctors
        public TestObject_ReadOnly_TranslationMask()
        {
        }

        public TestObject_ReadOnly_TranslationMask(bool defaultOn)
        {
            this.ByteArray = defaultOn;
            this.ByteArrayNull = defaultOn;
            this.ByteArrayNotNull = defaultOn;
