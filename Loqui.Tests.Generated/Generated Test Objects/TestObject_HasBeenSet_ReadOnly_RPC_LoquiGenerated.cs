...
{
    #region Class
    public partial class TestObject_HasBeenSet_ReadOnly_RPC : 
        ITestObject_HasBeenSet_ReadOnly_RPC,
        ILoquiObject<TestObject_HasBeenSet_ReadOnly_RPC>,
        ILoquiObjectSetter,
        INotifyPropertyChanged,
        IEquatable<TestObject_HasBeenSet_ReadOnly_RPC>
    {
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ILoquiRegistration ILoquiObject.Registration => TestObject_HasBeenSet_ReadOnly_RPC_Registration.Instance;
        public static TestObject_HasBeenSet_ReadOnly_RPC_Registration Registration => TestObject_HasBeenSet_ReadOnly_RPC_Registration.Instance;
        ...
        #region Ctor
        public TestObject_HasBeenSet_ReadOnly_RPC()
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        Byte[] ITestObject_HasBeenSet_ReadOnly_RPCGetter.ByteArray => this.ByteArray;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IHasBeenSetItemGetter<Byte[]> ITestObject_HasBeenSet_ReadOnly_RPCGetter.ByteArray_Property => this.ByteArray_Property;
        #endregion
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        Byte[] ITestObject_HasBeenSet_ReadOnly_RPCGetter.ByteArrayNull => this.ByteArrayNull;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IHasBeenSetItemGetter<Byte[]> ITestObject_HasBeenSet_ReadOnly_RPCGetter.ByteArrayNull_Property => this.ByteArrayNull_Property;
        #endregion
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        Byte[] ITestObject_HasBeenSet_ReadOnly_RPCGetter.ByteArrayNotNull => this.ByteArrayNotNull;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IHasBeenSetItemGetter<Byte[]> ITestObject_HasBeenSet_ReadOnly_RPCGetter.ByteArrayNotNull_Property => this.ByteArrayNotNull_Property;
        #endregion
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        Byte[] ITestObject_HasBeenSet_ReadOnly_RPCGetter.ByteArraySingleton => this.ByteArraySingleton;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IHasBeenSetItemGetter<Byte[]> ITestObject_HasBeenSet_ReadOnly_RPCGetter.ByteArraySingleton_Property => this.ByteArraySingleton_Property;
        #endregion
        #region BoolN
        ...
        Boolean? ITestObject_HasBeenSet_ReadOnly_RPCGetter.BoolN => this.BoolN;
        protected void UnsetBoolN()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.BoolN] = false;
        ...
        Boolean ITestObject_HasBeenSet_ReadOnly_RPCGetter.Bool => this.Bool;
        protected void UnsetBool()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Bool] = false;
        ...
        Char? ITestObject_HasBeenSet_ReadOnly_RPCGetter.CharN => this.CharN;
        protected void UnsetCharN()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.CharN] = false;
            CharN = default(Char?);
        }
        #endregion
        #region Char
        ...
        Char ITestObject_HasBeenSet_ReadOnly_RPCGetter.Char => this.Char;
        protected void UnsetChar()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Char] = false;
            Char = default(Char);
        }
        #endregion
        #region DateTimeNull
        ...
        DateTime? ITestObject_HasBeenSet_ReadOnly_RPCGetter.DateTimeNull => this.DateTimeNull;
        protected void UnsetDateTimeNull()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DateTimeNull] = false;
        ...
        DateTime ITestObject_HasBeenSet_ReadOnly_RPCGetter.DateTime => this.DateTime;
        protected void UnsetDateTime()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DateTime] = false;
        ...
        Double? ITestObject_HasBeenSet_ReadOnly_RPCGetter.DoubleN => this.DoubleN;
        protected void UnsetDoubleN()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DoubleN] = false;
        ...
        Double? ITestObject_HasBeenSet_ReadOnly_RPCGetter.DoubleN_Ranged => this.DoubleN_Ranged;
        IHasBeenSetItemGetter<Double?> ITestObject_HasBeenSet_ReadOnly_RPCGetter.DoubleN_Ranged_Property => this.DoubleN_Ranged_Property;
        ...
        Double ITestObject_HasBeenSet_ReadOnly_RPCGetter.Double => this.Double;
        protected void UnsetDouble()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Double] = false;
        ...
        Double ITestObject_HasBeenSet_ReadOnly_RPCGetter.Double_Ranged => this.Double_Ranged;
        IHasBeenSetItemGetter<Double> ITestObject_HasBeenSet_ReadOnly_RPCGetter.Double_Ranged_Property => this.Double_Ranged_Property;
        ...
        Single? ITestObject_HasBeenSet_ReadOnly_RPCGetter.FloatN => this.FloatN;
        protected void UnsetFloatN()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.FloatN] = false;
        ...
        Single? ITestObject_HasBeenSet_ReadOnly_RPCGetter.FloatN_Ranged => this.FloatN_Ranged;
        IHasBeenSetItemGetter<Single?> ITestObject_HasBeenSet_ReadOnly_RPCGetter.FloatN_Ranged_Property => this.FloatN_Ranged_Property;
        ...
        Single ITestObject_HasBeenSet_ReadOnly_RPCGetter.Float => this.Float;
        protected void UnsetFloat()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Float] = false;
        ...
        Single ITestObject_HasBeenSet_ReadOnly_RPCGetter.Float_Ranged => this.Float_Ranged;
        IHasBeenSetItemGetter<Single> ITestObject_HasBeenSet_ReadOnly_RPCGetter.Float_Ranged_Property => this.Float_Ranged_Property;
        ...
        Int16? ITestObject_HasBeenSet_ReadOnly_RPCGetter.Int16N => this.Int16N;
        protected void UnsetInt16N()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int16N] = false;
        ...
        Int16? ITestObject_HasBeenSet_ReadOnly_RPCGetter.Int16N_Ranged => this.Int16N_Ranged;
        IHasBeenSetItemGetter<Int16?> ITestObject_HasBeenSet_ReadOnly_RPCGetter.Int16N_Ranged_Property => this.Int16N_Ranged_Property;
        ...
        Int16 ITestObject_HasBeenSet_ReadOnly_RPCGetter.Int16 => this.Int16;
        protected void UnsetInt16()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int16] = false;
            Int16 = default(Int16);
        }
        #endregion
        #region Int16_Ranged
        ...
        Int16 ITestObject_HasBeenSet_ReadOnly_RPCGetter.Int16_Ranged => this.Int16_Ranged;
        IHasBeenSetItemGetter<Int16> ITestObject_HasBeenSet_ReadOnly_RPCGetter.Int16_Ranged_Property => this.Int16_Ranged_Property;
        ...
        Int32? ITestObject_HasBeenSet_ReadOnly_RPCGetter.Int32N => this.Int32N;
        protected void UnsetInt32N()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int32N] = false;
        ...
        Int32? ITestObject_HasBeenSet_ReadOnly_RPCGetter.Int32N_Ranged => this.Int32N_Ranged;
        IHasBeenSetItemGetter<Int32?> ITestObject_HasBeenSet_ReadOnly_RPCGetter.Int32N_Ranged_Property => this.Int32N_Ranged_Property;
        ...
        Int32 ITestObject_HasBeenSet_ReadOnly_RPCGetter.Int32 => this.Int32;
        protected void UnsetInt32()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int32] = false;
            Int32 = default(Int32);
        }
        #endregion
        #region Int32_Ranged
        ...
        Int32 ITestObject_HasBeenSet_ReadOnly_RPCGetter.Int32_Ranged => this.Int32_Ranged;
        IHasBeenSetItemGetter<Int32> ITestObject_HasBeenSet_ReadOnly_RPCGetter.Int32_Ranged_Property => this.Int32_Ranged_Property;
        ...
        Int64? ITestObject_HasBeenSet_ReadOnly_RPCGetter.Int64N => this.Int64N;
        protected void UnsetInt64N()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int64N] = false;
        ...
        Int64? ITestObject_HasBeenSet_ReadOnly_RPCGetter.Int64N_Ranged => this.Int64N_Ranged;
        IHasBeenSetItemGetter<Int64?> ITestObject_HasBeenSet_ReadOnly_RPCGetter.Int64N_Ranged_Property => this.Int64N_Ranged_Property;
        ...
        Int64 ITestObject_HasBeenSet_ReadOnly_RPCGetter.Int64 => this.Int64;
        protected void UnsetInt64()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int64] = false;
            Int64 = default(Int64);
        }
        #endregion
        #region Int64_Ranged
        ...
        Int64 ITestObject_HasBeenSet_ReadOnly_RPCGetter.Int64_Ranged => this.Int64_Ranged;
        IHasBeenSetItemGetter<Int64> ITestObject_HasBeenSet_ReadOnly_RPCGetter.Int64_Ranged_Property => this.Int64_Ranged_Property;
        ...
        SByte? ITestObject_HasBeenSet_ReadOnly_RPCGetter.Int8N => this.Int8N;
        protected void UnsetInt8N()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int8N] = false;
            Int8N = default(SByte?);
        }
        #endregion
        #region Int8N_Ranged
        ...
        SByte? ITestObject_HasBeenSet_ReadOnly_RPCGetter.Int8N_Ranged => this.Int8N_Ranged;
        IHasBeenSetItemGetter<SByte?> ITestObject_HasBeenSet_ReadOnly_RPCGetter.Int8N_Ranged_Property => this.Int8N_Ranged_Property;
        ...
        SByte ITestObject_HasBeenSet_ReadOnly_RPCGetter.Int8 => this.Int8;
        protected void UnsetInt8()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int8] = false;
            Int8 = default(SByte);
        }
        #endregion
        #region Int8_Ranged
        ...
        SByte ITestObject_HasBeenSet_ReadOnly_RPCGetter.Int8_Ranged => this.Int8_Ranged;
        IHasBeenSetItemGetter<SByte> ITestObject_HasBeenSet_ReadOnly_RPCGetter.Int8_Ranged_Property => this.Int8_Ranged_Property;
        ...
        bool ITestObject_HasBeenSet_ReadOnly_RPCGetter.Unsafe => this.Unsafe;
        protected void UnsetUnsafe()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Unsafe] = false;
            Unsafe = default(bool);
        }
        #endregion
        #region UnsafeLoqui
        ...
        ObjectToRef ITestObject_HasBeenSet_ReadOnly_RPCGetter.UnsafeLoqui => this.UnsafeLoqui;
        protected void UnsetUnsafeLoqui()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UnsafeLoqui] = false;
        ...
        ObjectToRef ITestObject_HasBeenSet_ReadOnly_RPCGetter.UnsafeNull => this.UnsafeNull;
        protected void UnsetUnsafeNull()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UnsafeNull] = false;
        ...
        P2Int? ITestObject_HasBeenSet_ReadOnly_RPCGetter.P2IntN => this.P2IntN;
        protected void UnsetP2IntN()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P2IntN] = false;
        ...
        P2Int ITestObject_HasBeenSet_ReadOnly_RPCGetter.P2Int => this.P2Int;
        protected void UnsetP2Int()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P2Int] = false;
            P2Int = default(P2Int);
        }
        #endregion
        #region P3DoubleN
        ...
        P3Double? ITestObject_HasBeenSet_ReadOnly_RPCGetter.P3DoubleN => this.P3DoubleN;
        protected void UnsetP3DoubleN()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3DoubleN] = false;
        ...
        P3Double ITestObject_HasBeenSet_ReadOnly_RPCGetter.P3Double => this.P3Double;
        protected void UnsetP3Double()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3Double] = false;
        ...
        P3Int? ITestObject_HasBeenSet_ReadOnly_RPCGetter.P3IntN => this.P3IntN;
        protected void UnsetP3IntN()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3IntN] = false;
        ...
        P3Int ITestObject_HasBeenSet_ReadOnly_RPCGetter.P3Int => this.P3Int;
        protected void UnsetP3Int()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3Int] = false;
            P3Int = default(P3Int);
        }
        #endregion
        #region PercentN
        ...
        Percent? ITestObject_HasBeenSet_ReadOnly_RPCGetter.PercentN => this.PercentN;
        protected void UnsetPercentN()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.PercentN] = false;
        ...
        Percent ITestObject_HasBeenSet_ReadOnly_RPCGetter.Percent => this.Percent;
        protected void UnsetPercent()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Percent] = false;
        ...
        RangeInt8? ITestObject_HasBeenSet_ReadOnly_RPCGetter.RangeInt8N => this.RangeInt8N;
        protected void UnsetRangeInt8N()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt8N] = false;
        ...
        RangeInt8 ITestObject_HasBeenSet_ReadOnly_RPCGetter.RangeInt8 => this.RangeInt8;
        protected void UnsetRangeInt8()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt8] = false;
        ...
        RangeInt16? ITestObject_HasBeenSet_ReadOnly_RPCGetter.RangeInt16N => this.RangeInt16N;
        protected void UnsetRangeInt16N()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt16N] = false;
        ...
        RangeInt16 ITestObject_HasBeenSet_ReadOnly_RPCGetter.RangeInt16 => this.RangeInt16;
        protected void UnsetRangeInt16()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt16] = false;
        ...
        RangeInt32? ITestObject_HasBeenSet_ReadOnly_RPCGetter.RangeInt32N => this.RangeInt32N;
        protected void UnsetRangeInt32N()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt32N] = false;
        ...
        RangeInt32 ITestObject_HasBeenSet_ReadOnly_RPCGetter.RangeInt32 => this.RangeInt32;
        protected void UnsetRangeInt32()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt32] = false;
        ...
        RangeInt64? ITestObject_HasBeenSet_ReadOnly_RPCGetter.RangeInt64N => this.RangeInt64N;
        protected void UnsetRangeInt64N()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt64N] = false;
        ...
        RangeInt64 ITestObject_HasBeenSet_ReadOnly_RPCGetter.RangeInt64 => this.RangeInt64;
        protected void UnsetRangeInt64()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt64] = false;
        ...
        RangeUInt8? ITestObject_HasBeenSet_ReadOnly_RPCGetter.RangeUInt8N => this.RangeUInt8N;
        protected void UnsetRangeUInt8N()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt8N] = false;
        ...
        RangeUInt8 ITestObject_HasBeenSet_ReadOnly_RPCGetter.RangeUInt8 => this.RangeUInt8;
        protected void UnsetRangeUInt8()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt8] = false;
        ...
        RangeUInt16? ITestObject_HasBeenSet_ReadOnly_RPCGetter.RangeUInt16N => this.RangeUInt16N;
        protected void UnsetRangeUInt16N()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt16N] = false;
        ...
        RangeUInt16 ITestObject_HasBeenSet_ReadOnly_RPCGetter.RangeUInt16 => this.RangeUInt16;
        protected void UnsetRangeUInt16()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt16] = false;
        ...
        RangeUInt32? ITestObject_HasBeenSet_ReadOnly_RPCGetter.RangeUInt32N => this.RangeUInt32N;
        protected void UnsetRangeUInt32N()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt32N] = false;
        ...
        RangeUInt32 ITestObject_HasBeenSet_ReadOnly_RPCGetter.RangeUInt32 => this.RangeUInt32;
        protected void UnsetRangeUInt32()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt32] = false;
        ...
        RangeUInt64? ITestObject_HasBeenSet_ReadOnly_RPCGetter.RangeUInt64N => this.RangeUInt64N;
        protected void UnsetRangeUInt64N()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt64N] = false;
        ...
        RangeUInt64 ITestObject_HasBeenSet_ReadOnly_RPCGetter.RangeUInt64 => this.RangeUInt64;
        protected void UnsetRangeUInt64()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt64] = false;
        ...
        String ITestObject_HasBeenSet_ReadOnly_RPCGetter.String => this.String;
        protected void UnsetString()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.String] = false;
        ...
        FilePath ITestObject_HasBeenSet_ReadOnly_RPCGetter.FilePath => this.FilePath;
        protected void UnsetFilePath()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.FilePath] = false;
        ...
        FilePath? ITestObject_HasBeenSet_ReadOnly_RPCGetter.FilePathNull => this.FilePathNull;
        protected void UnsetFilePathNull()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.FilePathNull] = false;
        ...
        DirectoryPath ITestObject_HasBeenSet_ReadOnly_RPCGetter.DirectoryPath => this.DirectoryPath;
        protected void UnsetDirectoryPath()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DirectoryPath] = false;
        ...
        DirectoryPath? ITestObject_HasBeenSet_ReadOnly_RPCGetter.DirectoryPathNull => this.DirectoryPathNull;
        protected void UnsetDirectoryPathNull()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DirectoryPathNull] = false;
        ...
        UDouble? ITestObject_HasBeenSet_ReadOnly_RPCGetter.UDoubleN => this.UDoubleN;
        protected void UnsetUDoubleN()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UDoubleN] = false;
        ...
        UDouble? ITestObject_HasBeenSet_ReadOnly_RPCGetter.UDoubleN_Ranged => this.UDoubleN_Ranged;
        IHasBeenSetItemGetter<UDouble?> ITestObject_HasBeenSet_ReadOnly_RPCGetter.UDoubleN_Ranged_Property => this.UDoubleN_Ranged_Property;
        ...
        UDouble ITestObject_HasBeenSet_ReadOnly_RPCGetter.UDouble => this.UDouble;
        protected void UnsetUDouble()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UDouble] = false;
        ...
        UDouble ITestObject_HasBeenSet_ReadOnly_RPCGetter.UDouble_Ranged => this.UDouble_Ranged;
        IHasBeenSetItemGetter<UDouble> ITestObject_HasBeenSet_ReadOnly_RPCGetter.UDouble_Ranged_Property => this.UDouble_Ranged_Property;
        ...
        UInt16? ITestObject_HasBeenSet_ReadOnly_RPCGetter.UInt16N => this.UInt16N;
        protected void UnsetUInt16N()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt16N] = false;
        ...
        UInt16? ITestObject_HasBeenSet_ReadOnly_RPCGetter.UInt16N_Ranged => this.UInt16N_Ranged;
        IHasBeenSetItemGetter<UInt16?> ITestObject_HasBeenSet_ReadOnly_RPCGetter.UInt16N_Ranged_Property => this.UInt16N_Ranged_Property;
        ...
        UInt16 ITestObject_HasBeenSet_ReadOnly_RPCGetter.UInt16 => this.UInt16;
        protected void UnsetUInt16()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt16] = false;
        ...
        UInt16 ITestObject_HasBeenSet_ReadOnly_RPCGetter.UInt16_Ranged => this.UInt16_Ranged;
        IHasBeenSetItemGetter<UInt16> ITestObject_HasBeenSet_ReadOnly_RPCGetter.UInt16_Ranged_Property => this.UInt16_Ranged_Property;
        ...
        UInt32? ITestObject_HasBeenSet_ReadOnly_RPCGetter.UInt32N => this.UInt32N;
        protected void UnsetUInt32N()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt32N] = false;
        ...
        UInt32? ITestObject_HasBeenSet_ReadOnly_RPCGetter.UInt32N_Ranged => this.UInt32N_Ranged;
        IHasBeenSetItemGetter<UInt32?> ITestObject_HasBeenSet_ReadOnly_RPCGetter.UInt32N_Ranged_Property => this.UInt32N_Ranged_Property;
        ...
        UInt32 ITestObject_HasBeenSet_ReadOnly_RPCGetter.UInt32 => this.UInt32;
        protected void UnsetUInt32()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt32] = false;
        ...
        UInt32 ITestObject_HasBeenSet_ReadOnly_RPCGetter.UInt32_Ranged => this.UInt32_Ranged;
        IHasBeenSetItemGetter<UInt32> ITestObject_HasBeenSet_ReadOnly_RPCGetter.UInt32_Ranged_Property => this.UInt32_Ranged_Property;
        ...
        UInt64? ITestObject_HasBeenSet_ReadOnly_RPCGetter.UInt64N => this.UInt64N;
        protected void UnsetUInt64N()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt64N] = false;
        ...
        UInt64? ITestObject_HasBeenSet_ReadOnly_RPCGetter.UInt64N_Ranged => this.UInt64N_Ranged;
        IHasBeenSetItemGetter<UInt64?> ITestObject_HasBeenSet_ReadOnly_RPCGetter.UInt64N_Ranged_Property => this.UInt64N_Ranged_Property;
        ...
        UInt64 ITestObject_HasBeenSet_ReadOnly_RPCGetter.UInt64 => this.UInt64;
        protected void UnsetUInt64()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt64] = false;
        ...
        UInt64 ITestObject_HasBeenSet_ReadOnly_RPCGetter.UInt64_Ranged => this.UInt64_Ranged;
        IHasBeenSetItemGetter<UInt64> ITestObject_HasBeenSet_ReadOnly_RPCGetter.UInt64_Ranged_Property => this.UInt64_Ranged_Property;
        ...
        Byte? ITestObject_HasBeenSet_ReadOnly_RPCGetter.UInt8N => this.UInt8N;
        protected void UnsetUInt8N()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt8N] = false;
            UInt8N = default(Byte?);
        }
        #endregion
        ...
        Byte? ITestObject_HasBeenSet_ReadOnly_RPCGetter.UInt8N_Ranged => this.UInt8N_Ranged;
        IHasBeenSetItemGetter<Byte?> ITestObject_HasBeenSet_ReadOnly_RPCGetter.UInt8N_Ranged_Property => this.UInt8N_Ranged_Property;
        ...
        Byte ITestObject_HasBeenSet_ReadOnly_RPCGetter.UInt8 => this.UInt8;
        protected void UnsetUInt8()
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt8] = false;
            UInt8 = default(Byte);
        }
        #endregion
        #region UInt8_Ranged
        ...
        Byte ITestObject_HasBeenSet_ReadOnly_RPCGetter.UInt8_Ranged => this.UInt8_Ranged;
        IHasBeenSetItemGetter<Byte> ITestObject_HasBeenSet_ReadOnly_RPCGetter.UInt8_Ranged_Property => this.UInt8_Ranged_Property;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Enum] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.EnumNull] = false;
        ...
        IHasBeenSetItemGetter<Object> ITestObject_HasBeenSet_ReadOnly_RPCGetter.WildCard_Property => this.WildCard_Property;
        #endregion
        ...
        IHasBeenSetItemGetter<Object> ITestObject_HasBeenSet_ReadOnly_RPCGetter.WildCardLoqui_Property => this.WildCardLoqui_Property;
        #endregion
        #region WildCardNull
        ...
        IHasBeenSetItemGetter<Object> ITestObject_HasBeenSet_ReadOnly_RPCGetter.WildCardNull_Property => this.WildCardNull_Property;
        #endregion
        #region Ref
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ObjectToRef ITestObject_HasBeenSet_ReadOnly_RPCGetter.Ref => this.Ref;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IHasBeenSetItemGetter<ObjectToRef> ITestObject_HasBeenSet_ReadOnly_RPCGetter.Ref_Property => this._Ref;
        #endregion
        #region Ref_NotNull
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ObjectToRef ITestObject_HasBeenSet_ReadOnly_RPCGetter.Ref_NotNull => this.Ref_NotNull;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IHasBeenSetItemGetter<ObjectToRef> ITestObject_HasBeenSet_ReadOnly_RPCGetter.Ref_NotNull_Property => this._Ref_NotNull;
        #endregion
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ObjectToRef ITestObject_HasBeenSet_ReadOnly_RPCGetter.Ref_Singleton => this.Ref_Singleton;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IHasBeenSetItemGetter<ObjectToRef> ITestObject_HasBeenSet_ReadOnly_RPCGetter.Ref_Singleton_Property => this._Ref_Singleton;
        #endregion
        #region RefGetter
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ObjectToRef ITestObject_HasBeenSet_ReadOnly_RPCGetter.RefGetter => this.RefGetter;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IHasBeenSetItemGetter<ObjectToRef> ITestObject_HasBeenSet_ReadOnly_RPCGetter.RefGetter_Property => this._RefGetter;
        #endregion
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ObjectToRef ITestObject_HasBeenSet_ReadOnly_RPCGetter.RefGetter_NotNull => this.RefGetter_NotNull;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IHasBeenSetItemGetter<ObjectToRef> ITestObject_HasBeenSet_ReadOnly_RPCGetter.RefGetter_NotNull_Property => this._RefGetter_NotNull;
        #endregion
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ObjectToRef ITestObject_HasBeenSet_ReadOnly_RPCGetter.RefGetter_Singleton => this.RefGetter_Singleton;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IHasBeenSetItemGetter<ObjectToRef> ITestObject_HasBeenSet_ReadOnly_RPCGetter.RefGetter_Singleton_Property => this._RefGetter_Singleton;
        #endregion
        #region RefSetter
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ObjectToRef ITestObject_HasBeenSet_ReadOnly_RPCGetter.RefSetter => this.RefSetter;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IHasBeenSetItemGetter<ObjectToRef> ITestObject_HasBeenSet_ReadOnly_RPCGetter.RefSetter_Property => this._RefSetter;
        #endregion
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ObjectToRef ITestObject_HasBeenSet_ReadOnly_RPCGetter.RefSetter_NotNull => this.RefSetter_NotNull;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IHasBeenSetItemGetter<ObjectToRef> ITestObject_HasBeenSet_ReadOnly_RPCGetter.RefSetter_NotNull_Property => this._RefSetter_NotNull;
        #endregion
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ObjectToRef ITestObject_HasBeenSet_ReadOnly_RPCGetter.RefSetter_Singleton => this.RefSetter_Singleton;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IHasBeenSetItemGetter<ObjectToRef> ITestObject_HasBeenSet_ReadOnly_RPCGetter.RefSetter_Singleton_Property => this._RefSetter_Singleton;
        #endregion
        #region List
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IObservableSetList<Boolean> ITestObject_HasBeenSet_ReadOnly_RPCGetter.List => _List;
        #endregion
        ...
        #region Interface Members
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IObservableSetList<ObjectToRef> ITestObject_HasBeenSet_ReadOnly_RPCGetter.RefList => _RefList;
        #endregion
        ...
        #region Interface Members
        INotifyingDictionaryGetter<String, Boolean> ITestObject_HasBeenSet_ReadOnly_RPCGetter.Dict => _Dict;
        #endregion
        ...
        #region Interface Members
        INotifyingDictionaryGetter<ObjectToRef, ObjectToRef> ITestObject_HasBeenSet_ReadOnly_RPCGetter.RefDict => _RefDict;
        #endregion
        ...
        #region Interface Members
        INotifyingDictionaryGetter<ObjectToRef, Boolean> ITestObject_HasBeenSet_ReadOnly_RPCGetter.KeyRefDict => _KeyRefDict;
        #endregion
        ...
        #region Interface Members
        INotifyingDictionaryGetter<String, ObjectToRef> ITestObject_HasBeenSet_ReadOnly_RPCGetter.ValRefDict => _ValRefDict;
        #endregion
        ...
        #region Interface Members
        IObservableSetCache<ObjectToRef, Int32> ITestObject_HasBeenSet_ReadOnly_RPCGetter.DictKeyedValue => _DictKeyedValue;
        #endregion
        ...
        protected object GetNthObject(ushort index) => TestObject_HasBeenSet_ReadOnly_RPCCommon.GetNthObject(index, this);
        object ILoquiObjectGetter.GetNthObject(ushort index) => this.GetNthObject(index);

        protected bool GetNthObjectHasBeenSet(ushort index) => TestObject_HasBeenSet_ReadOnly_RPCCommon.GetNthObjectHasBeenSet(index, this);
        bool ILoquiObjectGetter.GetNthObjectHasBeenSet(ushort index) => this.GetNthObjectHasBeenSet(index);

        protected void UnsetNthObject(ushort index, NotifyingUnsetParameters cmds) => TestObject_HasBeenSet_ReadOnly_RPCCommon.UnsetNthObject(index, this, cmds);
        ...
        {
            TestObject_HasBeenSet_ReadOnly_RPCCommon.SetNthObjectHasBeenSet(index, on, this);
        }
        void ILoquiObjectSetter.SetNthObjectHasBeenSet(ushort index, bool on) => this.SetNthObjectHasBeenSet(index, on);

        #endregion

        IMask<bool> IEqualsMask<TestObject_HasBeenSet_ReadOnly_RPC>.GetEqualsMask(TestObject_HasBeenSet_ReadOnly_RPC rhs, EqualsMaskHelper.Include include) => TestObject_HasBeenSet_ReadOnly_RPCCommon.GetEqualsMask(this, rhs, include);
        IMask<bool> IEqualsMask<ITestObject_HasBeenSet_ReadOnly_RPCGetter>.GetEqualsMask(ITestObject_HasBeenSet_ReadOnly_RPCGetter rhs, EqualsMaskHelper.Include include) => TestObject_HasBeenSet_ReadOnly_RPCCommon.GetEqualsMask(this, rhs, include);
        #region To String
        public override string ToString()
        {
            return TestObject_HasBeenSet_ReadOnly_RPCCommon.ToString(this, printMask: null);
        }

        public string ToString(
            string name = null,
            TestObject_HasBeenSet_ReadOnly_RPC_Mask<bool> printMask = null)
        {
            return TestObject_HasBeenSet_ReadOnly_RPCCommon.ToString(this, name: name, printMask: printMask);
        }
        ...
        public void ToString(
            ...
            string name = null)
        {
            TestObject_HasBeenSet_ReadOnly_RPCCommon.ToString(this, fg, name: name, printMask: null);
        }

        #endregion

        IMask<bool> ILoquiObjectGetter.GetHasBeenSetMask() => this.GetHasBeenSetMask();
        public TestObject_HasBeenSet_ReadOnly_RPC_Mask<bool> GetHasBeenSetMask()
        {
            return TestObject_HasBeenSet_ReadOnly_RPCCommon.GetHasBeenSetMask(this);
        }
        #region Equals and Hash
        public override bool Equals(object obj)
        {
            if (!(obj is TestObject_HasBeenSet_ReadOnly_RPC rhs)) return false;
            return Equals(rhs);
        }

        public bool Equals(TestObject_HasBeenSet_ReadOnly_RPC rhs)
        {
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static TestObject_HasBeenSet_ReadOnly_RPC Create_Xml(
            XElement node,
            TestObject_HasBeenSet_ReadOnly_RPC_TranslationMask translationMask = null)
        {
            return Create_Xml(
                node: node,
                errorMask: null,
            ...
            TestObject_HasBeenSet_ReadOnly_RPC_TranslationMask translationMask = null)
        {
            ...
            var ret = Create_Xml(
                ...
                translationMask: translationMask.GetCrystal());
            errorMask = TestObject_HasBeenSet_ReadOnly_RPC_ErrorMask.Factory(errorMaskBuilder);
            return ret;
        }
            ...
            TranslationCrystal translationMask)
        {
            ...
            try
            {
                foreach (var elem in node.Elements())
                {
                    ...
                    TestObject_HasBeenSet_ReadOnly_RPCCommon.FillPublicElement_Xml(
                        item: ret,
                        node: elem,
                        name: elem.Name.LocalName,
                        errorMask: errorMask,
        ...
        protected void CopyIn_Xml_Internal(
            ...
            NotifyingFireParameters cmds = null)
        {
            LoquiXmlTranslation<TestObject_HasBeenSet_ReadOnly_RPC>.Instance.CopyIn(
                node: node,
                item: this,
                skipProtected: true,
                errorMask: errorMask,
        ...
        public void CopyIn_Xml(
            string path,
            out TestObject_HasBeenSet_ReadOnly_RPC_ErrorMask errorMask,
            TestObject_HasBeenSet_ReadOnly_RPC_TranslationMask translationMask,
            NotifyingFireParameters cmds = null,
            bool doMasks = true)
        {
            var node = XDocument.Load(path).Root;
        ...
        public void Write_Xml(
            ...
            string name = null)
        {
            TestObject_HasBeenSet_ReadOnly_RPCCommon.Write_Xml(
                item: this,
                name: name,
                node: node,
                errorMask: errorMask,
        ...
        protected static void FillPrivateElement_Xml(
            TestObject_HasBeenSet_ReadOnly_RPC item,
            XElement node,
            string name,
            ErrorMaskBuilder errorMask,
            TranslationCrystal translationMask)
        {
            ...
            {
                case "ByteArray":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ByteArray) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ByteArray);
                    ...
                    break;
                case "ByteArrayNull":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ByteArrayNull) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ByteArrayNull);
                            if (ByteArrayXmlTranslation.Instance.Parse(
                                node: node,
                ...
                case "ByteArrayNotNull":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ByteArrayNotNull) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ByteArrayNotNull);
                            if (ByteArrayXmlTranslation.Instance.Parse(
                                node: node,
                ...
                case "ByteArraySingleton":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ByteArraySingleton) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ByteArraySingleton);
                            if (ByteArrayXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "BoolN":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.BoolN) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.BoolN);
                    ...
                    break;
                case "Bool":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Bool) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Bool);
                            if (BooleanXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "CharN":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.CharN) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.CharN);
                    ...
                    break;
                case "Char":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Char) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Char);
                            if (CharXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "DateTimeNull":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DateTimeNull) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DateTimeNull);
                    ...
                    break;
                case "DateTime":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DateTime) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DateTime);
                            if (DateTimeXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "DoubleN":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DoubleN) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DoubleN);
                    ...
                    break;
                case "DoubleN_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DoubleN_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DoubleN_Ranged);
                            if (DoubleXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Double":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Double) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Double);
                            if (DoubleXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Double_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Double_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Double_Ranged);
                            if (DoubleXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "FloatN":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.FloatN) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.FloatN);
                    ...
                    break;
                case "FloatN_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.FloatN_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.FloatN_Ranged);
                            if (FloatXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Float":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Float) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Float);
                            if (FloatXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Float_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Float_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Float_Ranged);
                            if (FloatXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Int16N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int16N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int16N);
                    ...
                    break;
                case "Int16N_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int16N_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int16N_Ranged);
                            if (Int16XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Int16":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int16) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int16);
                            if (Int16XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Int16_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int16_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int16_Ranged);
                            if (Int16XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Int32N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int32N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int32N);
                    ...
                    break;
                case "Int32N_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int32N_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int32N_Ranged);
                            if (Int32XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Int32":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int32) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int32);
                            if (Int32XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Int32_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int32_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int32_Ranged);
                            if (Int32XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Int64N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int64N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int64N);
                    ...
                    break;
                case "Int64N_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int64N_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int64N_Ranged);
                            if (Int64XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Int64":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int64) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int64);
                            if (Int64XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Int64_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int64_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int64_Ranged);
                            if (Int64XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Int8N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int8N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int8N);
                    ...
                    break;
                case "Int8N_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int8N_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int8N_Ranged);
                            if (Int8XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Int8":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int8) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int8);
                            if (Int8XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Int8_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int8_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int8_Ranged);
                            if (Int8XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Unsafe":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Unsafe) ?? true))
                    {
                        item.Unsafe = WildcardXmlTranslation.Instance.Parse(
                            root: node,
                            fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Unsafe,
                            errorMask: errorMask,
                            translationMask: translationMask).Bubble<bool>(i => (bool)i).GetOrDefault(item.Unsafe);
                    }
                    break;
                case "UnsafeLoqui":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UnsafeLoqui) ?? true))
                    {
                        item.UnsafeLoqui = WildcardXmlTranslation.Instance.Parse(
                            root: node,
                            fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UnsafeLoqui,
                            errorMask: errorMask,
                            translationMask: translationMask).Bubble<ObjectToRef>(i => (ObjectToRef)i).GetOrDefault(item.UnsafeLoqui);
                    }
                    break;
                case "UnsafeNull":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UnsafeNull) ?? true))
                    {
                        item.UnsafeNull = WildcardXmlTranslation.Instance.Parse(
                            root: node,
                            fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UnsafeNull,
                            errorMask: errorMask,
                            translationMask: translationMask).Bubble<ObjectToRef>(i => (ObjectToRef)i).GetOrDefault(item.UnsafeNull);
                    }
                    break;
                case "P2IntN":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P2IntN) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P2IntN);
                    ...
                    break;
                case "P2Int":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P2Int) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P2Int);
                            if (P2IntXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "P3DoubleN":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3DoubleN) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3DoubleN);
                    ...
                    break;
                case "P3Double":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3Double) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3Double);
                            if (P3DoubleXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "P3IntN":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3IntN) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3IntN);
                    ...
                    break;
                case "P3Int":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3Int) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3Int);
                            if (P3IntXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "PercentN":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.PercentN) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.PercentN);
                    ...
                    break;
                case "Percent":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Percent) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Percent);
                            if (PercentXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "RangeInt8N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt8N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt8N);
                    ...
                    break;
                case "RangeInt8":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt8) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt8);
                            if (RangeInt8XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "RangeInt16N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt16N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt16N);
                    ...
                    break;
                case "RangeInt16":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt16) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt16);
                            if (RangeInt16XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "RangeInt32N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt32N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt32N);
                    ...
                    break;
                case "RangeInt32":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt32) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt32);
                            if (RangeInt32XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "RangeInt64N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt64N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt64N);
                    ...
                    break;
                case "RangeInt64":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt64) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt64);
                            if (RangeInt64XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "RangeUInt8N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt8N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt8N);
                    ...
                    break;
                case "RangeUInt8":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt8) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt8);
                            if (RangeUInt8XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "RangeUInt16N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt16N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt16N);
                    ...
                    break;
                case "RangeUInt16":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt16) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt16);
                            if (RangeUInt16XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "RangeUInt32N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt32N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt32N);
                    ...
                    break;
                case "RangeUInt32":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt32) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt32);
                            if (RangeUInt32XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "RangeUInt64N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt64N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt64N);
                    ...
                    break;
                case "RangeUInt64":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt64) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt64);
                            if (RangeUInt64XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "String":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.String) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.String);
                    ...
                    break;
                case "FilePath":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.FilePath) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.FilePath);
                    ...
                    break;
                case "FilePathNull":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.FilePathNull) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.FilePathNull);
                            if (FilePathXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "DirectoryPath":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DirectoryPath) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DirectoryPath);
                ...
                case "DirectoryPathNull":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DirectoryPathNull) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DirectoryPathNull);
                            if (DirectoryPathXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UDoubleN":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UDoubleN) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UDoubleN);
                ...
                case "UDoubleN_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UDoubleN_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UDoubleN_Ranged);
                            if (UDoubleXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UDouble":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UDouble) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UDouble);
                            if (UDoubleXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UDouble_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UDouble_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UDouble_Ranged);
                            if (UDoubleXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UInt16N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt16N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt16N);
                    ...
                    break;
                case "UInt16N_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt16N_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt16N_Ranged);
                            if (UInt16XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UInt16":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt16) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt16);
                            if (UInt16XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UInt16_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt16_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt16_Ranged);
                            if (UInt16XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UInt32N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt32N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt32N);
                    ...
                    break;
                case "UInt32N_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt32N_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt32N_Ranged);
                            if (UInt32XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UInt32":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt32) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt32);
                            if (UInt32XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UInt32_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt32_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt32_Ranged);
                            if (UInt32XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UInt64N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt64N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt64N);
                    ...
                    break;
                case "UInt64N_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt64N_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt64N_Ranged);
                            if (UInt64XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UInt64":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt64) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt64);
                            if (UInt64XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UInt64_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt64_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt64_Ranged);
                            if (UInt64XmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UInt8N":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt8N) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt8N);
                    ...
                    break;
                case "UInt8N_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt8N_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt8N_Ranged);
                            if (ByteXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UInt8":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt8) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt8);
                            if (ByteXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "UInt8_Ranged":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt8_Ranged) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt8_Ranged);
                            if (ByteXmlTranslation.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "Enum":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Enum) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Enum);
                    ...
                    break;
                case "EnumNull":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.EnumNull) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.EnumNull);
                            if (EnumXmlTranslation<TestEnum>.Instance.Parse(
                                node: node,
                    ...
                    break;
                case "WildCard":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.WildCard) ?? true))
                    {
                        item.WildCard = WildcardXmlTranslation.Instance.Parse(
                            root: node,
                            fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.WildCard,
                            errorMask: errorMask,
                            translationMask: translationMask).Bubble<Object>(i => (Object)i).GetOrDefault(item.WildCard);
                    }
                    break;
                case "WildCardLoqui":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.WildCardLoqui) ?? true))
                    {
                        item.WildCardLoqui = WildcardXmlTranslation.Instance.Parse(
                            root: node,
                            fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.WildCardLoqui,
                            errorMask: errorMask,
                            translationMask: translationMask).Bubble<Object>(i => (Object)i).GetOrDefault(item.WildCardLoqui);
                    }
                    break;
                case "WildCardNull":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.WildCardNull) ?? true))
                    {
                        item.WildCardNull = WildcardXmlTranslation.Instance.Parse(
                            root: node,
                            fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.WildCardNull,
                            errorMask: errorMask,
                            translationMask: translationMask).Bubble<Object>(i => (Object)i).GetOrDefault(item.WildCardNull);
                    }
                    break;
                case "Ref":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Ref) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Ref);
                            if (LoquiXmlTranslation<ObjectToRef>.Instance.Parse(
                                node: node,
                                item: out ObjectToRef RefParse,
                                errorMask: errorMask,
                                translationMask: translationMask?.GetSubCrystal((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Ref)))
                            {
                                item.Ref = RefParse;
                            }
                            else
                    ...
                    break;
                case "Ref_NotNull":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Ref_NotNull) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Ref_NotNull);
                            if (LoquiXmlTranslation<ObjectToRef>.Instance.Parse(
                                node: node,
                                item: out ObjectToRef Ref_NotNullParse,
                                errorMask: errorMask,
                                translationMask: translationMask?.GetSubCrystal((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Ref_NotNull)))
                            {
                    ...
                    break;
                case "Ref_Singleton":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Ref_Singleton) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Ref_Singleton);
                    ...
                    break;
                case "RefGetter":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefGetter) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefGetter);
                            if (LoquiXmlTranslation<ObjectToRef>.Instance.Parse(
                                node: node,
                                item: out ObjectToRef RefGetterParse,
                                errorMask: errorMask,
                                translationMask: translationMask?.GetSubCrystal((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefGetter)))
                            {
                ...
                case "RefGetter_NotNull":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefGetter_NotNull) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefGetter_NotNull);
                            if (LoquiXmlTranslation<ObjectToRef>.Instance.Parse(
                                node: node,
                                item: out ObjectToRef RefGetter_NotNullParse,
                                errorMask: errorMask,
                                translationMask: translationMask?.GetSubCrystal((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefGetter_NotNull)))
                            {
                ...
                case "RefGetter_Singleton":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefGetter_Singleton) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefGetter_Singleton);
                    ...
                    break;
                case "RefSetter":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefSetter) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefSetter);
                            if (LoquiXmlTranslation<ObjectToRef>.Instance.Parse(
                                node: node,
                                item: out ObjectToRef RefSetterParse,
                                errorMask: errorMask,
                                translationMask: translationMask?.GetSubCrystal((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefSetter)))
                            {
                ...
                case "RefSetter_NotNull":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefSetter_NotNull) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefSetter_NotNull);
                            if (LoquiXmlTranslation<ObjectToRef>.Instance.Parse(
                                node: node,
                                item: out ObjectToRef RefSetter_NotNullParse,
                                errorMask: errorMask,
                                translationMask: translationMask?.GetSubCrystal((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefSetter_NotNull)))
                            {
                ...
                case "RefSetter_Singleton":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefSetter_Singleton) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefSetter_Singleton);
                    ...
                    break;
                case "List":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.List) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.List);
                    ...
                    break;
                case "RefList":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefList) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefList);
                    ...
                    break;
                case "Dict":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Dict) ?? true))
                    {
                        DictXmlTranslation<String, Boolean>.Instance.ParseInto(
                            node: node,
                            item: item.Dict,
                            fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Dict,
                            errorMask: errorMask,
                            translationMask: translationMask,
                    ...
                    break;
                case "RefDict":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefDict) ?? true))
                    {
                        DictXmlTranslation<ObjectToRef, ObjectToRef>.Instance.ParseInto(
                            node: node,
                            item: item.RefDict,
                            fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefDict,
                            errorMask: errorMask,
                            translationMask: translationMask,
                            keyTransl: (XElement r, int dictIndex, ErrorMaskBuilder dictErrMask, MaskItem<bool, ObjectToRef_TranslationMask> dictTranslMask) =>
                            {
                                try
                                {
                                    ...
                                    if (LoquiXmlTranslation<ObjectToRef>.Instance.Parse(
                                        ...
                                        errorMask: dictErrMask,
                                        translationMask: dictTranslMask?.GetSubCrystal((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.)))
                                    {
                                        return  = Parse;
                                    }
                                    else
                    ...
                    break;
                case "KeyRefDict":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.KeyRefDict) ?? true))
                    {
                        DictXmlTranslation<ObjectToRef, Boolean>.Instance.ParseInto(
                            node: node,
                            item: item.KeyRefDict,
                            fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.KeyRefDict,
                            errorMask: errorMask,
                            translationMask: translationMask,
                            keyTransl: (XElement r, int dictIndex, ErrorMaskBuilder dictErrMask, bool dictTranslMask) =>
                            {
                    ...
                    break;
                case "ValRefDict":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ValRefDict) ?? true))
                    {
                        DictXmlTranslation<String, ObjectToRef>.Instance.ParseInto(
                            node: node,
                            item: item.ValRefDict,
                            fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ValRefDict,
                            errorMask: errorMask,
                            translationMask: translationMask,
                            keyTransl: (XElement r, int dictIndex, ErrorMaskBuilder dictErrMask, MaskItem<bool, ObjectToRef_TranslationMask> dictTranslMask) =>
                            {
                    ...
                    break;
                case "DictKeyedValue":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DictKeyedValue) ?? true))
                    {
                        KeyedDictXmlTranslation<Int32, ObjectToRef>.Instance.ParseInto(
                            node: node,
                            item: item.DictKeyedValue,
                            fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DictKeyedValue,
                            errorMask: errorMask,
                            translationMask: translationMask,
        ...
        {
            switch ((TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex)index)
            {
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ByteArray:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ByteArrayNull:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ByteArrayNotNull:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ByteArraySingleton:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.BoolN:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Bool:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.CharN:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Char:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DateTimeNull:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DateTime:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DoubleN:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DoubleN_Ranged:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Double:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Double_Ranged:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.FloatN:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.FloatN_Ranged:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Float:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Float_Ranged:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int16N:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int16N_Ranged:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int16:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int16_Ranged:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int32N:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int32N_Ranged:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int32:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int32_Ranged:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int64N:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int64N_Ranged:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int64:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int64_Ranged:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int8N:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int8N_Ranged:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int8:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int8_Ranged:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Unsafe:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UnsafeLoqui:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UnsafeNull:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P2IntN:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P2Int:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3DoubleN:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3Double:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3IntN:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3Int:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.PercentN:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Percent:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt8N:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt8:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt16N:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt16:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt32N:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt32:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt64N:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt64:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt8N:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt8:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt16N:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt16:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt32N:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt32:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt64N:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt64:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.String:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.FilePath:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.FilePathNull:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DirectoryPath:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DirectoryPathNull:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UDoubleN:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UDoubleN_Ranged:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UDouble:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UDouble_Ranged:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt16N:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt16N_Ranged:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt16:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt16_Ranged:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt32N:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt32N_Ranged:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt32:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt32_Ranged:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt64N:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt64N_Ranged:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt64:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt64_Ranged:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt8N:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt8N_Ranged:
                ...
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.WildCardLoqui:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.WildCardNull:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Ref:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Ref_NotNull:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Ref_Singleton:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefGetter:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefGetter_NotNull:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefGetter_Singleton:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefSetter:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefSetter_NotNull:
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefSetter_Singleton:
                    return _hasBeenSetTracker[index];
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.List:
                    return List.HasBeenSet;
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefList:
                    return RefList.HasBeenSet;
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Dict:
                    return Dict.HasBeenSet;
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefDict:
                    return RefDict.HasBeenSet;
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.KeyRefDict:
                    return KeyRefDict.HasBeenSet;
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ValRefDict:
                    return ValRefDict.HasBeenSet;
                case TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DictKeyedValue:
        ...
        public TestObject_HasBeenSet_ReadOnly_RPC Copy(
            TestObject_HasBeenSet_ReadOnly_RPC_CopyMask copyMask = null,
            ITestObject_HasBeenSet_ReadOnly_RPCGetter def = null)
        {
            return TestObject_HasBeenSet_ReadOnly_RPC.Copy(
                this,
                copyMask: copyMask,
                def: def);
        }

        public static TestObject_HasBeenSet_ReadOnly_RPC Copy(
            ITestObject_HasBeenSet_ReadOnly_RPC item,
            TestObject_HasBeenSet_ReadOnly_RPC_CopyMask copyMask = null,
            ITestObject_HasBeenSet_ReadOnly_RPCGetter def = null)
        {
            ...
            {
                ret = new TestObject_HasBeenSet_ReadOnly_RPC();
            }
            else
            {
                ret = (TestObject_HasBeenSet_ReadOnly_RPC)System.Activator.CreateInstance(item.GetType());
            }
            ret.CopyFieldsFrom(
                item,
                copyMask: copyMask,
        ...
        public static TestObject_HasBeenSet_ReadOnly_RPC Copy_ToLoqui(
            ITestObject_HasBeenSet_ReadOnly_RPCGetter item,
            TestObject_HasBeenSet_ReadOnly_RPC_CopyMask copyMask = null,
            ITestObject_HasBeenSet_ReadOnly_RPCGetter def = null)
        {
            TestObject_HasBeenSet_ReadOnly_RPC ret;
        ...
        {
            this.CopyFieldsFrom(
                rhs: (ITestObject_HasBeenSet_ReadOnly_RPCGetter)rhs,
                def: null,
                doMasks: false,
        ...
        public void Clear(NotifyingUnsetParameters cmds = null)
        {
            ...
            TestObject_HasBeenSet_ReadOnly_RPCCommon.Clear(this, cmds);
        }


        public static TestObject_HasBeenSet_ReadOnly_RPC Create(IEnumerable<KeyValuePair<ushort, object>> fields)
        {
            var ret = new TestObject_HasBeenSet_ReadOnly_RPC();
            foreach (var pair in fields)
            {
                CopyInInternal_TestObject_HasBeenSet_ReadOnly_RPC(ret, pair);
            }
            return ret;
        }

        protected static void CopyInInternal_TestObject_HasBeenSet_ReadOnly_RPC(TestObject_HasBeenSet_ReadOnly_RPC obj, KeyValuePair<ushort, object> pair)
        {
            if (!EnumExt.TryParse(pair.Key, out TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex enu))
            {
        ...
        public static void CopyIn(IEnumerable<KeyValuePair<ushort, object>> fields, TestObject_HasBeenSet_ReadOnly_RPC obj)
        {
    ...
    #region Interface
    public partial interface ITestObject_HasBeenSet_ReadOnly_RPC : ITestObject_HasBeenSet_ReadOnly_RPCGetter, ILoquiClass<ITestObject_HasBeenSet_ReadOnly_RPC, ITestObject_HasBeenSet_ReadOnly_RPCGetter>, ILoquiClass<TestObject_HasBeenSet_ReadOnly_RPC, ITestObject_HasBeenSet_ReadOnly_RPCGetter>
    {
    }

    public partial interface ITestObject_HasBeenSet_ReadOnly_RPCGetter : ILoquiObject
    {
        #region ByteArray
        Byte[] ByteArray { get; }
...
{
    #region Field Index
    public enum TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex
    {
        ByteArray = 0,
        ByteArrayNull = 1,
        ByteArrayNotNull = 2,
    ...
    #region Registration
    public class TestObject_HasBeenSet_ReadOnly_RPC_Registration : ILoquiRegistration
    {
        public static readonly TestObject_HasBeenSet_ReadOnly_RPC_Registration Instance = new TestObject_HasBeenSet_ReadOnly_RPC_Registration();
        ...
        public static readonly Type ErrorMaskType = typeof(TestObject_HasBeenSet_ReadOnly_RPC_ErrorMask);

        public static readonly Type ClassType = typeof(TestObject_HasBeenSet_ReadOnly_RPC);

        public static readonly Type GetterType = typeof(ITestObject_HasBeenSet_ReadOnly_RPCGetter);

        public static readonly Type SetterType = typeof(ITestObject_HasBeenSet_ReadOnly_RPC);

        public static readonly Type CommonType = typeof(TestObject_HasBeenSet_ReadOnly_RPCCommon);

        public const string FullName = "Loqui.Tests.Generated.TestObject_HasBeenSet_ReadOnly_RPC";

        public const string Name = "TestObject_HasBeenSet_ReadOnly_RPC";
        ...
        public static ushort? GetNameIndex(StringCaseAgnostic str)
        {
            ...
            {
                case "BYTEARRAY":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ByteArray;
                case "BYTEARRAYNULL":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ByteArrayNull;
                case "BYTEARRAYNOTNULL":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ByteArrayNotNull;
                case "BYTEARRAYSINGLETON":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ByteArraySingleton;
                case "BOOLN":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.BoolN;
                case "BOOL":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Bool;
                case "CHARN":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.CharN;
                case "CHAR":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Char;
                case "DATETIMENULL":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DateTimeNull;
                case "DATETIME":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DateTime;
                case "DOUBLEN":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DoubleN;
                case "DOUBLEN_RANGED":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DoubleN_Ranged;
                case "DOUBLE":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Double;
                case "DOUBLE_RANGED":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Double_Ranged;
                case "FLOATN":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.FloatN;
                case "FLOATN_RANGED":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.FloatN_Ranged;
                case "FLOAT":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Float;
                case "FLOAT_RANGED":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Float_Ranged;
                case "INT16N":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int16N;
                case "INT16N_RANGED":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int16N_Ranged;
                case "INT16":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int16;
                case "INT16_RANGED":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int16_Ranged;
                case "INT32N":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int32N;
                case "INT32N_RANGED":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int32N_Ranged;
                case "INT32":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int32;
                case "INT32_RANGED":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int32_Ranged;
                case "INT64N":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int64N;
                case "INT64N_RANGED":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int64N_Ranged;
                case "INT64":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int64;
                case "INT64_RANGED":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int64_Ranged;
                case "INT8N":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int8N;
                case "INT8N_RANGED":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int8N_Ranged;
                case "INT8":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int8;
                case "INT8_RANGED":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int8_Ranged;
                case "UNSAFE":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Unsafe;
                case "UNSAFELOQUI":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UnsafeLoqui;
                case "UNSAFENULL":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UnsafeNull;
                case "P2INTN":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P2IntN;
                case "P2INT":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P2Int;
                case "P3DOUBLEN":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3DoubleN;
                case "P3DOUBLE":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3Double;
                case "P3INTN":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3IntN;
                case "P3INT":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3Int;
                case "PERCENTN":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.PercentN;
                case "PERCENT":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Percent;
                case "RANGEINT8N":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt8N;
                case "RANGEINT8":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt8;
                case "RANGEINT16N":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt16N;
                case "RANGEINT16":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt16;
                case "RANGEINT32N":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt32N;
                case "RANGEINT32":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt32;
                case "RANGEINT64N":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt64N;
                case "RANGEINT64":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt64;
                case "RANGEUINT8N":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt8N;
                case "RANGEUINT8":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt8;
                case "RANGEUINT16N":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt16N;
                case "RANGEUINT16":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt16;
                case "RANGEUINT32N":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt32N;
                case "RANGEUINT32":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt32;
                case "RANGEUINT64N":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt64N;
                case "RANGEUINT64":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt64;
                case "STRING":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.String;
                case "FILEPATH":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.FilePath;
                case "FILEPATHNULL":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.FilePathNull;
                case "DIRECTORYPATH":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DirectoryPath;
                case "DIRECTORYPATHNULL":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DirectoryPathNull;
                case "UDOUBLEN":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UDoubleN;
                case "UDOUBLEN_RANGED":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UDoubleN_Ranged;
                case "UDOUBLE":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UDouble;
                case "UDOUBLE_RANGED":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UDouble_Ranged;
                case "UINT16N":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt16N;
                case "UINT16N_RANGED":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt16N_Ranged;
                case "UINT16":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt16;
                case "UINT16_RANGED":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt16_Ranged;
                case "UINT32N":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt32N;
                case "UINT32N_RANGED":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt32N_Ranged;
                case "UINT32":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt32;
                case "UINT32_RANGED":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt32_Ranged;
                case "UINT64N":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt64N;
                case "UINT64N_RANGED":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt64N_Ranged;
                case "UINT64":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt64;
                case "UINT64_RANGED":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt64_Ranged;
                case "UINT8N":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt8N;
                case "UINT8N_RANGED":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt8N_Ranged;
                case "UINT8":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt8;
                case "UINT8_RANGED":
                ...
                case "WILDCARDLOQUI":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.WildCardLoqui;
                case "WILDCARDNULL":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.WildCardNull;
                case "REF":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Ref;
                case "REF_NOTNULL":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Ref_NotNull;
                case "REF_SINGLETON":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Ref_Singleton;
                case "REFGETTER":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefGetter;
                case "REFGETTER_NOTNULL":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefGetter_NotNull;
                case "REFGETTER_SINGLETON":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefGetter_Singleton;
                case "REFSETTER":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefSetter;
                case "REFSETTER_NOTNULL":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefSetter_NotNull;
                case "REFSETTER_SINGLETON":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefSetter_Singleton;
                case "LIST":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.List;
                case "REFLIST":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefList;
                case "DICT":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Dict;
                case "REFDICT":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefDict;
                case "KEYREFDICT":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.KeyRefDict;
                case "VALREFDICT":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ValRefDict;
                case "DICTKEYEDVALUE":
                    return (ushort)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DictKeyedValue;
                default:
                    return null;
            }
        }
    ...
    #region Extensions
    public static partial class TestObject_HasBeenSet_ReadOnly_RPCCommon
    {
        ...
        public static void SetNthObjectHasBeenSet(
            ushort index,
            bool on,
            ITestObject_HasBeenSet_ReadOnly_RPC obj,
            NotifyingFireParameters cmds = null)
        {
            TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex enu = (TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex)index;
            switch (enu)
        ...
        public static object GetNthObject(
            ushort index,
            ITestObject_HasBeenSet_ReadOnly_RPCGetter obj)
        {
            TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex enu = (TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex)index;
            switch (enu)
            {
        ...
        public static TestObject_HasBeenSet_ReadOnly_RPC_Mask<bool> GetEqualsMask(
            this ITestObject_HasBeenSet_ReadOnly_RPCGetter item,
            ITestObject_HasBeenSet_ReadOnly_RPCGetter rhs,
            EqualsMaskHelper.Include include = EqualsMaskHelper.Include.All)
        {
            var ret = new TestObject_HasBeenSet_ReadOnly_RPC_Mask<bool>();
            FillEqualsMask(
                item: item,
                rhs: rhs,
                ret: ret,
        ...
        public static void FillEqualsMask(
            ITestObject_HasBeenSet_ReadOnly_RPCGetter item,
            ITestObject_HasBeenSet_ReadOnly_RPCGetter rhs,
            TestObject_HasBeenSet_ReadOnly_RPC_Mask<bool> ret,
            EqualsMaskHelper.Include include = EqualsMaskHelper.Include.All)
        {
            if (rhs == null) return;
            ...
            TestObject_HasBeenSet_ReadOnly_RPC_Mask<bool> printMask = null)
        {
            if (name == null)
            {
                fg.AppendLine($"{nameof(TestObject_HasBeenSet_ReadOnly_RPC)} =>");
            }
            else
            {
                fg.AppendLine($"{name} ({nameof(TestObject_HasBeenSet_ReadOnly_RPC)}) =>");
            }
            fg.AppendLine("[");
        ...
        public static bool HasBeenSet(
            this ITestObject_HasBeenSet_ReadOnly_RPCGetter item,
            TestObject_HasBeenSet_ReadOnly_RPC_Mask<bool?> checkMask)
        {
        ...
        public static TestObject_HasBeenSet_ReadOnly_RPC_Mask<bool> GetHasBeenSetMask(ITestObject_HasBeenSet_ReadOnly_RPCGetter item)
        {
            var ret = new TestObject_HasBeenSet_ReadOnly_RPC_Mask<bool>();
        ...
        public static void Write_Xml(
            ...
            string name = null)
        {
            var elem = new XElement(name ?? "Loqui.Tests.Generated.TestObject_HasBeenSet_ReadOnly_RPC");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Loqui.Tests.Generated.TestObject_HasBeenSet_ReadOnly_RPC");
            }
            WriteToNode_Xml(
                item: item,
                node: elem,
            ...
            TranslationCrystal translationMask)
        {
            if (item.ByteArray_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ByteArray) ?? true))
            {
                ByteArrayXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.ByteArray),
                    item: item.ByteArray,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ByteArray,
                    errorMask: errorMask);
            }
            if (item.ByteArrayNull_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ByteArrayNull) ?? true))
            {
                ByteArrayXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.ByteArrayNull),
                    item: item.ByteArrayNull,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ByteArrayNull,
                    errorMask: errorMask);
            }
            if (item.ByteArrayNotNull_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ByteArrayNotNull) ?? true))
            {
                ByteArrayXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.ByteArrayNotNull),
                    item: item.ByteArrayNotNull,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ByteArrayNotNull,
                    errorMask: errorMask);
            }
            if (item.ByteArraySingleton_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ByteArraySingleton) ?? true))
            {
                ByteArrayXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.ByteArraySingleton),
                    item: item.ByteArraySingleton,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ByteArraySingleton,
                    errorMask: errorMask);
            }
            if (item.BoolN_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.BoolN) ?? true))
            {
                BooleanXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.BoolN),
                    item: item.BoolN,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.BoolN,
                    errorMask: errorMask);
            }
            if (item.Bool_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Bool) ?? true))
            {
                BooleanXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Bool),
                    item: item.Bool,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Bool,
                    errorMask: errorMask);
            }
            if (item.CharN_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.CharN) ?? true))
            {
                CharXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.CharN),
                    item: item.CharN,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.CharN,
                    errorMask: errorMask);
            }
            if (item.Char_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Char) ?? true))
            {
                CharXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Char),
                    item: item.Char,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Char,
                    errorMask: errorMask);
            }
            if (item.DateTimeNull_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DateTimeNull) ?? true))
            {
                DateTimeXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.DateTimeNull),
                    item: item.DateTimeNull,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DateTimeNull,
                    errorMask: errorMask);
            }
            if (item.DateTime_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DateTime) ?? true))
            {
                DateTimeXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.DateTime),
                    item: item.DateTime,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DateTime,
                    errorMask: errorMask);
            }
            if (item.DoubleN_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DoubleN) ?? true))
            {
                DoubleXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.DoubleN),
                    item: item.DoubleN,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DoubleN,
                    errorMask: errorMask);
            }
            if (item.DoubleN_Ranged_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DoubleN_Ranged) ?? true))
            {
                DoubleXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.DoubleN_Ranged),
                    item: item.DoubleN_Ranged,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DoubleN_Ranged,
                    errorMask: errorMask);
            }
            if (item.Double_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Double) ?? true))
            {
                DoubleXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Double),
                    item: item.Double,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Double,
                    errorMask: errorMask);
            }
            if (item.Double_Ranged_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Double_Ranged) ?? true))
            {
                DoubleXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Double_Ranged),
                    item: item.Double_Ranged,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Double_Ranged,
                    errorMask: errorMask);
            }
            if (item.FloatN_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.FloatN) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.FloatN),
                    item: item.FloatN,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.FloatN,
                    errorMask: errorMask);
            }
            if (item.FloatN_Ranged_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.FloatN_Ranged) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.FloatN_Ranged),
                    item: item.FloatN_Ranged,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.FloatN_Ranged,
                    errorMask: errorMask);
            }
            if (item.Float_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Float) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Float),
                    item: item.Float,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Float,
                    errorMask: errorMask);
            }
            if (item.Float_Ranged_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Float_Ranged) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Float_Ranged),
                    item: item.Float_Ranged,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Float_Ranged,
                    errorMask: errorMask);
            }
            if (item.Int16N_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int16N) ?? true))
            {
                Int16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int16N),
                    item: item.Int16N,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int16N,
                    errorMask: errorMask);
            }
            if (item.Int16N_Ranged_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int16N_Ranged) ?? true))
            {
                Int16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int16N_Ranged),
                    item: item.Int16N_Ranged,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int16N_Ranged,
                    errorMask: errorMask);
            }
            if (item.Int16_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int16) ?? true))
            {
                Int16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int16),
                    item: item.Int16,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int16,
                    errorMask: errorMask);
            }
            if (item.Int16_Ranged_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int16_Ranged) ?? true))
            {
                Int16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int16_Ranged),
                    item: item.Int16_Ranged,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int16_Ranged,
                    errorMask: errorMask);
            }
            if (item.Int32N_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int32N) ?? true))
            {
                Int32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int32N),
                    item: item.Int32N,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int32N,
                    errorMask: errorMask);
            }
            if (item.Int32N_Ranged_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int32N_Ranged) ?? true))
            {
                Int32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int32N_Ranged),
                    item: item.Int32N_Ranged,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int32N_Ranged,
                    errorMask: errorMask);
            }
            if (item.Int32_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int32) ?? true))
            {
                Int32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int32),
                    item: item.Int32,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int32,
                    errorMask: errorMask);
            }
            if (item.Int32_Ranged_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int32_Ranged) ?? true))
            {
                Int32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int32_Ranged),
                    item: item.Int32_Ranged,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int32_Ranged,
                    errorMask: errorMask);
            }
            if (item.Int64N_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int64N) ?? true))
            {
                Int64XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int64N),
                    item: item.Int64N,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int64N,
                    errorMask: errorMask);
            }
            if (item.Int64N_Ranged_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int64N_Ranged) ?? true))
            {
                Int64XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int64N_Ranged),
                    item: item.Int64N_Ranged,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int64N_Ranged,
                    errorMask: errorMask);
            }
            if (item.Int64_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int64) ?? true))
            {
                Int64XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int64),
                    item: item.Int64,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int64,
                    errorMask: errorMask);
            }
            if (item.Int64_Ranged_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int64_Ranged) ?? true))
            {
                Int64XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int64_Ranged),
                    item: item.Int64_Ranged,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int64_Ranged,
                    errorMask: errorMask);
            }
            if (item.Int8N_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int8N) ?? true))
            {
                Int8XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int8N),
                    item: item.Int8N,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int8N,
                    errorMask: errorMask);
            }
            if (item.Int8N_Ranged_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int8N_Ranged) ?? true))
            {
                Int8XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int8N_Ranged),
                    item: item.Int8N_Ranged,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int8N_Ranged,
                    errorMask: errorMask);
            }
            if (item.Int8_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int8) ?? true))
            {
                Int8XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int8),
                    item: item.Int8,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int8,
                    errorMask: errorMask);
            }
            if (item.Int8_Ranged_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int8_Ranged) ?? true))
            {
                Int8XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int8_Ranged),
                    item: item.Int8_Ranged,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Int8_Ranged,
                    errorMask: errorMask);
            }
            if (item.Unsafe_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Unsafe) ?? true))
            {
            ...
            if (item.UnsafeLoqui_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UnsafeLoqui) ?? true))
            {
                WildcardXmlTranslation.Instance.Write(
                    node: node,
            ...
            if (item.UnsafeNull_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UnsafeNull) ?? true))
            {
                WildcardXmlTranslation.Instance.Write(
                    node: node,
            ...
            if (item.P2IntN_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P2IntN) ?? true))
            {
                P2IntXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.P2IntN),
                    item: item.P2IntN,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P2IntN,
                    errorMask: errorMask);
            }
            if (item.P2Int_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P2Int) ?? true))
            {
                P2IntXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.P2Int),
                    item: item.P2Int,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P2Int,
                    errorMask: errorMask);
            }
            if (item.P3DoubleN_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3DoubleN) ?? true))
            {
                P3DoubleXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.P3DoubleN),
                    item: item.P3DoubleN,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3DoubleN,
                    errorMask: errorMask);
            }
            if (item.P3Double_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3Double) ?? true))
            {
                P3DoubleXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.P3Double),
                    item: item.P3Double,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3Double,
                    errorMask: errorMask);
            }
            if (item.P3IntN_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3IntN) ?? true))
            {
                P3IntXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.P3IntN),
                    item: item.P3IntN,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3IntN,
                    errorMask: errorMask);
            }
            if (item.P3Int_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3Int) ?? true))
            {
                P3IntXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.P3Int),
                    item: item.P3Int,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.P3Int,
                    errorMask: errorMask);
            }
            if (item.PercentN_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.PercentN) ?? true))
            {
                PercentXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.PercentN),
                    item: item.PercentN,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.PercentN,
                    errorMask: errorMask);
            }
            if (item.Percent_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Percent) ?? true))
            {
                PercentXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Percent),
                    item: item.Percent,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Percent,
                    errorMask: errorMask);
            }
            if (item.RangeInt8N_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt8N) ?? true))
            {
                RangeInt8XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeInt8N),
                    item: item.RangeInt8N,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt8N,
                    errorMask: errorMask);
            }
            if (item.RangeInt8_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt8) ?? true))
            {
                RangeInt8XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeInt8),
                    item: item.RangeInt8,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt8,
                    errorMask: errorMask);
            }
            if (item.RangeInt16N_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt16N) ?? true))
            {
                RangeInt16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeInt16N),
                    item: item.RangeInt16N,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt16N,
                    errorMask: errorMask);
            }
            if (item.RangeInt16_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt16) ?? true))
            {
                RangeInt16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeInt16),
                    item: item.RangeInt16,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt16,
                    errorMask: errorMask);
            }
            if (item.RangeInt32N_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt32N) ?? true))
            {
                RangeInt32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeInt32N),
                    item: item.RangeInt32N,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt32N,
                    errorMask: errorMask);
            }
            if (item.RangeInt32_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt32) ?? true))
            {
                RangeInt32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeInt32),
                    item: item.RangeInt32,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt32,
                    errorMask: errorMask);
            }
            if (item.RangeInt64N_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt64N) ?? true))
            {
                RangeInt64XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeInt64N),
                    item: item.RangeInt64N,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt64N,
                    errorMask: errorMask);
            }
            if (item.RangeInt64_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt64) ?? true))
            {
                RangeInt64XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeInt64),
                    item: item.RangeInt64,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeInt64,
                    errorMask: errorMask);
            }
            if (item.RangeUInt8N_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt8N) ?? true))
            {
                RangeUInt8XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeUInt8N),
                    item: item.RangeUInt8N,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt8N,
                    errorMask: errorMask);
            }
            if (item.RangeUInt8_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt8) ?? true))
            {
                RangeUInt8XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeUInt8),
                    item: item.RangeUInt8,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt8,
                    errorMask: errorMask);
            }
            if (item.RangeUInt16N_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt16N) ?? true))
            {
                RangeUInt16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeUInt16N),
                    item: item.RangeUInt16N,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt16N,
                    errorMask: errorMask);
            }
            if (item.RangeUInt16_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt16) ?? true))
            {
                RangeUInt16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeUInt16),
                    item: item.RangeUInt16,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt16,
                    errorMask: errorMask);
            }
            if (item.RangeUInt32N_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt32N) ?? true))
            {
                RangeUInt32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeUInt32N),
                    item: item.RangeUInt32N,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt32N,
                    errorMask: errorMask);
            }
            if (item.RangeUInt32_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt32) ?? true))
            {
                RangeUInt32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeUInt32),
                    item: item.RangeUInt32,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt32,
                    errorMask: errorMask);
            }
            if (item.RangeUInt64N_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt64N) ?? true))
            {
                RangeUInt64XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeUInt64N),
                    item: item.RangeUInt64N,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt64N,
                    errorMask: errorMask);
            }
            if (item.RangeUInt64_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt64) ?? true))
            {
                RangeUInt64XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeUInt64),
                    item: item.RangeUInt64,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RangeUInt64,
                    errorMask: errorMask);
            }
            if (item.String_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.String) ?? true))
            {
                StringXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.String),
                    item: item.String,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.String,
                    errorMask: errorMask);
            }
            if (item.FilePath_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.FilePath) ?? true))
            {
                FilePathXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.FilePath),
                    item: item.FilePath,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.FilePath,
                    errorMask: errorMask);
            }
            if (item.FilePathNull_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.FilePathNull) ?? true))
            {
                FilePathXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.FilePathNull),
                    item: item.FilePathNull,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.FilePathNull,
                    errorMask: errorMask);
            }
            if (item.DirectoryPath_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DirectoryPath) ?? true))
            {
                DirectoryPathXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.DirectoryPath),
                    item: item.DirectoryPath,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DirectoryPath,
                    errorMask: errorMask);
            }
            if (item.DirectoryPathNull_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DirectoryPathNull) ?? true))
            {
                DirectoryPathXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.DirectoryPathNull),
                    item: item.DirectoryPathNull,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DirectoryPathNull,
                    errorMask: errorMask);
            }
            if (item.UDoubleN_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UDoubleN) ?? true))
            {
                UDoubleXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UDoubleN),
                    item: item.UDoubleN,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UDoubleN,
                    errorMask: errorMask);
            }
            if (item.UDoubleN_Ranged_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UDoubleN_Ranged) ?? true))
            {
                UDoubleXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UDoubleN_Ranged),
                    item: item.UDoubleN_Ranged,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UDoubleN_Ranged,
                    errorMask: errorMask);
            }
            if (item.UDouble_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UDouble) ?? true))
            {
                UDoubleXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UDouble),
                    item: item.UDouble,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UDouble,
                    errorMask: errorMask);
            }
            if (item.UDouble_Ranged_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UDouble_Ranged) ?? true))
            {
                UDoubleXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UDouble_Ranged),
                    item: item.UDouble_Ranged,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UDouble_Ranged,
                    errorMask: errorMask);
            }
            if (item.UInt16N_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt16N) ?? true))
            {
                UInt16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt16N),
                    item: item.UInt16N,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt16N,
                    errorMask: errorMask);
            }
            if (item.UInt16N_Ranged_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt16N_Ranged) ?? true))
            {
                UInt16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt16N_Ranged),
                    item: item.UInt16N_Ranged,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt16N_Ranged,
                    errorMask: errorMask);
            }
            if (item.UInt16_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt16) ?? true))
            {
                UInt16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt16),
                    item: item.UInt16,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt16,
                    errorMask: errorMask);
            }
            if (item.UInt16_Ranged_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt16_Ranged) ?? true))
            {
                UInt16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt16_Ranged),
                    item: item.UInt16_Ranged,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt16_Ranged,
                    errorMask: errorMask);
            }
            if (item.UInt32N_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt32N) ?? true))
            {
                UInt32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt32N),
                    item: item.UInt32N,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt32N,
                    errorMask: errorMask);
            }
            if (item.UInt32N_Ranged_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt32N_Ranged) ?? true))
            {
                UInt32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt32N_Ranged),
                    item: item.UInt32N_Ranged,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt32N_Ranged,
                    errorMask: errorMask);
            }
            if (item.UInt32_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt32) ?? true))
            {
                UInt32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt32),
                    item: item.UInt32,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt32,
                    errorMask: errorMask);
            }
            if (item.UInt32_Ranged_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt32_Ranged) ?? true))
            {
                UInt32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt32_Ranged),
                    item: item.UInt32_Ranged,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt32_Ranged,
                    errorMask: errorMask);
            }
            if (item.UInt64N_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt64N) ?? true))
            {
                UInt64XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt64N),
                    item: item.UInt64N,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt64N,
                    errorMask: errorMask);
            }
            if (item.UInt64N_Ranged_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt64N_Ranged) ?? true))
            {
                UInt64XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt64N_Ranged),
                    item: item.UInt64N_Ranged,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt64N_Ranged,
                    errorMask: errorMask);
            }
            if (item.UInt64_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt64) ?? true))
            {
                UInt64XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt64),
                    item: item.UInt64,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt64,
                    errorMask: errorMask);
            }
            if (item.UInt64_Ranged_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt64_Ranged) ?? true))
            {
                UInt64XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt64_Ranged),
                    item: item.UInt64_Ranged,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt64_Ranged,
                    errorMask: errorMask);
            }
            if (item.UInt8N_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt8N) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt8N),
                    item: item.UInt8N,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt8N,
                    errorMask: errorMask);
            }
            if (item.UInt8N_Ranged_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt8N_Ranged) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt8N_Ranged),
                    item: item.UInt8N_Ranged,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt8N_Ranged,
                    errorMask: errorMask);
            }
            if (item.UInt8_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt8) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt8),
                    item: item.UInt8,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt8,
                    errorMask: errorMask);
            }
            if (item.UInt8_Ranged_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt8_Ranged) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt8_Ranged),
                    item: item.UInt8_Ranged,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.UInt8_Ranged,
                    errorMask: errorMask);
            }
            if (item.Enum_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Enum) ?? true))
            {
                EnumXmlTranslation<TestEnum>.Instance.Write(
                    node: node,
                    name: nameof(item.Enum),
                    item: item.Enum,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Enum,
                    errorMask: errorMask);
            }
            if (item.EnumNull_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.EnumNull) ?? true))
            {
                EnumXmlTranslation<TestEnum>.Instance.Write(
                    node: node,
                    name: nameof(item.EnumNull),
                    item: item.EnumNull,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.EnumNull,
                    errorMask: errorMask);
            }
            if (item.WildCard_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.WildCard) ?? true))
            {
                WildcardXmlTranslation.Instance.Write(
                    node: node,
            ...
            if (item.WildCardLoqui_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.WildCardLoqui) ?? true))
            {
                WildcardXmlTranslation.Instance.Write(
                    node: node,
            ...
            if (item.WildCardNull_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.WildCardNull) ?? true))
            {
                WildcardXmlTranslation.Instance.Write(
                    node: node,
            ...
            if (item.Ref_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Ref) ?? true))
            {
                LoquiXmlTranslation<ObjectToRef>.Instance.Write(
                    node: node,
                    item: item.Ref,
                    name: nameof(item.Ref),
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Ref,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Ref));
            }
            if (item.Ref_NotNull_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Ref_NotNull) ?? true))
            {
                LoquiXmlTranslation<ObjectToRef>.Instance.Write(
                    node: node,
                    item: item.Ref_NotNull,
                    name: nameof(item.Ref_NotNull),
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Ref_NotNull,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Ref_NotNull));
            }
            if (item.Ref_Singleton_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Ref_Singleton) ?? true))
            {
                LoquiXmlTranslation<ObjectToRef>.Instance.Write(
                    node: node,
                    item: item.Ref_Singleton,
                    name: nameof(item.Ref_Singleton),
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Ref_Singleton,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Ref_Singleton));
            }
            if (item.RefGetter_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefGetter) ?? true))
            {
                LoquiXmlTranslation<ObjectToRef>.Instance.Write(
                    node: node,
                    item: item.RefGetter,
                    name: nameof(item.RefGetter),
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefGetter,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefGetter));
            }
            if (item.RefGetter_NotNull_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefGetter_NotNull) ?? true))
            {
                LoquiXmlTranslation<ObjectToRef>.Instance.Write(
                    node: node,
                    item: item.RefGetter_NotNull,
                    name: nameof(item.RefGetter_NotNull),
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefGetter_NotNull,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefGetter_NotNull));
            }
            if (item.RefGetter_Singleton_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefGetter_Singleton) ?? true))
            {
                LoquiXmlTranslation<ObjectToRef>.Instance.Write(
                    node: node,
                    item: item.RefGetter_Singleton,
                    name: nameof(item.RefGetter_Singleton),
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefGetter_Singleton,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefGetter_Singleton));
            }
            if (item.RefSetter_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefSetter) ?? true))
            {
                LoquiXmlTranslation<ObjectToRef>.Instance.Write(
                    node: node,
                    item: item.RefSetter,
                    name: nameof(item.RefSetter),
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefSetter,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefSetter));
            }
            if (item.RefSetter_NotNull_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefSetter_NotNull) ?? true))
            {
                LoquiXmlTranslation<ObjectToRef>.Instance.Write(
                    node: node,
                    item: item.RefSetter_NotNull,
                    name: nameof(item.RefSetter_NotNull),
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefSetter_NotNull,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefSetter_NotNull));
            }
            if (item.RefSetter_Singleton_Property.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefSetter_Singleton) ?? true))
            {
                LoquiXmlTranslation<ObjectToRef>.Instance.Write(
                    node: node,
                    item: item.RefSetter_Singleton,
                    name: nameof(item.RefSetter_Singleton),
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefSetter_Singleton,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefSetter_Singleton));
            }
            if (item.List.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.List) ?? true))
            {
                ListXmlTranslation<Boolean>.Instance.Write(
                    node: node,
                    name: nameof(item.List),
                    item: item.List,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.List,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.List),
            ...
            if (item.RefList.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefList) ?? true))
            {
                ListXmlTranslation<ObjectToRef>.Instance.Write(
                    node: node,
                    name: nameof(item.RefList),
                    item: item.RefList,
                    fieldIndex: (int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefList,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefList),
            ...
            if (item.Dict.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.Dict) ?? true))
            {
            ...
            if (item.RefDict.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.RefDict) ?? true))
            {
            ...
            if (item.KeyRefDict.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.KeyRefDict) ?? true))
            {
            ...
            if (item.ValRefDict.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.ValRefDict) ?? true))
            {
            ...
            if (item.DictKeyedValue.HasBeenSet
                && (translationMask?.GetShouldTranslate((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DictKeyedValue) ?? true))
            {
                try
                {
                    errorMask?.PushIndex((int)TestObject_HasBeenSet_ReadOnly_RPC_FieldIndex.DictKeyedValue);
        ...
        public static void FillPublic_Xml(
            this TestObject_HasBeenSet_ReadOnly_RPC item,
            XElement node,
            ErrorMaskBuilder errorMask,
            TranslationCrystal translationMask)
        {
    ...
    #region Modules
    #region Mask
    public class TestObject_HasBeenSet_ReadOnly_RPC_Mask<T> : IMask<T>, IEquatable<TestObject_HasBeenSet_ReadOnly_RPC_Mask<T>>
    {
        #region Ctors
        public TestObject_HasBeenSet_ReadOnly_RPC_Mask()
        {
        }

        public TestObject_HasBeenSet_ReadOnly_RPC_Mask(T initialValue)
        {
        ...
        public override bool Equals(object obj)
        {
            if (!(obj is TestObject_HasBeenSet_ReadOnly_RPC_Mask<T> rhs)) return false;
            return Equals(rhs);
        }

        public bool Equals(TestObject_HasBeenSet_ReadOnly_RPC_Mask<T> rhs)
        {
            if (rhs == null) return false;
        ...
        public string ToString(TestObject_HasBeenSet_ReadOnly_RPC_Mask<bool> printMask = null)
        {
            var fg = new FileGeneration();
        ...
        public void ToString(FileGeneration fg, TestObject_HasBeenSet_ReadOnly_RPC_Mask<bool> printMask = null)
        {
            fg.AppendLine($"{nameof(TestObject_HasBeenSet_ReadOnly_RPC_Mask<T>)} =>");
            fg.AppendLine("[");
            using (new DepthWrapper(fg))
            {
                if (printMask?.ByteArray ?? true)
    ...
    public class TestObject_HasBeenSet_ReadOnly_RPC_ErrorMask : IErrorMask, IErrorMask<TestObject_HasBeenSet_ReadOnly_RPC_ErrorMask>
    {
        ...
        {
            fg.AppendLine("TestObject_HasBeenSet_ReadOnly_RPC_ErrorMask =>");
            fg.AppendLine("[");
            using (new DepthWrapper(fg))
            {
        ...
        #region Combine
        public TestObject_HasBeenSet_ReadOnly_RPC_ErrorMask Combine(TestObject_HasBeenSet_ReadOnly_RPC_ErrorMask rhs)
        {
            var ret = new TestObject_HasBeenSet_ReadOnly_RPC_ErrorMask();
        ...
        #region Factory
        public static TestObject_HasBeenSet_ReadOnly_RPC_ErrorMask Factory(ErrorMaskBuilder errorMask)
        {
            if (errorMask?.Empty ?? true) return null;
            return new TestObject_HasBeenSet_ReadOnly_RPC_ErrorMask();
        }
        #endregion
    ...
    {
        public TestObject_HasBeenSet_ReadOnly_RPC_CopyMask()
        {
        }

        public TestObject_HasBeenSet_ReadOnly_RPC_CopyMask(bool defaultOn, CopyOption deepCopyOption = CopyOption.Reference)
        {
    ...
    public class TestObject_HasBeenSet_ReadOnly_RPC_TranslationMask : ITranslationMask
    {
        #region Members
        ...
        #region Ctors
        public TestObject_HasBeenSet_ReadOnly_RPC_TranslationMask()
        {
        }

        public TestObject_HasBeenSet_ReadOnly_RPC_TranslationMask(bool defaultOn)
        {
            this.ByteArray = defaultOn;
            this.ByteArrayNull = defaultOn;
            this.ByteArrayNotNull = defaultOn;
