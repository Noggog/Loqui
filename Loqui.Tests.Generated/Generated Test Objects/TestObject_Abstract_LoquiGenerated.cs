...
{
    #region Class
    public abstract partial class TestObject_Abstract : 
        ITestObject_Abstract,
        ILoquiObject<TestObject_Abstract>,
        ILoquiObjectSetter,
        IEquatable<TestObject_Abstract>
    {
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ILoquiRegistration ILoquiObject.Registration => TestObject_Abstract_Registration.Instance;
        public static TestObject_Abstract_Registration Registration => TestObject_Abstract_Registration.Instance;

        #region Ctor
        public TestObject_Abstract()
        {
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.BoolN] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.Bool] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.CharN] = false;
            CharN = default(Char?);
        }
        #endregion
        #region Char
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.Char] = false;
            Char = default(Char);
        }
        #endregion
        #region DateTimeNull
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.DateTimeNull] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.DateTime] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.DoubleN] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.Double] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.FloatN] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.Float] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.Int16N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.Int16] = false;
            Int16 = default(Int16);
        }
        #endregion
        #region Int16_Ranged
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.Int32N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.Int32] = false;
            Int32 = default(Int32);
        }
        #endregion
        #region Int32_Ranged
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.Int64N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.Int64] = false;
            Int64 = default(Int64);
        }
        #endregion
        #region Int64_Ranged
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.Int8N] = false;
            Int8N = default(SByte?);
        }
        #endregion
        #region Int8N_Ranged
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.Int8] = false;
            Int8 = default(SByte);
        }
        #endregion
        #region Int8_Ranged
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.Unsafe] = false;
            Unsafe = default(bool);
        }
        #endregion
        #region UnsafeLoqui
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.UnsafeLoqui] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.UnsafeNull] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.P2IntN] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.P2Int] = false;
            P2Int = default(P2Int);
        }
        #endregion
        #region P3DoubleN
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.P3DoubleN] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.P3Double] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.P3IntN] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.P3Int] = false;
            P3Int = default(P3Int);
        }
        #endregion
        #region PercentN
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.PercentN] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.Percent] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.RangeInt8N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.RangeInt8] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.RangeInt16N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.RangeInt16] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.RangeInt32N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.RangeInt32] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.RangeInt64N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.RangeInt64] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.RangeUInt8N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.RangeUInt8] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.RangeUInt16N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.RangeUInt16] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.RangeUInt32N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.RangeUInt32] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.RangeUInt64N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.RangeUInt64] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.String] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.FilePath] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.FilePathNull] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.DirectoryPath] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.DirectoryPathNull] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.UDoubleN] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.UDouble] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.UInt16N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.UInt16] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.UInt32N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.UInt32] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.UInt64N] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.UInt64] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.UInt8N] = false;
            UInt8N = default(Byte?);
        }
        #endregion
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.UInt8] = false;
            UInt8 = default(Byte);
        }
        #endregion
        #region UInt8_Ranged
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.Enum] = false;
        ...
        {
            _hasBeenSetTracker[(int)TestObject_Abstract_FieldIndex.EnumNull] = false;
        ...
        Object ITestObject_AbstractGetter.WildCard => this.WildCard;
        #endregion
        ...
        Object ITestObject_AbstractGetter.WildCardLoqui => this.WildCardLoqui;
        #endregion
        #region WildCardNull
        ...
        Object ITestObject_AbstractGetter.WildCardNull => this.WildCardNull;
        #endregion
        #region Ref
        ...
        #endregion
        #region RefGetter
        public ObjectToRef RefGetter { get; set; }
        #endregion
        ...
        #endregion
        #region RefSetter
        public ObjectToRef RefSetter { get; set; }
        #endregion
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ISourceSetList<Boolean> ITestObject_Abstract.List => _List;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IObservableSetList<Boolean> ITestObject_AbstractGetter.List => _List;
        #endregion
        ...
        #region Interface Members
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ISourceSetList<ObjectToRef> ITestObject_Abstract.RefList => _RefList;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IObservableSetList<ObjectToRef> ITestObject_AbstractGetter.RefList => _RefList;
        #endregion
        ...
        #region Interface Members
        INotifyingDictionary<String, Boolean> ITestObject_Abstract.Dict => _Dict;
        INotifyingDictionaryGetter<String, Boolean> ITestObject_AbstractGetter.Dict => _Dict;
        #endregion
        ...
        #region Interface Members
        INotifyingDictionary<ObjectToRef, ObjectToRef> ITestObject_Abstract.RefDict => _RefDict;
        INotifyingDictionaryGetter<ObjectToRef, ObjectToRef> ITestObject_AbstractGetter.RefDict => _RefDict;
        #endregion
        ...
        #region Interface Members
        INotifyingDictionary<ObjectToRef, Boolean> ITestObject_Abstract.KeyRefDict => _KeyRefDict;
        INotifyingDictionaryGetter<ObjectToRef, Boolean> ITestObject_AbstractGetter.KeyRefDict => _KeyRefDict;
        #endregion
        ...
        #region Interface Members
        INotifyingDictionary<String, ObjectToRef> ITestObject_Abstract.ValRefDict => _ValRefDict;
        INotifyingDictionaryGetter<String, ObjectToRef> ITestObject_AbstractGetter.ValRefDict => _ValRefDict;
        #endregion
        ...
        #region Interface Members
        ISourceSetCache<ObjectToRef, Int32> ITestObject_Abstract.DictKeyedValue => _DictKeyedValue;
        IObservableSetCache<ObjectToRef, Int32> ITestObject_AbstractGetter.DictKeyedValue => _DictKeyedValue;
        #endregion
        ...
        protected object GetNthObject(ushort index) => TestObject_AbstractCommon.GetNthObject(index, this);
        ...
        {
            TestObject_AbstractCommon.SetNthObjectHasBeenSet(index, on, this);
        }
        void ILoquiObjectSetter.SetNthObjectHasBeenSet(ushort index, bool on) => this.SetNthObjectHasBeenSet(index, on);

        #endregion

        IMask<bool> IEqualsMask<TestObject_Abstract>.GetEqualsMask(TestObject_Abstract rhs, EqualsMaskHelper.Include include) => TestObject_AbstractCommon.GetEqualsMask(this, rhs, include);
        IMask<bool> IEqualsMask<ITestObject_AbstractGetter>.GetEqualsMask(ITestObject_AbstractGetter rhs, EqualsMaskHelper.Include include) => TestObject_AbstractCommon.GetEqualsMask(this, rhs, include);
        #region To String
        public override string ToString()
        {
            return TestObject_AbstractCommon.ToString(this, printMask: null);
        }

        public string ToString(
            string name = null,
            TestObject_Abstract_Mask<bool> printMask = null)
        {
            return TestObject_AbstractCommon.ToString(this, name: name, printMask: printMask);
        }
        ...
        public void ToString(
            ...
            string name = null)
        {
            TestObject_AbstractCommon.ToString(this, fg, name: name, printMask: null);
        }

        #endregion

        IMask<bool> ILoquiObjectGetter.GetHasBeenSetMask() => this.GetHasBeenSetMask();
        public TestObject_Abstract_Mask<bool> GetHasBeenSetMask()
        {
            return TestObject_AbstractCommon.GetHasBeenSetMask(this);
        }
        #region Equals and Hash
        public override bool Equals(object obj)
        {
            if (!(obj is TestObject_Abstract rhs)) return false;
            return Equals(rhs);
        }

        public bool Equals(TestObject_Abstract rhs)
        {
        ...
        #region Xml Create
        [DebuggerStepThrough]
        public static TestObject_Abstract Create_Xml(
            XElement node,
            TestObject_Abstract_TranslationMask translationMask = null)
        {
            return Create_Xml(
                node: node,
                errorMask: null,
            ...
            TestObject_Abstract_TranslationMask translationMask = null)
        {
            ...
            var ret = Create_Xml(
                ...
                translationMask: translationMask.GetCrystal());
            errorMask = TestObject_Abstract_ErrorMask.Factory(errorMaskBuilder);
            return ret;
        }
        ...
        {
            TestObject_Abstract ret;
            if (!LoquiXmlTranslation.Instance.TryCreate(node, out ret, errorMask, translationMask))
            {
                throw new ArgumentException($"Unknown TestObject_Abstract subclass: {node.Name.LocalName}");
            }
            return ret;
        }
        ...
        protected void CopyIn_Xml_Internal(
            ...
            NotifyingFireParameters cmds = null)
        {
            LoquiXmlTranslation<TestObject_Abstract>.Instance.CopyIn(
                node: node,
                item: this,
                skipProtected: true,
                errorMask: errorMask,
        ...
        public void CopyIn_Xml(
            string path,
            out TestObject_Abstract_ErrorMask errorMask,
            TestObject_Abstract_TranslationMask translationMask,
            NotifyingFireParameters cmds = null,
            bool doMasks = true)
        {
            var node = XDocument.Load(path).Root;
            ...
            TranslationCrystal translationMask)
        {
            switch (name)
            {
                case "ByteArraySingleton":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.ByteArraySingleton) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.ByteArraySingleton);
                    ...
                    break;
                case "Ref_Singleton":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Ref_Singleton) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Ref_Singleton);
                ...
                case "RefGetter_Singleton":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.RefGetter_Singleton) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.RefGetter_Singleton);
                ...
                case "RefSetter_Singleton":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.RefSetter_Singleton) ?? true))
                    {
                        try
                        {
                            errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.RefSetter_Singleton);
        ...
        {
            switch ((TestObject_Abstract_FieldIndex)index)
            {
                case TestObject_Abstract_FieldIndex.ByteArray:
                case TestObject_Abstract_FieldIndex.ByteArrayNull:
                case TestObject_Abstract_FieldIndex.ByteArrayNotNull:
                case TestObject_Abstract_FieldIndex.ByteArraySingleton:
                case TestObject_Abstract_FieldIndex.BoolN:
                case TestObject_Abstract_FieldIndex.Bool:
                case TestObject_Abstract_FieldIndex.CharN:
                case TestObject_Abstract_FieldIndex.Char:
                case TestObject_Abstract_FieldIndex.DateTimeNull:
                case TestObject_Abstract_FieldIndex.DateTime:
                case TestObject_Abstract_FieldIndex.DoubleN:
                case TestObject_Abstract_FieldIndex.DoubleN_Ranged:
                case TestObject_Abstract_FieldIndex.Double:
                case TestObject_Abstract_FieldIndex.Double_Ranged:
                case TestObject_Abstract_FieldIndex.FloatN:
                case TestObject_Abstract_FieldIndex.FloatN_Ranged:
                case TestObject_Abstract_FieldIndex.Float:
                case TestObject_Abstract_FieldIndex.Float_Ranged:
                case TestObject_Abstract_FieldIndex.Int16N:
                case TestObject_Abstract_FieldIndex.Int16N_Ranged:
                case TestObject_Abstract_FieldIndex.Int16:
                case TestObject_Abstract_FieldIndex.Int16_Ranged:
                case TestObject_Abstract_FieldIndex.Int32N:
                case TestObject_Abstract_FieldIndex.Int32N_Ranged:
                case TestObject_Abstract_FieldIndex.Int32:
                case TestObject_Abstract_FieldIndex.Int32_Ranged:
                case TestObject_Abstract_FieldIndex.Int64N:
                case TestObject_Abstract_FieldIndex.Int64N_Ranged:
                case TestObject_Abstract_FieldIndex.Int64:
                case TestObject_Abstract_FieldIndex.Int64_Ranged:
                case TestObject_Abstract_FieldIndex.Int8N:
                case TestObject_Abstract_FieldIndex.Int8N_Ranged:
                case TestObject_Abstract_FieldIndex.Int8:
                case TestObject_Abstract_FieldIndex.Int8_Ranged:
                case TestObject_Abstract_FieldIndex.Unsafe:
                case TestObject_Abstract_FieldIndex.UnsafeLoqui:
                case TestObject_Abstract_FieldIndex.UnsafeNull:
                case TestObject_Abstract_FieldIndex.P2IntN:
                case TestObject_Abstract_FieldIndex.P2Int:
                case TestObject_Abstract_FieldIndex.P3DoubleN:
                case TestObject_Abstract_FieldIndex.P3Double:
                case TestObject_Abstract_FieldIndex.P3IntN:
                case TestObject_Abstract_FieldIndex.P3Int:
                case TestObject_Abstract_FieldIndex.PercentN:
                case TestObject_Abstract_FieldIndex.Percent:
                case TestObject_Abstract_FieldIndex.RangeInt8N:
                case TestObject_Abstract_FieldIndex.RangeInt8:
                case TestObject_Abstract_FieldIndex.RangeInt16N:
                case TestObject_Abstract_FieldIndex.RangeInt16:
                case TestObject_Abstract_FieldIndex.RangeInt32N:
                case TestObject_Abstract_FieldIndex.RangeInt32:
                case TestObject_Abstract_FieldIndex.RangeInt64N:
                case TestObject_Abstract_FieldIndex.RangeInt64:
                case TestObject_Abstract_FieldIndex.RangeUInt8N:
                case TestObject_Abstract_FieldIndex.RangeUInt8:
                case TestObject_Abstract_FieldIndex.RangeUInt16N:
                case TestObject_Abstract_FieldIndex.RangeUInt16:
                case TestObject_Abstract_FieldIndex.RangeUInt32N:
                case TestObject_Abstract_FieldIndex.RangeUInt32:
                case TestObject_Abstract_FieldIndex.RangeUInt64N:
                case TestObject_Abstract_FieldIndex.RangeUInt64:
                case TestObject_Abstract_FieldIndex.String:
                case TestObject_Abstract_FieldIndex.FilePath:
                case TestObject_Abstract_FieldIndex.FilePathNull:
                case TestObject_Abstract_FieldIndex.DirectoryPath:
                case TestObject_Abstract_FieldIndex.DirectoryPathNull:
                case TestObject_Abstract_FieldIndex.UDoubleN:
                case TestObject_Abstract_FieldIndex.UDoubleN_Ranged:
                case TestObject_Abstract_FieldIndex.UDouble:
                case TestObject_Abstract_FieldIndex.UDouble_Ranged:
                case TestObject_Abstract_FieldIndex.UInt16N:
                case TestObject_Abstract_FieldIndex.UInt16N_Ranged:
                case TestObject_Abstract_FieldIndex.UInt16:
                case TestObject_Abstract_FieldIndex.UInt16_Ranged:
                case TestObject_Abstract_FieldIndex.UInt32N:
                case TestObject_Abstract_FieldIndex.UInt32N_Ranged:
                case TestObject_Abstract_FieldIndex.UInt32:
                case TestObject_Abstract_FieldIndex.UInt32_Ranged:
                case TestObject_Abstract_FieldIndex.UInt64N:
                case TestObject_Abstract_FieldIndex.UInt64N_Ranged:
                case TestObject_Abstract_FieldIndex.UInt64:
                case TestObject_Abstract_FieldIndex.UInt64_Ranged:
                case TestObject_Abstract_FieldIndex.UInt8N:
                case TestObject_Abstract_FieldIndex.UInt8N_Ranged:
                case TestObject_Abstract_FieldIndex.UInt8:
                case TestObject_Abstract_FieldIndex.UInt8_Ranged:
                case TestObject_Abstract_FieldIndex.Enum:
                case TestObject_Abstract_FieldIndex.EnumNull:
                case TestObject_Abstract_FieldIndex.WildCard:
                case TestObject_Abstract_FieldIndex.WildCardLoqui:
                case TestObject_Abstract_FieldIndex.WildCardNull:
                case TestObject_Abstract_FieldIndex.Ref:
                case TestObject_Abstract_FieldIndex.Ref_NotNull:
                case TestObject_Abstract_FieldIndex.Ref_Singleton:
                case TestObject_Abstract_FieldIndex.RefGetter:
                case TestObject_Abstract_FieldIndex.RefGetter_NotNull:
                case TestObject_Abstract_FieldIndex.RefGetter_Singleton:
                case TestObject_Abstract_FieldIndex.RefSetter:
                case TestObject_Abstract_FieldIndex.RefSetter_NotNull:
                case TestObject_Abstract_FieldIndex.RefSetter_Singleton:
                case TestObject_Abstract_FieldIndex.List:
                case TestObject_Abstract_FieldIndex.RefList:
                case TestObject_Abstract_FieldIndex.Dict:
                case TestObject_Abstract_FieldIndex.RefDict:
                case TestObject_Abstract_FieldIndex.KeyRefDict:
                case TestObject_Abstract_FieldIndex.ValRefDict:
                case TestObject_Abstract_FieldIndex.DictKeyedValue:
                    return true;
                default:
        ...
        {
            this.CopyFieldsFrom(
                rhs: (ITestObject_AbstractGetter)rhs,
                def: null,
                doMasks: false,
        ...
        protected static void CopyInInternal_TestObject_Abstract(TestObject_Abstract obj, KeyValuePair<ushort, object> pair)
        {
            if (!EnumExt.TryParse(pair.Key, out TestObject_Abstract_FieldIndex enu))
            {
        ...
        public static void CopyIn(IEnumerable<KeyValuePair<ushort, object>> fields, TestObject_Abstract obj)
        {
    ...
    #region Interface
    public partial interface ITestObject_Abstract : ITestObject_AbstractGetter, ILoquiClass<ITestObject_Abstract, ITestObject_AbstractGetter>, ILoquiClass<TestObject_Abstract, ITestObject_AbstractGetter>
    {
    ...
    public partial interface ITestObject_AbstractGetter : ILoquiObject
    {
        #region ByteArray
        Byte[] ByteArray { get; }
...
{
    #region Field Index
    public enum TestObject_Abstract_FieldIndex
    {
        ByteArray = 0,
        ByteArrayNull = 1,
        ByteArrayNotNull = 2,
    ...
    #region Registration
    public class TestObject_Abstract_Registration : ILoquiRegistration
    {
        public static readonly TestObject_Abstract_Registration Instance = new TestObject_Abstract_Registration();
        ...
        public const string GUID = "86b68476-62cc-4963-a4ac-5da9b58a6ecd";

        public const ushort AdditionalFieldCount = 107;

        public const ushort FieldCount = 107;

        public static readonly Type MaskType = typeof(TestObject_Abstract_Mask<>);

        public static readonly Type ErrorMaskType = typeof(TestObject_Abstract_ErrorMask);

        public static readonly Type ClassType = typeof(TestObject_Abstract);

        public static readonly Type GetterType = typeof(ITestObject_AbstractGetter);

        public static readonly Type SetterType = typeof(ITestObject_Abstract);

        public static readonly Type CommonType = typeof(TestObject_AbstractCommon);

        public const string FullName = "Loqui.Tests.Generated.TestObject_Abstract";

        public const string Name = "TestObject_Abstract";
        ...
        public static ushort? GetNameIndex(StringCaseAgnostic str)
        {
            ...
            {
                case "BYTEARRAY":
                    return (ushort)TestObject_Abstract_FieldIndex.ByteArray;
                case "BYTEARRAYNULL":
                    return (ushort)TestObject_Abstract_FieldIndex.ByteArrayNull;
                case "BYTEARRAYNOTNULL":
                    return (ushort)TestObject_Abstract_FieldIndex.ByteArrayNotNull;
                case "BYTEARRAYSINGLETON":
                    return (ushort)TestObject_Abstract_FieldIndex.ByteArraySingleton;
                case "BOOLN":
                    return (ushort)TestObject_Abstract_FieldIndex.BoolN;
                case "BOOL":
                    return (ushort)TestObject_Abstract_FieldIndex.Bool;
                case "CHARN":
                    return (ushort)TestObject_Abstract_FieldIndex.CharN;
                case "CHAR":
                    return (ushort)TestObject_Abstract_FieldIndex.Char;
                case "DATETIMENULL":
                    return (ushort)TestObject_Abstract_FieldIndex.DateTimeNull;
                case "DATETIME":
                    return (ushort)TestObject_Abstract_FieldIndex.DateTime;
                case "DOUBLEN":
                    return (ushort)TestObject_Abstract_FieldIndex.DoubleN;
                case "DOUBLEN_RANGED":
                    return (ushort)TestObject_Abstract_FieldIndex.DoubleN_Ranged;
                case "DOUBLE":
                    return (ushort)TestObject_Abstract_FieldIndex.Double;
                case "DOUBLE_RANGED":
                    return (ushort)TestObject_Abstract_FieldIndex.Double_Ranged;
                case "FLOATN":
                    return (ushort)TestObject_Abstract_FieldIndex.FloatN;
                case "FLOATN_RANGED":
                    return (ushort)TestObject_Abstract_FieldIndex.FloatN_Ranged;
                case "FLOAT":
                    return (ushort)TestObject_Abstract_FieldIndex.Float;
                case "FLOAT_RANGED":
                    return (ushort)TestObject_Abstract_FieldIndex.Float_Ranged;
                case "INT16N":
                    return (ushort)TestObject_Abstract_FieldIndex.Int16N;
                case "INT16N_RANGED":
                    return (ushort)TestObject_Abstract_FieldIndex.Int16N_Ranged;
                case "INT16":
                    return (ushort)TestObject_Abstract_FieldIndex.Int16;
                case "INT16_RANGED":
                    return (ushort)TestObject_Abstract_FieldIndex.Int16_Ranged;
                case "INT32N":
                    return (ushort)TestObject_Abstract_FieldIndex.Int32N;
                case "INT32N_RANGED":
                    return (ushort)TestObject_Abstract_FieldIndex.Int32N_Ranged;
                case "INT32":
                    return (ushort)TestObject_Abstract_FieldIndex.Int32;
                case "INT32_RANGED":
                    return (ushort)TestObject_Abstract_FieldIndex.Int32_Ranged;
                case "INT64N":
                    return (ushort)TestObject_Abstract_FieldIndex.Int64N;
                case "INT64N_RANGED":
                    return (ushort)TestObject_Abstract_FieldIndex.Int64N_Ranged;
                case "INT64":
                    return (ushort)TestObject_Abstract_FieldIndex.Int64;
                case "INT64_RANGED":
                    return (ushort)TestObject_Abstract_FieldIndex.Int64_Ranged;
                case "INT8N":
                    return (ushort)TestObject_Abstract_FieldIndex.Int8N;
                case "INT8N_RANGED":
                    return (ushort)TestObject_Abstract_FieldIndex.Int8N_Ranged;
                case "INT8":
                    return (ushort)TestObject_Abstract_FieldIndex.Int8;
                case "INT8_RANGED":
                    return (ushort)TestObject_Abstract_FieldIndex.Int8_Ranged;
                case "UNSAFE":
                    return (ushort)TestObject_Abstract_FieldIndex.Unsafe;
                case "UNSAFELOQUI":
                    return (ushort)TestObject_Abstract_FieldIndex.UnsafeLoqui;
                case "UNSAFENULL":
                    return (ushort)TestObject_Abstract_FieldIndex.UnsafeNull;
                case "P2INTN":
                    return (ushort)TestObject_Abstract_FieldIndex.P2IntN;
                case "P2INT":
                    return (ushort)TestObject_Abstract_FieldIndex.P2Int;
                case "P3DOUBLEN":
                    return (ushort)TestObject_Abstract_FieldIndex.P3DoubleN;
                case "P3DOUBLE":
                    return (ushort)TestObject_Abstract_FieldIndex.P3Double;
                case "P3INTN":
                    return (ushort)TestObject_Abstract_FieldIndex.P3IntN;
                case "P3INT":
                    return (ushort)TestObject_Abstract_FieldIndex.P3Int;
                case "PERCENTN":
                    return (ushort)TestObject_Abstract_FieldIndex.PercentN;
                case "PERCENT":
                    return (ushort)TestObject_Abstract_FieldIndex.Percent;
                case "RANGEINT8N":
                    return (ushort)TestObject_Abstract_FieldIndex.RangeInt8N;
                case "RANGEINT8":
                    return (ushort)TestObject_Abstract_FieldIndex.RangeInt8;
                case "RANGEINT16N":
                    return (ushort)TestObject_Abstract_FieldIndex.RangeInt16N;
                case "RANGEINT16":
                    return (ushort)TestObject_Abstract_FieldIndex.RangeInt16;
                case "RANGEINT32N":
                    return (ushort)TestObject_Abstract_FieldIndex.RangeInt32N;
                case "RANGEINT32":
                    return (ushort)TestObject_Abstract_FieldIndex.RangeInt32;
                case "RANGEINT64N":
                    return (ushort)TestObject_Abstract_FieldIndex.RangeInt64N;
                case "RANGEINT64":
                    return (ushort)TestObject_Abstract_FieldIndex.RangeInt64;
                case "RANGEUINT8N":
                    return (ushort)TestObject_Abstract_FieldIndex.RangeUInt8N;
                case "RANGEUINT8":
                    return (ushort)TestObject_Abstract_FieldIndex.RangeUInt8;
                case "RANGEUINT16N":
                    return (ushort)TestObject_Abstract_FieldIndex.RangeUInt16N;
                case "RANGEUINT16":
                    return (ushort)TestObject_Abstract_FieldIndex.RangeUInt16;
                case "RANGEUINT32N":
                    return (ushort)TestObject_Abstract_FieldIndex.RangeUInt32N;
                case "RANGEUINT32":
                    return (ushort)TestObject_Abstract_FieldIndex.RangeUInt32;
                case "RANGEUINT64N":
                    return (ushort)TestObject_Abstract_FieldIndex.RangeUInt64N;
                case "RANGEUINT64":
                    return (ushort)TestObject_Abstract_FieldIndex.RangeUInt64;
                case "STRING":
                    return (ushort)TestObject_Abstract_FieldIndex.String;
                case "FILEPATH":
                    return (ushort)TestObject_Abstract_FieldIndex.FilePath;
                case "FILEPATHNULL":
                    return (ushort)TestObject_Abstract_FieldIndex.FilePathNull;
                case "DIRECTORYPATH":
                    return (ushort)TestObject_Abstract_FieldIndex.DirectoryPath;
                case "DIRECTORYPATHNULL":
                    return (ushort)TestObject_Abstract_FieldIndex.DirectoryPathNull;
                case "UDOUBLEN":
                    return (ushort)TestObject_Abstract_FieldIndex.UDoubleN;
                case "UDOUBLEN_RANGED":
                    return (ushort)TestObject_Abstract_FieldIndex.UDoubleN_Ranged;
                case "UDOUBLE":
                    return (ushort)TestObject_Abstract_FieldIndex.UDouble;
                case "UDOUBLE_RANGED":
                    return (ushort)TestObject_Abstract_FieldIndex.UDouble_Ranged;
                case "UINT16N":
                    return (ushort)TestObject_Abstract_FieldIndex.UInt16N;
                case "UINT16N_RANGED":
                    return (ushort)TestObject_Abstract_FieldIndex.UInt16N_Ranged;
                case "UINT16":
                    return (ushort)TestObject_Abstract_FieldIndex.UInt16;
                case "UINT16_RANGED":
                    return (ushort)TestObject_Abstract_FieldIndex.UInt16_Ranged;
                case "UINT32N":
                    return (ushort)TestObject_Abstract_FieldIndex.UInt32N;
                case "UINT32N_RANGED":
                    return (ushort)TestObject_Abstract_FieldIndex.UInt32N_Ranged;
                case "UINT32":
                    return (ushort)TestObject_Abstract_FieldIndex.UInt32;
                case "UINT32_RANGED":
                    return (ushort)TestObject_Abstract_FieldIndex.UInt32_Ranged;
                case "UINT64N":
                    return (ushort)TestObject_Abstract_FieldIndex.UInt64N;
                case "UINT64N_RANGED":
                    return (ushort)TestObject_Abstract_FieldIndex.UInt64N_Ranged;
                case "UINT64":
                    return (ushort)TestObject_Abstract_FieldIndex.UInt64;
                case "UINT64_RANGED":
                    return (ushort)TestObject_Abstract_FieldIndex.UInt64_Ranged;
                case "UINT8N":
                    return (ushort)TestObject_Abstract_FieldIndex.UInt8N;
                case "UINT8N_RANGED":
                    return (ushort)TestObject_Abstract_FieldIndex.UInt8N_Ranged;
                case "UINT8":
                    return (ushort)TestObject_Abstract_FieldIndex.UInt8;
                case "UINT8_RANGED":
                    return (ushort)TestObject_Abstract_FieldIndex.UInt8_Ranged;
                case "ENUM":
                    return (ushort)TestObject_Abstract_FieldIndex.Enum;
                case "ENUMNULL":
                    return (ushort)TestObject_Abstract_FieldIndex.EnumNull;
                case "WILDCARD":
                    return (ushort)TestObject_Abstract_FieldIndex.WildCard;
                case "WILDCARDLOQUI":
                    return (ushort)TestObject_Abstract_FieldIndex.WildCardLoqui;
                case "WILDCARDNULL":
                    return (ushort)TestObject_Abstract_FieldIndex.WildCardNull;
                case "REF":
                    return (ushort)TestObject_Abstract_FieldIndex.Ref;
                case "REF_NOTNULL":
                    return (ushort)TestObject_Abstract_FieldIndex.Ref_NotNull;
                case "REF_SINGLETON":
                    return (ushort)TestObject_Abstract_FieldIndex.Ref_Singleton;
                case "REFGETTER":
                    return (ushort)TestObject_Abstract_FieldIndex.RefGetter;
                case "REFGETTER_NOTNULL":
                    return (ushort)TestObject_Abstract_FieldIndex.RefGetter_NotNull;
                case "REFGETTER_SINGLETON":
                    return (ushort)TestObject_Abstract_FieldIndex.RefGetter_Singleton;
                case "REFSETTER":
                    return (ushort)TestObject_Abstract_FieldIndex.RefSetter;
                case "REFSETTER_NOTNULL":
                    return (ushort)TestObject_Abstract_FieldIndex.RefSetter_NotNull;
                case "REFSETTER_SINGLETON":
                    return (ushort)TestObject_Abstract_FieldIndex.RefSetter_Singleton;
                case "LIST":
                    return (ushort)TestObject_Abstract_FieldIndex.List;
                case "REFLIST":
                    return (ushort)TestObject_Abstract_FieldIndex.RefList;
                case "DICT":
                    return (ushort)TestObject_Abstract_FieldIndex.Dict;
                case "REFDICT":
                    return (ushort)TestObject_Abstract_FieldIndex.RefDict;
                case "KEYREFDICT":
                    return (ushort)TestObject_Abstract_FieldIndex.KeyRefDict;
                case "VALREFDICT":
                    return (ushort)TestObject_Abstract_FieldIndex.ValRefDict;
                case "DICTKEYEDVALUE":
                    return (ushort)TestObject_Abstract_FieldIndex.DictKeyedValue;
                default:
                    return null;
            }
        }
    ...
    #region Extensions
    public static partial class TestObject_AbstractCommon
    {
        #region Copy Fields From
        public static void CopyFieldsFrom(
            ITestObject_Abstract item,
            ITestObject_AbstractGetter rhs,
            ITestObject_AbstractGetter def,
            ErrorMaskBuilder errorMask,
            TestObject_Abstract_CopyMask copyMask,
            NotifyingFireParameters cmds = null)
        {
            ...
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.ByteArray);
                item.ByteArray = rhs.ByteArray;
                errorMask?.PopIndex();
            }
            if (copyMask?.ByteArrayNull ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.ByteArrayNull);
                item.ByteArrayNull = rhs.ByteArrayNull;
                errorMask?.PopIndex();
            }
            if (copyMask?.ByteArrayNotNull ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.ByteArrayNotNull);
                item.ByteArrayNotNull = rhs.ByteArrayNotNull;
                errorMask?.PopIndex();
            }
            if (copyMask?.BoolN ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.BoolN);
                item.BoolN = rhs.BoolN;
                errorMask?.PopIndex();
            }
            if (copyMask?.Bool ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Bool);
                item.Bool = rhs.Bool;
                errorMask?.PopIndex();
            }
            if (copyMask?.CharN ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.CharN);
                item.CharN = rhs.CharN;
                errorMask?.PopIndex();
            }
            if (copyMask?.Char ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Char);
                item.Char = rhs.Char;
                errorMask?.PopIndex();
            }
            if (copyMask?.DateTimeNull ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.DateTimeNull);
                item.DateTimeNull = rhs.DateTimeNull;
                errorMask?.PopIndex();
            }
            if (copyMask?.DateTime ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.DateTime);
                item.DateTime = rhs.DateTime;
                errorMask?.PopIndex();
            }
            if (copyMask?.DoubleN ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.DoubleN);
                item.DoubleN = rhs.DoubleN;
                errorMask?.PopIndex();
            }
            if (copyMask?.DoubleN_Ranged ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.DoubleN_Ranged);
                item.DoubleN_Ranged = rhs.DoubleN_Ranged;
                errorMask?.PopIndex();
            }
            if (copyMask?.Double ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Double);
                item.Double = rhs.Double;
                errorMask?.PopIndex();
            }
            if (copyMask?.Double_Ranged ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Double_Ranged);
                item.Double_Ranged = rhs.Double_Ranged;
                errorMask?.PopIndex();
            }
            if (copyMask?.FloatN ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.FloatN);
                item.FloatN = rhs.FloatN;
                errorMask?.PopIndex();
            }
            if (copyMask?.FloatN_Ranged ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.FloatN_Ranged);
                item.FloatN_Ranged = rhs.FloatN_Ranged;
                errorMask?.PopIndex();
            }
            if (copyMask?.Float ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Float);
                item.Float = rhs.Float;
                errorMask?.PopIndex();
            }
            if (copyMask?.Float_Ranged ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Float_Ranged);
                item.Float_Ranged = rhs.Float_Ranged;
                errorMask?.PopIndex();
            }
            if (copyMask?.Int16N ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Int16N);
                item.Int16N = rhs.Int16N;
                errorMask?.PopIndex();
            }
            if (copyMask?.Int16N_Ranged ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Int16N_Ranged);
                item.Int16N_Ranged = rhs.Int16N_Ranged;
                errorMask?.PopIndex();
            }
            if (copyMask?.Int16 ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Int16);
                item.Int16 = rhs.Int16;
                errorMask?.PopIndex();
            }
            if (copyMask?.Int16_Ranged ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Int16_Ranged);
                item.Int16_Ranged = rhs.Int16_Ranged;
                errorMask?.PopIndex();
            }
            if (copyMask?.Int32N ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Int32N);
                item.Int32N = rhs.Int32N;
                errorMask?.PopIndex();
            }
            if (copyMask?.Int32N_Ranged ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Int32N_Ranged);
                item.Int32N_Ranged = rhs.Int32N_Ranged;
                errorMask?.PopIndex();
            }
            if (copyMask?.Int32 ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Int32);
                item.Int32 = rhs.Int32;
                errorMask?.PopIndex();
            }
            if (copyMask?.Int32_Ranged ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Int32_Ranged);
                item.Int32_Ranged = rhs.Int32_Ranged;
                errorMask?.PopIndex();
            }
            if (copyMask?.Int64N ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Int64N);
                item.Int64N = rhs.Int64N;
                errorMask?.PopIndex();
            }
            if (copyMask?.Int64N_Ranged ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Int64N_Ranged);
                item.Int64N_Ranged = rhs.Int64N_Ranged;
                errorMask?.PopIndex();
            }
            if (copyMask?.Int64 ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Int64);
                item.Int64 = rhs.Int64;
                errorMask?.PopIndex();
            }
            if (copyMask?.Int64_Ranged ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Int64_Ranged);
                item.Int64_Ranged = rhs.Int64_Ranged;
                errorMask?.PopIndex();
            }
            if (copyMask?.Int8N ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Int8N);
                item.Int8N = rhs.Int8N;
                errorMask?.PopIndex();
            }
            if (copyMask?.Int8N_Ranged ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Int8N_Ranged);
                item.Int8N_Ranged = rhs.Int8N_Ranged;
                errorMask?.PopIndex();
            }
            if (copyMask?.Int8 ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Int8);
                item.Int8 = rhs.Int8;
                errorMask?.PopIndex();
            }
            if (copyMask?.Int8_Ranged ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Int8_Ranged);
                item.Int8_Ranged = rhs.Int8_Ranged;
                errorMask?.PopIndex();
            }
            if (copyMask?.Unsafe ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Unsafe);
                item.Unsafe = rhs.Unsafe;
                errorMask?.PopIndex();
            }
            if (copyMask?.UnsafeLoqui ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.UnsafeLoqui);
                item.UnsafeLoqui = rhs.UnsafeLoqui;
                errorMask?.PopIndex();
            }
            if (copyMask?.UnsafeNull ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.UnsafeNull);
                item.UnsafeNull = rhs.UnsafeNull;
                errorMask?.PopIndex();
            }
            if (copyMask?.P2IntN ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.P2IntN);
                item.P2IntN = rhs.P2IntN;
                errorMask?.PopIndex();
            }
            if (copyMask?.P2Int ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.P2Int);
                item.P2Int = rhs.P2Int;
                errorMask?.PopIndex();
            }
            if (copyMask?.P3DoubleN ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.P3DoubleN);
                item.P3DoubleN = rhs.P3DoubleN;
                errorMask?.PopIndex();
            }
            if (copyMask?.P3Double ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.P3Double);
                item.P3Double = rhs.P3Double;
                errorMask?.PopIndex();
            }
            if (copyMask?.P3IntN ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.P3IntN);
                item.P3IntN = rhs.P3IntN;
                errorMask?.PopIndex();
            }
            if (copyMask?.P3Int ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.P3Int);
                item.P3Int = rhs.P3Int;
                errorMask?.PopIndex();
            }
            if (copyMask?.PercentN ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.PercentN);
                item.PercentN = rhs.PercentN;
                errorMask?.PopIndex();
            }
            if (copyMask?.Percent ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Percent);
                item.Percent = rhs.Percent;
                errorMask?.PopIndex();
            }
            if (copyMask?.RangeInt8N ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.RangeInt8N);
                item.RangeInt8N = rhs.RangeInt8N;
                errorMask?.PopIndex();
            }
            if (copyMask?.RangeInt8 ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.RangeInt8);
                item.RangeInt8 = rhs.RangeInt8;
                errorMask?.PopIndex();
            }
            if (copyMask?.RangeInt16N ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.RangeInt16N);
                item.RangeInt16N = rhs.RangeInt16N;
                errorMask?.PopIndex();
            }
            if (copyMask?.RangeInt16 ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.RangeInt16);
                item.RangeInt16 = rhs.RangeInt16;
                errorMask?.PopIndex();
            }
            if (copyMask?.RangeInt32N ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.RangeInt32N);
                item.RangeInt32N = rhs.RangeInt32N;
                errorMask?.PopIndex();
            }
            if (copyMask?.RangeInt32 ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.RangeInt32);
                item.RangeInt32 = rhs.RangeInt32;
                errorMask?.PopIndex();
            }
            if (copyMask?.RangeInt64N ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.RangeInt64N);
                item.RangeInt64N = rhs.RangeInt64N;
                errorMask?.PopIndex();
            }
            if (copyMask?.RangeInt64 ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.RangeInt64);
                item.RangeInt64 = rhs.RangeInt64;
                errorMask?.PopIndex();
            }
            if (copyMask?.RangeUInt8N ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.RangeUInt8N);
                item.RangeUInt8N = rhs.RangeUInt8N;
                errorMask?.PopIndex();
            }
            if (copyMask?.RangeUInt8 ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.RangeUInt8);
                item.RangeUInt8 = rhs.RangeUInt8;
                errorMask?.PopIndex();
            }
            if (copyMask?.RangeUInt16N ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.RangeUInt16N);
                item.RangeUInt16N = rhs.RangeUInt16N;
                errorMask?.PopIndex();
            }
            if (copyMask?.RangeUInt16 ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.RangeUInt16);
                item.RangeUInt16 = rhs.RangeUInt16;
                errorMask?.PopIndex();
            }
            if (copyMask?.RangeUInt32N ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.RangeUInt32N);
                item.RangeUInt32N = rhs.RangeUInt32N;
                errorMask?.PopIndex();
            }
            if (copyMask?.RangeUInt32 ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.RangeUInt32);
                item.RangeUInt32 = rhs.RangeUInt32;
                errorMask?.PopIndex();
            }
            if (copyMask?.RangeUInt64N ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.RangeUInt64N);
                item.RangeUInt64N = rhs.RangeUInt64N;
                errorMask?.PopIndex();
            }
            if (copyMask?.RangeUInt64 ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.RangeUInt64);
                item.RangeUInt64 = rhs.RangeUInt64;
                errorMask?.PopIndex();
            }
            if (copyMask?.String ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.String);
                item.String = rhs.String;
                errorMask?.PopIndex();
            }
            if (copyMask?.FilePath ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.FilePath);
                item.FilePath = rhs.FilePath;
                errorMask?.PopIndex();
            }
            if (copyMask?.FilePathNull ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.FilePathNull);
                item.FilePathNull = rhs.FilePathNull;
                errorMask?.PopIndex();
            }
            if (copyMask?.DirectoryPath ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.DirectoryPath);
                item.DirectoryPath = rhs.DirectoryPath;
                errorMask?.PopIndex();
            }
            if (copyMask?.DirectoryPathNull ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.DirectoryPathNull);
                item.DirectoryPathNull = rhs.DirectoryPathNull;
                errorMask?.PopIndex();
            }
            if (copyMask?.UDoubleN ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.UDoubleN);
                item.UDoubleN = rhs.UDoubleN;
                errorMask?.PopIndex();
            }
            if (copyMask?.UDoubleN_Ranged ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.UDoubleN_Ranged);
                item.UDoubleN_Ranged = rhs.UDoubleN_Ranged;
                errorMask?.PopIndex();
            }
            if (copyMask?.UDouble ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.UDouble);
                item.UDouble = rhs.UDouble;
                errorMask?.PopIndex();
            }
            if (copyMask?.UDouble_Ranged ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.UDouble_Ranged);
                item.UDouble_Ranged = rhs.UDouble_Ranged;
                errorMask?.PopIndex();
            }
            if (copyMask?.UInt16N ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.UInt16N);
                item.UInt16N = rhs.UInt16N;
                errorMask?.PopIndex();
            }
            if (copyMask?.UInt16N_Ranged ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.UInt16N_Ranged);
                item.UInt16N_Ranged = rhs.UInt16N_Ranged;
                errorMask?.PopIndex();
            }
            if (copyMask?.UInt16 ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.UInt16);
                item.UInt16 = rhs.UInt16;
                errorMask?.PopIndex();
            }
            if (copyMask?.UInt16_Ranged ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.UInt16_Ranged);
                item.UInt16_Ranged = rhs.UInt16_Ranged;
                errorMask?.PopIndex();
            }
            if (copyMask?.UInt32N ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.UInt32N);
                item.UInt32N = rhs.UInt32N;
                errorMask?.PopIndex();
            }
            if (copyMask?.UInt32N_Ranged ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.UInt32N_Ranged);
                item.UInt32N_Ranged = rhs.UInt32N_Ranged;
                errorMask?.PopIndex();
            }
            if (copyMask?.UInt32 ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.UInt32);
                item.UInt32 = rhs.UInt32;
                errorMask?.PopIndex();
            }
            if (copyMask?.UInt32_Ranged ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.UInt32_Ranged);
                item.UInt32_Ranged = rhs.UInt32_Ranged;
                errorMask?.PopIndex();
            }
            if (copyMask?.UInt64N ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.UInt64N);
                item.UInt64N = rhs.UInt64N;
                errorMask?.PopIndex();
            }
            if (copyMask?.UInt64N_Ranged ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.UInt64N_Ranged);
                item.UInt64N_Ranged = rhs.UInt64N_Ranged;
                errorMask?.PopIndex();
            }
            if (copyMask?.UInt64 ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.UInt64);
                item.UInt64 = rhs.UInt64;
                errorMask?.PopIndex();
            }
            if (copyMask?.UInt64_Ranged ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.UInt64_Ranged);
                item.UInt64_Ranged = rhs.UInt64_Ranged;
                errorMask?.PopIndex();
            }
            if (copyMask?.UInt8N ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.UInt8N);
                item.UInt8N = rhs.UInt8N;
                errorMask?.PopIndex();
            }
            if (copyMask?.UInt8N_Ranged ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.UInt8N_Ranged);
                item.UInt8N_Ranged = rhs.UInt8N_Ranged;
                errorMask?.PopIndex();
            }
            if (copyMask?.UInt8 ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.UInt8);
                item.UInt8 = rhs.UInt8;
                errorMask?.PopIndex();
            }
            if (copyMask?.UInt8_Ranged ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.UInt8_Ranged);
                item.UInt8_Ranged = rhs.UInt8_Ranged;
                errorMask?.PopIndex();
            }
            if (copyMask?.Enum ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Enum);
                item.Enum = rhs.Enum;
                errorMask?.PopIndex();
            }
            if (copyMask?.EnumNull ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.EnumNull);
                item.EnumNull = rhs.EnumNull;
                errorMask?.PopIndex();
            }
            if (copyMask?.WildCard ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.WildCard);
                item.WildCard = rhs.WildCard;
                errorMask?.PopIndex();
            }
            if (copyMask?.WildCardLoqui ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.WildCardLoqui);
                item.WildCardLoqui = rhs.WildCardLoqui;
                errorMask?.PopIndex();
            }
            if (copyMask?.WildCardNull ?? true)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.WildCardNull);
                item.WildCardNull = rhs.WildCardNull;
                errorMask?.PopIndex();
            }
            if (copyMask?.Ref.Overall != CopyOption.Skip)
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Ref);
                try
                {
            ...
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Ref_NotNull);
                try
                {
            ...
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.RefGetter);
                try
                {
            ...
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.RefGetter_NotNull);
                try
                {
            ...
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.RefSetter);
                try
                {
            ...
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.RefSetter_NotNull);
                try
                {
            ...
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.List);
                try
                {
            ...
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.RefList);
                try
                {
            ...
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.Dict);
                try
                {
            ...
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.RefDict);
                try
                {
            ...
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.KeyRefDict);
                try
                {
            ...
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.ValRefDict);
                try
                {
            ...
            {
                errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.DictKeyedValue);
                try
                {
            ...
            NotifyingUnsetParameters cmds = null)
        {
            ...
            switch (enu)
            {
                ...
                case TestObject_Abstract_FieldIndex.Ref_Singleton:
                    throw new ArgumentException("Tried to set at a readonly index " + index);
                case TestObject_Abstract_FieldIndex.RefGetter:
                    obj.RefGetter = default(ObjectToRef);
                    break;
                case TestObject_Abstract_FieldIndex.RefGetter_NotNull:
                    obj.RefGetter_NotNull = default(ObjectToRef);
                    break;
                case TestObject_Abstract_FieldIndex.RefGetter_Singleton:
                    throw new ArgumentException("Tried to set at a readonly index " + index);
                case TestObject_Abstract_FieldIndex.RefSetter:
                    obj.RefSetter = default(ObjectToRef);
                    break;
                case TestObject_Abstract_FieldIndex.RefSetter_NotNull:
                    obj.RefSetter_NotNull = default(ObjectToRef);
                    break;
                case TestObject_Abstract_FieldIndex.RefSetter_Singleton:
                    throw new ArgumentException("Tried to set at a readonly index " + index);
                case TestObject_Abstract_FieldIndex.List:
        ...
        public static object GetNthObject(
            ushort index,
            ITestObject_AbstractGetter obj)
        {
            TestObject_Abstract_FieldIndex enu = (TestObject_Abstract_FieldIndex)index;
            switch (enu)
            {
        ...
        public static TestObject_Abstract_Mask<bool> GetEqualsMask(
            this ITestObject_AbstractGetter item,
            ITestObject_AbstractGetter rhs,
            EqualsMaskHelper.Include include = EqualsMaskHelper.Include.All)
        {
            var ret = new TestObject_Abstract_Mask<bool>();
            FillEqualsMask(
                item: item,
                rhs: rhs,
                ret: ret,
        ...
        public static void FillEqualsMask(
            ITestObject_AbstractGetter item,
            ITestObject_AbstractGetter rhs,
            TestObject_Abstract_Mask<bool> ret,
            EqualsMaskHelper.Include include = EqualsMaskHelper.Include.All)
        {
            if (rhs == null) return;
            ...
            TestObject_Abstract_Mask<bool> printMask = null)
        {
            if (name == null)
            {
                fg.AppendLine($"{nameof(TestObject_Abstract)} =>");
            }
            else
            {
                fg.AppendLine($"{name} ({nameof(TestObject_Abstract)}) =>");
            }
            fg.AppendLine("[");
        ...
        public static bool HasBeenSet(
            this ITestObject_AbstractGetter item,
            TestObject_Abstract_Mask<bool?> checkMask)
        {
        ...
        public static TestObject_Abstract_Mask<bool> GetHasBeenSetMask(ITestObject_AbstractGetter item)
        {
            var ret = new TestObject_Abstract_Mask<bool>();
            ret.ByteArray = true;
        ...
        public static void Write_Xml(
            ...
            string name = null)
        {
            var elem = new XElement(name ?? "Loqui.Tests.Generated.TestObject_Abstract");
            node.Add(elem);
            if (name != null)
            {
                elem.SetAttributeValue("type", "Loqui.Tests.Generated.TestObject_Abstract");
            }
            WriteToNode_Xml(
                item: item,
                node: elem,
        ...
        public static void WriteToNode_Xml(
            ...
            TranslationCrystal translationMask)
        {
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.ByteArray) ?? true))
            {
                ByteArrayXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.ByteArray),
                    item: item.ByteArray,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.ByteArray,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.ByteArrayNull) ?? true))
            {
                ByteArrayXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.ByteArrayNull),
                    item: item.ByteArrayNull,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.ByteArrayNull,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.ByteArrayNotNull) ?? true))
            {
                ByteArrayXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.ByteArrayNotNull),
                    item: item.ByteArrayNotNull,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.ByteArrayNotNull,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.ByteArraySingleton) ?? true))
            {
                ByteArrayXmlTranslation.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.ByteArraySingleton,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.BoolN) ?? true))
            {
                BooleanXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.BoolN),
                    item: item.BoolN,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.BoolN,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Bool) ?? true))
            {
                BooleanXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Bool),
                    item: item.Bool,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Bool,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.CharN) ?? true))
            {
                CharXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.CharN),
                    item: item.CharN,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.CharN,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Char) ?? true))
            {
                CharXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Char),
                    item: item.Char,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Char,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.DateTimeNull) ?? true))
            {
                DateTimeXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.DateTimeNull),
                    item: item.DateTimeNull,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.DateTimeNull,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.DateTime) ?? true))
            {
                DateTimeXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.DateTime),
                    item: item.DateTime,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.DateTime,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.DoubleN) ?? true))
            {
                DoubleXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.DoubleN),
                    item: item.DoubleN,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.DoubleN,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.DoubleN_Ranged) ?? true))
            {
                DoubleXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.DoubleN_Ranged),
                    item: item.DoubleN_Ranged,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.DoubleN_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Double) ?? true))
            {
                DoubleXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Double),
                    item: item.Double,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Double,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Double_Ranged) ?? true))
            {
                DoubleXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Double_Ranged),
                    item: item.Double_Ranged,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Double_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.FloatN) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.FloatN),
                    item: item.FloatN,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.FloatN,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.FloatN_Ranged) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.FloatN_Ranged),
                    item: item.FloatN_Ranged,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.FloatN_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Float) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Float),
                    item: item.Float,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Float,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Float_Ranged) ?? true))
            {
                FloatXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Float_Ranged),
                    item: item.Float_Ranged,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Float_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Int16N) ?? true))
            {
                Int16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int16N),
                    item: item.Int16N,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Int16N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Int16N_Ranged) ?? true))
            {
                Int16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int16N_Ranged),
                    item: item.Int16N_Ranged,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Int16N_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Int16) ?? true))
            {
                Int16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int16),
                    item: item.Int16,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Int16,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Int16_Ranged) ?? true))
            {
                Int16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int16_Ranged),
                    item: item.Int16_Ranged,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Int16_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Int32N) ?? true))
            {
                Int32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int32N),
                    item: item.Int32N,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Int32N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Int32N_Ranged) ?? true))
            {
                Int32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int32N_Ranged),
                    item: item.Int32N_Ranged,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Int32N_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Int32) ?? true))
            {
                Int32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int32),
                    item: item.Int32,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Int32,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Int32_Ranged) ?? true))
            {
                Int32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int32_Ranged),
                    item: item.Int32_Ranged,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Int32_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Int64N) ?? true))
            {
                Int64XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int64N),
                    item: item.Int64N,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Int64N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Int64N_Ranged) ?? true))
            {
                Int64XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int64N_Ranged),
                    item: item.Int64N_Ranged,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Int64N_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Int64) ?? true))
            {
                Int64XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int64),
                    item: item.Int64,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Int64,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Int64_Ranged) ?? true))
            {
                Int64XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int64_Ranged),
                    item: item.Int64_Ranged,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Int64_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Int8N) ?? true))
            {
                Int8XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int8N),
                    item: item.Int8N,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Int8N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Int8N_Ranged) ?? true))
            {
                Int8XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int8N_Ranged),
                    item: item.Int8N_Ranged,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Int8N_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Int8) ?? true))
            {
                Int8XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int8),
                    item: item.Int8,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Int8,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Int8_Ranged) ?? true))
            {
                Int8XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Int8_Ranged),
                    item: item.Int8_Ranged,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Int8_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Unsafe) ?? true))
            {
                WildcardXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Unsafe),
                    item: item.Unsafe,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Unsafe,
                    errorMask: errorMask,
                    translationMask: translationMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.UnsafeLoqui) ?? true))
            {
                WildcardXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UnsafeLoqui),
                    item: item.UnsafeLoqui,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.UnsafeLoqui,
                    errorMask: errorMask,
                    translationMask: translationMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.UnsafeNull) ?? true))
            {
                WildcardXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UnsafeNull),
                    item: item.UnsafeNull,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.UnsafeNull,
                    errorMask: errorMask,
                    translationMask: translationMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.P2IntN) ?? true))
            {
                P2IntXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.P2IntN),
                    item: item.P2IntN,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.P2IntN,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.P2Int) ?? true))
            {
                P2IntXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.P2Int),
                    item: item.P2Int,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.P2Int,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.P3DoubleN) ?? true))
            {
                P3DoubleXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.P3DoubleN),
                    item: item.P3DoubleN,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.P3DoubleN,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.P3Double) ?? true))
            {
                P3DoubleXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.P3Double),
                    item: item.P3Double,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.P3Double,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.P3IntN) ?? true))
            {
                P3IntXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.P3IntN),
                    item: item.P3IntN,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.P3IntN,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.P3Int) ?? true))
            {
                P3IntXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.P3Int),
                    item: item.P3Int,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.P3Int,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.PercentN) ?? true))
            {
                PercentXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.PercentN),
                    item: item.PercentN,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.PercentN,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Percent) ?? true))
            {
                PercentXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.Percent),
                    item: item.Percent,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Percent,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.RangeInt8N) ?? true))
            {
                RangeInt8XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeInt8N),
                    item: item.RangeInt8N,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.RangeInt8N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.RangeInt8) ?? true))
            {
                RangeInt8XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeInt8),
                    item: item.RangeInt8,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.RangeInt8,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.RangeInt16N) ?? true))
            {
                RangeInt16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeInt16N),
                    item: item.RangeInt16N,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.RangeInt16N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.RangeInt16) ?? true))
            {
                RangeInt16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeInt16),
                    item: item.RangeInt16,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.RangeInt16,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.RangeInt32N) ?? true))
            {
                RangeInt32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeInt32N),
                    item: item.RangeInt32N,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.RangeInt32N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.RangeInt32) ?? true))
            {
                RangeInt32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeInt32),
                    item: item.RangeInt32,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.RangeInt32,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.RangeInt64N) ?? true))
            {
                RangeInt64XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeInt64N),
                    item: item.RangeInt64N,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.RangeInt64N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.RangeInt64) ?? true))
            {
                RangeInt64XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeInt64),
                    item: item.RangeInt64,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.RangeInt64,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.RangeUInt8N) ?? true))
            {
                RangeUInt8XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeUInt8N),
                    item: item.RangeUInt8N,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.RangeUInt8N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.RangeUInt8) ?? true))
            {
                RangeUInt8XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeUInt8),
                    item: item.RangeUInt8,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.RangeUInt8,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.RangeUInt16N) ?? true))
            {
                RangeUInt16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeUInt16N),
                    item: item.RangeUInt16N,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.RangeUInt16N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.RangeUInt16) ?? true))
            {
                RangeUInt16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeUInt16),
                    item: item.RangeUInt16,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.RangeUInt16,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.RangeUInt32N) ?? true))
            {
                RangeUInt32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeUInt32N),
                    item: item.RangeUInt32N,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.RangeUInt32N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.RangeUInt32) ?? true))
            {
                RangeUInt32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeUInt32),
                    item: item.RangeUInt32,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.RangeUInt32,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.RangeUInt64N) ?? true))
            {
                RangeUInt64XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeUInt64N),
                    item: item.RangeUInt64N,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.RangeUInt64N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.RangeUInt64) ?? true))
            {
                RangeUInt64XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.RangeUInt64),
                    item: item.RangeUInt64,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.RangeUInt64,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.String) ?? true))
            {
                StringXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.String),
                    item: item.String,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.String,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.FilePath) ?? true))
            {
                FilePathXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.FilePath),
                    item: item.FilePath,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.FilePath,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.FilePathNull) ?? true))
            {
                FilePathXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.FilePathNull),
                    item: item.FilePathNull,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.FilePathNull,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.DirectoryPath) ?? true))
            {
                DirectoryPathXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.DirectoryPath),
                    item: item.DirectoryPath,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.DirectoryPath,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.DirectoryPathNull) ?? true))
            {
                DirectoryPathXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.DirectoryPathNull),
                    item: item.DirectoryPathNull,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.DirectoryPathNull,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.UDoubleN) ?? true))
            {
                UDoubleXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UDoubleN),
                    item: item.UDoubleN,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.UDoubleN,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.UDoubleN_Ranged) ?? true))
            {
                UDoubleXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UDoubleN_Ranged),
                    item: item.UDoubleN_Ranged,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.UDoubleN_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.UDouble) ?? true))
            {
                UDoubleXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UDouble),
                    item: item.UDouble,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.UDouble,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.UDouble_Ranged) ?? true))
            {
                UDoubleXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UDouble_Ranged),
                    item: item.UDouble_Ranged,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.UDouble_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.UInt16N) ?? true))
            {
                UInt16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt16N),
                    item: item.UInt16N,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.UInt16N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.UInt16N_Ranged) ?? true))
            {
                UInt16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt16N_Ranged),
                    item: item.UInt16N_Ranged,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.UInt16N_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.UInt16) ?? true))
            {
                UInt16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt16),
                    item: item.UInt16,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.UInt16,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.UInt16_Ranged) ?? true))
            {
                UInt16XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt16_Ranged),
                    item: item.UInt16_Ranged,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.UInt16_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.UInt32N) ?? true))
            {
                UInt32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt32N),
                    item: item.UInt32N,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.UInt32N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.UInt32N_Ranged) ?? true))
            {
                UInt32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt32N_Ranged),
                    item: item.UInt32N_Ranged,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.UInt32N_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.UInt32) ?? true))
            {
                UInt32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt32),
                    item: item.UInt32,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.UInt32,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.UInt32_Ranged) ?? true))
            {
                UInt32XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt32_Ranged),
                    item: item.UInt32_Ranged,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.UInt32_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.UInt64N) ?? true))
            {
                UInt64XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt64N),
                    item: item.UInt64N,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.UInt64N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.UInt64N_Ranged) ?? true))
            {
                UInt64XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt64N_Ranged),
                    item: item.UInt64N_Ranged,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.UInt64N_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.UInt64) ?? true))
            {
                UInt64XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt64),
                    item: item.UInt64,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.UInt64,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.UInt64_Ranged) ?? true))
            {
                UInt64XmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt64_Ranged),
                    item: item.UInt64_Ranged,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.UInt64_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.UInt8N) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt8N),
                    item: item.UInt8N,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.UInt8N,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.UInt8N_Ranged) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt8N_Ranged),
                    item: item.UInt8N_Ranged,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.UInt8N_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.UInt8) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt8),
                    item: item.UInt8,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.UInt8,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.UInt8_Ranged) ?? true))
            {
                ByteXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.UInt8_Ranged),
                    item: item.UInt8_Ranged,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.UInt8_Ranged,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Enum) ?? true))
            {
                EnumXmlTranslation<TestEnum>.Instance.Write(
                    node: node,
                    name: nameof(item.Enum),
                    item: item.Enum,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Enum,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.EnumNull) ?? true))
            {
                EnumXmlTranslation<TestEnum>.Instance.Write(
                    node: node,
                    name: nameof(item.EnumNull),
                    item: item.EnumNull,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.EnumNull,
                    errorMask: errorMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.WildCard) ?? true))
            {
                WildcardXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.WildCard),
                    item: item.WildCard,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.WildCard,
                    errorMask: errorMask,
                    translationMask: translationMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.WildCardLoqui) ?? true))
            {
                WildcardXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.WildCardLoqui),
                    item: item.WildCardLoqui,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.WildCardLoqui,
                    errorMask: errorMask,
                    translationMask: translationMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.WildCardNull) ?? true))
            {
                WildcardXmlTranslation.Instance.Write(
                    node: node,
                    name: nameof(item.WildCardNull),
                    item: item.WildCardNull,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.WildCardNull,
                    errorMask: errorMask,
                    translationMask: translationMask);
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Ref) ?? true))
            {
                LoquiXmlTranslation<ObjectToRef>.Instance.Write(
                    node: node,
                    item: item.Ref,
                    name: nameof(item.Ref),
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Ref,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_Abstract_FieldIndex.Ref));
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Ref_NotNull) ?? true))
            {
                LoquiXmlTranslation<ObjectToRef>.Instance.Write(
                    node: node,
                    item: item.Ref_NotNull,
                    name: nameof(item.Ref_NotNull),
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Ref_NotNull,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_Abstract_FieldIndex.Ref_NotNull));
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Ref_Singleton) ?? true))
            {
                LoquiXmlTranslation<ObjectToRef>.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Ref_Singleton,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_Abstract_FieldIndex.Ref_Singleton));
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.RefGetter) ?? true))
            {
                LoquiXmlTranslation<ObjectToRef>.Instance.Write(
                    node: node,
                    item: item.RefGetter,
                    name: nameof(item.RefGetter),
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.RefGetter,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_Abstract_FieldIndex.RefGetter));
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.RefGetter_NotNull) ?? true))
            {
                LoquiXmlTranslation<ObjectToRef>.Instance.Write(
                    node: node,
                    item: item.RefGetter_NotNull,
                    name: nameof(item.RefGetter_NotNull),
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.RefGetter_NotNull,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_Abstract_FieldIndex.RefGetter_NotNull));
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.RefGetter_Singleton) ?? true))
            {
                LoquiXmlTranslation<ObjectToRef>.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.RefGetter_Singleton,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_Abstract_FieldIndex.RefGetter_Singleton));
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.RefSetter) ?? true))
            {
                LoquiXmlTranslation<ObjectToRef>.Instance.Write(
                    node: node,
                    item: item.RefSetter,
                    name: nameof(item.RefSetter),
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.RefSetter,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_Abstract_FieldIndex.RefSetter));
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.RefSetter_NotNull) ?? true))
            {
                LoquiXmlTranslation<ObjectToRef>.Instance.Write(
                    node: node,
                    item: item.RefSetter_NotNull,
                    name: nameof(item.RefSetter_NotNull),
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.RefSetter_NotNull,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_Abstract_FieldIndex.RefSetter_NotNull));
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.RefSetter_Singleton) ?? true))
            {
                LoquiXmlTranslation<ObjectToRef>.Instance.Write(
                    ...
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.RefSetter_Singleton,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_Abstract_FieldIndex.RefSetter_Singleton));
            }
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.List) ?? true))
            {
                ListXmlTranslation<Boolean>.Instance.Write(
                    node: node,
                    name: nameof(item.List),
                    item: item.List,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.List,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_Abstract_FieldIndex.List),
            ...
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.RefList) ?? true))
            {
                ListXmlTranslation<ObjectToRef>.Instance.Write(
                    node: node,
                    name: nameof(item.RefList),
                    item: item.RefList,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.RefList,
                    errorMask: errorMask,
                    translationMask: translationMask?.GetSubCrystal((int)TestObject_Abstract_FieldIndex.RefList),
            ...
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.Dict) ?? true))
            {
                DictXmlTranslation<String, Boolean>.Instance.Write(
                    writer: node,
                    name: nameof(item.Dict),
                    items: item.Dict,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.Dict,
                    errorMask: errorMask,
                    translationMask: translationMask,
            ...
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.RefDict) ?? true))
            {
                DictXmlTranslation<ObjectToRef, ObjectToRef>.Instance.Write(
                    writer: node,
                    name: nameof(item.RefDict),
                    items: item.RefDict,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.RefDict,
                    errorMask: errorMask,
                    translationMask: translationMask,
            ...
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.KeyRefDict) ?? true))
            {
                DictXmlTranslation<ObjectToRef, Boolean>.Instance.Write(
                    writer: node,
                    name: nameof(item.KeyRefDict),
                    items: item.KeyRefDict,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.KeyRefDict,
                    errorMask: errorMask,
                    translationMask: translationMask,
                    keyTransl: (ObjectToRef subItem, ErrorMaskBuilder dictSubMask, TranslationCrystal dictSubTranslMask) =>
                    {
            ...
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.ValRefDict) ?? true))
            {
                DictXmlTranslation<String, ObjectToRef>.Instance.Write(
                    writer: node,
                    name: nameof(item.ValRefDict),
                    items: item.ValRefDict,
                    fieldIndex: (int)TestObject_Abstract_FieldIndex.ValRefDict,
                    errorMask: errorMask,
                    translationMask: translationMask,
                    keyTransl: (String subItem, ErrorMaskBuilder dictSubMask, TranslationCrystal dictSubTranslMask) =>
                    {
            ...
            if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.DictKeyedValue) ?? true))
            {
                try
                {
                    errorMask?.PushIndex((int)TestObject_Abstract_FieldIndex.DictKeyedValue);
            ...
            TranslationCrystal translationMask)
        {
            try
            {
                ...
                {
                    TestObject_AbstractCommon.FillPublicElement_Xml(
                        item: item,
                        node: elem,
                            ...
                            keyTransl: (XElement r, int dictIndex, ErrorMaskBuilder dictErrMask, MaskItem<bool, ObjectToRef_TranslationMask> dictTranslMask) =>
                            {
                                try
                                {
                                    ...
                                    if (LoquiXmlTranslation<ObjectToRef>.Instance.Parse(
                                        ...
                                        errorMask: dictErrMask,
                                        translationMask: dictTranslMask?.GetSubCrystal((int)TestObject_Abstract_FieldIndex.)))
                                    {
                                        return  = Parse;
                                    }
                                    else
                ...
                case "DictKeyedValue":
                    if ((translationMask?.GetShouldTranslate((int)TestObject_Abstract_FieldIndex.DictKeyedValue) ?? true))
                    {
                        KeyedDictXmlTranslation<Int32, ObjectToRef>.Instance.ParseInto(
                            ...
                            fieldIndex: (int)TestObject_Abstract_FieldIndex.DictKeyedValue,
                            errorMask: errorMask,
                            translationMask: translationMask,
    ...
    #region Modules
    #region Mask
    public class TestObject_Abstract_Mask<T> : IMask<T>, IEquatable<TestObject_Abstract_Mask<T>>
    {
        #region Ctors
        public TestObject_Abstract_Mask()
        {
        }

        public TestObject_Abstract_Mask(T initialValue)
        {
        ...
        public override bool Equals(object obj)
        {
            if (!(obj is TestObject_Abstract_Mask<T> rhs)) return false;
            return Equals(rhs);
        }

        public bool Equals(TestObject_Abstract_Mask<T> rhs)
        {
            if (rhs == null) return false;
        ...
        #region Translate
        public TestObject_Abstract_Mask<R> Translate<R>(Func<T, R> eval)
        {
            var ret = new TestObject_Abstract_Mask<R>();
            this.Translate_InternalFill(ret, eval);
            return ret;
        }

        protected void Translate_InternalFill<R>(TestObject_Abstract_Mask<R> obj, Func<T, R> eval)
        {
        ...
        public string ToString(TestObject_Abstract_Mask<bool> printMask = null)
        {
            var fg = new FileGeneration();
        ...
        public void ToString(FileGeneration fg, TestObject_Abstract_Mask<bool> printMask = null)
        {
            fg.AppendLine($"{nameof(TestObject_Abstract_Mask<T>)} =>");
            fg.AppendLine("[");
            using (new DepthWrapper(fg))
            {
                if (printMask?.ByteArray ?? true)
    ...
    public class TestObject_Abstract_ErrorMask : IErrorMask, IErrorMask<TestObject_Abstract_ErrorMask>
    {
        ...
        {
            fg.AppendLine("TestObject_Abstract_ErrorMask =>");
            fg.AppendLine("[");
            using (new DepthWrapper(fg))
            {
        ...
        #region Combine
        public TestObject_Abstract_ErrorMask Combine(TestObject_Abstract_ErrorMask rhs)
        {
            var ret = new TestObject_Abstract_ErrorMask();
        ...
        public static TestObject_Abstract_ErrorMask Combine(TestObject_Abstract_ErrorMask lhs, TestObject_Abstract_ErrorMask rhs)
        {
        ...
        #region Factory
        public static TestObject_Abstract_ErrorMask Factory(ErrorMaskBuilder errorMask)
        {
            if (errorMask?.Empty ?? true) return null;
            return new TestObject_Abstract_ErrorMask();
        }
        #endregion

    }
    public class TestObject_Abstract_CopyMask
    {
        public TestObject_Abstract_CopyMask()
        {
        }

        public TestObject_Abstract_CopyMask(bool defaultOn, CopyOption deepCopyOption = CopyOption.Reference)
        {
    ...
    public class TestObject_Abstract_TranslationMask : ITranslationMask
    {
        #region Members
        ...
        #region Ctors
        public TestObject_Abstract_TranslationMask()
        {
        }

        public TestObject_Abstract_TranslationMask(bool defaultOn)
        {
            this.ByteArray = defaultOn;
            this.ByteArrayNull = defaultOn;
            this.ByteArrayNotNull = defaultOn;
