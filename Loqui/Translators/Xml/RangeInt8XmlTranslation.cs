...
namespace Loqui.Xml
{
    public class RangeInt8XmlTranslation : PrimitiveXmlTranslation<RangeInt8>
    {
        ...
        protected override bool ParseNonNullString(string str, out RangeInt8 value, ErrorMaskBuilder errorMask)
        {
            throw new NotImplementedException();
        }

        protected override bool ParseValue(XElement root, out RangeInt8? value, ErrorMaskBuilder errorMask)
        {
            sbyte? min, max;
