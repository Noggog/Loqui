...
namespace Loqui.Xml
{
    public class RangeUInt32XmlTranslation : PrimitiveXmlTranslation<RangeUInt32>
    {
        ...
        protected override bool ParseNonNullString(string str, out RangeUInt32 value, ErrorMaskBuilder errorMask)
        {
            throw new NotImplementedException();
        }

        protected override bool ParseValue(XElement root, out RangeUInt32? value, ErrorMaskBuilder errorMask)
        {
            uint? min, max;
