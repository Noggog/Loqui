...
namespace Loqui.Xml
{
    public class RangeInt32XmlTranslation : PrimitiveXmlTranslation<RangeInt32>
    {
        ...
        protected override bool ParseNonNullString(string str, out RangeInt32 value, ErrorMaskBuilder errorMask)
        {
            throw new NotImplementedException();
        }

        protected override bool ParseValue(XElement root, out RangeInt32? item, ErrorMaskBuilder errorMask)
        {
            int? min, max;
