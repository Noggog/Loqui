...
namespace Loqui.Xml
{
    public class RangeInt64XmlTranslation : PrimitiveXmlTranslation<RangeInt64>
    {
        ...
        protected override bool ParseNonNullString(string str, out RangeInt64 value, ErrorMaskBuilder errorMask)
        {
            throw new NotImplementedException();
        }

        protected override bool ParseValue(XElement root, out RangeInt64? value, ErrorMaskBuilder errorMask)
        {
            long? min, max;
