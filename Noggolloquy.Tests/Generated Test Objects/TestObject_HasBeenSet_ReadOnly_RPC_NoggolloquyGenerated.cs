...
namespace Noggolloquy.Tests
{
    ...
    public partial class TestObject_HasBeenSet_ReadOnly_RPC : ITestObject_HasBeenSet_ReadOnly_RPC, INoggolloquyObjectSetter, INotifyPropertyChanged, IEquatable<TestObject_HasBeenSet_ReadOnly_RPC>
    {
        ...
        RangeInt? ITestObject_HasBeenSet_ReadOnly_RPCGetter.RangeIntN => this.RangeIntN;
        IHasBeenSetItemGetter<RangeInt?> ITestObject_HasBeenSet_ReadOnly_RPCGetter.RangeIntN_Property => this.RangeIntN_Property;
        #endregion
        #region RangeInt
        ...
        RangeInt ITestObject_HasBeenSet_ReadOnly_RPCGetter.RangeInt => this.RangeInt;
        IHasBeenSetItemGetter<RangeInt> ITestObject_HasBeenSet_ReadOnly_RPCGetter.RangeInt_Property => this.RangeInt_Property;
        #endregion
        #region String
