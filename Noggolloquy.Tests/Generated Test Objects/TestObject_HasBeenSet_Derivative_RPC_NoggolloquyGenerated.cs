...
namespace Noggolloquy.Tests
{
    ...
    public partial class TestObject_HasBeenSet_Derivative_RPC : ITestObject_HasBeenSet_Derivative_RPC, INoggolloquyObjectSetter, INotifyPropertyChanged, IEquatable<TestObject_HasBeenSet_Derivative_RPC>
    {
        ...
        RangeInt? ITestObject_HasBeenSet_Derivative_RPCGetter.RangeIntN => this.RangeIntN;
        IHasBeenSetItemGetter<RangeInt?> ITestObject_HasBeenSet_Derivative_RPCGetter.RangeIntN_Property => this.RangeIntN_Property;
        #endregion
        #region RangeInt
        ...
        RangeInt ITestObject_HasBeenSet_Derivative_RPCGetter.RangeInt => this.RangeInt;
        IHasBeenSetItemGetter<RangeInt> ITestObject_HasBeenSet_Derivative_RPCGetter.RangeInt_Property => this.RangeInt_Property;
        #endregion
        #region String
