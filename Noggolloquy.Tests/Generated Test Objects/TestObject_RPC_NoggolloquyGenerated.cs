...
{
    #region Class
    public partial class TestObject_RPC : ITestObject_RPC, INoggolloquyObjectSetter, INotifyPropertyChanged, IEquatable<TestObject_RPC>
    {
        INoggolloquyRegistration INoggolloquyObject.Registration => TestObject_RPC_Registration.Instance;
        ...
        {
            get => _RangeIntN;
            set { this._RangeIntN = value; OnPropertyChanged(nameof(RangeIntN)); }
        }
        #endregion
        #region RangeInt
        ...
        {
            get => _RangeInt;
            set { this._RangeInt = value; OnPropertyChanged(nameof(RangeInt)); }
        }
        #endregion
        #region String
        ...
        #region Interface Members
        INotifyingDictionary<Boolean, String> ITestObject_RPC.Dict => _Dict;
        INotifyingDictionaryGetter<Boolean, String> ITestObject_RPCGetter.Dict => _Dict;
        #endregion
        ...
        public static TestObject_RPC Create_XML(XElement root)
        {
            ...
            NoggXmlTranslation<TestObject_RPC, TestObject_RPC_ErrorMask>.Instance.CopyIn(
                root: root,
                item: ret,
                skipProtected: false,
                doMasks: false,
        ...
        {
            NoggXmlTranslation<TestObject_RPC, TestObject_RPC_ErrorMask>.Instance.Write(
                writer: writer,
                name: name,
                item: this,
                doMasks: true,
        ...
        public static TestObject_RPC Copy_ToNoggolloquy(
        ...
        protected void SetNthObject(ushort index, object obj, NotifyingFireParameters? cmds = null)
        {
            ...
            switch (enu)
            {
                ...
                case TestObject_RPC_FieldIndex.Percent:
                    ...
                    break;
                case TestObject_RPC_FieldIndex.RangeIntN:
                    this.RangeIntN = (RangeInt32?)obj;
                    break;
                case TestObject_RPC_FieldIndex.RangeInt:
    ...
    #region Interface
    public interface ITestObject_RPC : ITestObject_RPCGetter, INoggolloquyClass<ITestObject_RPC, ITestObject_RPCGetter>, INoggolloquyClass<TestObject_RPC, ITestObject_RPCGetter>
    {
    ...
    public interface ITestObject_RPCGetter : INoggolloquyObject
    {
        #region BoolN
        Boolean? BoolN { get; }
...
namespace Noggolloquy.Tests.Internals
{
    ...
    #region Registration
    public class TestObject_RPC_Registration : INoggolloquyRegistration
    {
        ...
        public const string FullName = "Noggolloquy.Tests.TestObject_RPC";
        ...
        public static ushort? GetNameIndex(StringCaseAgnostic str)
        {
            switch (str.Upper)
            {
                ...
                case "RANGEINTN":
                    return (ushort)TestObject_RPC_FieldIndex.RangeIntN;
                case "RANGEINT":
                    return (ushort)TestObject_RPC_FieldIndex.RangeInt;
                case "STRING":
    ...
    #region Mask
    public class TestObject_RPC_Mask<T> 
    {
        public T BoolN;
        public T Bool;
        public T CharN;
