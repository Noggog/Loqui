...
namespace Noggolloquy.Tests
{
    ...
    public partial class TestObject_Notifying_RPC : ITestObject_Notifying_RPC, INoggolloquyObjectSetter, INotifyPropertyChanged, IEquatable<TestObject_Notifying_RPC>
    {
        ...
        INotifyingItem<RangeInt32?> ITestObject_Notifying_RPC.RangeIntN_Property => this.RangeIntN_Property;
        INotifyingItemGetter<RangeInt32?> ITestObject_Notifying_RPCGetter.RangeIntN_Property => this.RangeIntN_Property;
        #endregion
        #region RangeInt
        ...
        INotifyingItem<RangeInt32> ITestObject_Notifying_RPC.RangeInt_Property => this.RangeInt_Property;
        INotifyingItemGetter<RangeInt32> ITestObject_Notifying_RPCGetter.RangeInt_Property => this.RangeInt_Property;
        #endregion
        #region String
    ...
    public class TestObject_Notifying_RPC_Registration : INoggolloquyRegistration
    {
        ...
        public static ushort? GetNameIndex(StringCaseAgnostic str)
        {
            switch (str.Upper)
            {
                ...
                case "RANGEINTN":
                    return (ushort)TestObject_Notifying_RPC_FieldIndex.RangeIntN;
                case "RANGEINT":
                    return (ushort)TestObject_Notifying_RPC_FieldIndex.RangeInt;
                case "STRING":
