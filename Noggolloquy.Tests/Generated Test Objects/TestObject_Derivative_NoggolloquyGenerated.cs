    ...
    public partial class TestObject_Derivative : ITestObject_Derivative, INoggolloquyObjectSetter, IEquatable<TestObject_Derivative>
    {
        ...
        protected void SetNthObject(ushort index, object obj, NotifyingFireParameters? cmds = null)
        {
            ...
            switch (enu)
            {
                ...
                case TestObject_Derivative_FieldIndex.RangeIntN:
                case TestObject_Derivative_FieldIndex.RangeInt:
    ...
    public class TestObject_Derivative_Registration : INoggolloquyRegistration
    {
        ...
        public static ushort? GetNameIndex(StringCaseAgnostic str)
        {
            switch (str.Upper)
            {
                ...
                case "RANGEINTN":
                    return (ushort)TestObject_Derivative_FieldIndex.RangeIntN;
                case "RANGEINT":
                    return (ushort)TestObject_Derivative_FieldIndex.RangeInt;
                case "STRING":
