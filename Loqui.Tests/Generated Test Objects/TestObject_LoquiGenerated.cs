...
namespace Loqui.Tests
{
    ...
    public partial class TestObject : ITestObject, ILoquiObjectSetter, IEquatable<TestObject>
    {
        ...
        public virtual void Write_XML(Stream stream, out TestObject_ErrorMask errorMask)
        {
        ...
        public virtual void Write_XML(string path, out TestObject_ErrorMask errorMask)
        {
        ...
        public virtual void Write_XML(XmlWriter writer, out TestObject_ErrorMask errorMask, string name = null)
        {
...
namespace Loqui.Tests.Internals
{
    ...
    public class TestObject_Mask<T> : IMask<T>, IEquatable<TestObject_Mask<T>>
    {
        ...
        #region Translate
        public new TestObject_Mask<R> Translate<R>(Func<T, R> eval)
        {
