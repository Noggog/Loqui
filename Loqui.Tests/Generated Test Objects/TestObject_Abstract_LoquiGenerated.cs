...
{
    #region Class
    public abstract partial class TestObject_Abstract : ITestObject_Abstract, ILoquiObjectSetter, IEquatable<TestObject_Abstract>
    {
        ...
        INotifyingList<Boolean> ITestObject_Abstract.List => _List;
        INotifyingListGetter<Boolean> ITestObject_AbstractGetter.List => _List;
        #endregion
        ...
        #region Interface Members
        INotifyingList<ObjectToRef> ITestObject_Abstract.RefList => _RefList;
        INotifyingListGetter<ObjectToRef> ITestObject_AbstractGetter.RefList => _RefList;
        #endregion
        ...
        #region Interface Members
        INotifyingKeyedCollection<Int32, ObjectToRef> ITestObject_Abstract.DictKeyedValue => _DictKeyedValue;
        INotifyingKeyedCollectionGetter<Int32, ObjectToRef> ITestObject_AbstractGetter.DictKeyedValue => _DictKeyedValue;
        #endregion
            ...
            switch (name)
            {
                ...
                case "Ref_Singleton":
                    ...
                    ErrorMask.HandleErrorMask(
                        errorMask,
                        index: (int)TestObject_Abstract_FieldIndex.Ref_Singleton,
                ...
                case "RefSetter_Singleton":
                    ...
                    ErrorMask.HandleErrorMask(
                        errorMask,
                        index: (int)TestObject_Abstract_FieldIndex.RefSetter_Singleton,
    ...
    #region Interface
    public interface ITestObject_Abstract : ITestObject_AbstractGetter, ILoquiClass<ITestObject_Abstract, ITestObject_AbstractGetter>, ILoquiClass<TestObject_Abstract, ITestObject_AbstractGetter>
    {
    ...
    public interface ITestObject_AbstractGetter : ILoquiObject
    {
        #region ByteArray
        Byte[] ByteArray { get; }
...
namespace Loqui.Tests.Internals
{
    ...
    public class TestObject_Abstract_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Loqui.Tests.TestObject_Abstract";
    ...
    public static partial class TestObject_AbstractCommon
    {
        ...
        public static void CopyFieldsFrom(
            this ITestObject_Abstract item,
            ...
            NotifyingFireParameters cmds = null)
        {
            ...
            Func<TestObject_Abstract_ErrorMask> maskGetter = () =>
            {
                ...
                {
                    retErrorMask = new TestObject_Abstract_ErrorMask();
                }
                return retErrorMask;
            };
            CopyFieldsFrom(
            ...
            NotifyingFireParameters cmds = null)
        {
            ...
            if (copyMask?.Ref.Overall != CopyOption.Skip)
            {
                ...
                when (doMasks)
                {
                    errorMask().SetNthException((int)TestObject_Abstract_FieldIndex.Ref, ex);
                }
            }
            if (copyMask?.Ref_NotNull.Overall != CopyOption.Skip)
            {
                ...
                when (doMasks)
                {
                    errorMask().SetNthException((int)TestObject_Abstract_FieldIndex.Ref_NotNull, ex);
                }
            }
            if (copyMask?.Ref_Singleton.Overall ?? true)
            {
                ...
                when (doMasks)
                {
                    errorMask().SetNthException((int)TestObject_Abstract_FieldIndex.Ref_Singleton, ex);
                }
            }
            if (copyMask?.RefGetter.Overall != CopyOption.Skip)
            {
                ...
                when (doMasks)
                {
                    errorMask().SetNthException((int)TestObject_Abstract_FieldIndex.RefGetter, ex);
                }
            }
            if (copyMask?.RefGetter_NotNull.Overall != CopyOption.Skip)
            {
                ...
                when (doMasks)
                {
                    errorMask().SetNthException((int)TestObject_Abstract_FieldIndex.RefGetter_NotNull, ex);
                }
            }
            if (copyMask?.RefSetter.Overall != CopyOption.Skip)
            {
                ...
                when (doMasks)
                {
                    errorMask().SetNthException((int)TestObject_Abstract_FieldIndex.RefSetter, ex);
                }
            }
            if (copyMask?.RefSetter_NotNull.Overall != CopyOption.Skip)
            {
                ...
                when (doMasks)
                {
                    errorMask().SetNthException((int)TestObject_Abstract_FieldIndex.RefSetter_NotNull, ex);
                }
            }
            if (copyMask?.RefSetter_Singleton.Overall ?? true)
            {
                ...
                when (doMasks)
                {
                    errorMask().SetNthException((int)TestObject_Abstract_FieldIndex.RefSetter_Singleton, ex);
                }
            }
            if (copyMask?.List != CopyOption.Skip)
            {
                ...
                when (doMasks)
                {
                    errorMask().SetNthException((int)TestObject_Abstract_FieldIndex.List, ex);
                }
            }
            if (copyMask?.RefList.Overall != CopyOption.Skip)
            {
                ...
                when (doMasks)
                {
                    errorMask().SetNthException((int)TestObject_Abstract_FieldIndex.RefList, ex);
                }
            }
            if (copyMask?.Dict ?? true)
            {
                ...
                when (doMasks)
                {
                    errorMask().SetNthException((int)TestObject_Abstract_FieldIndex.Dict, ex);
                }
            }
            if (copyMask?.RefDict.Overall ?? true)
            {
                ...
                when (doMasks)
                {
                    errorMask().SetNthException((int)TestObject_Abstract_FieldIndex.RefDict, ex);
                }
            }
            if (copyMask?.KeyRefDict.Overall ?? true)
            {
                ...
                when (doMasks)
                {
                    errorMask().SetNthException((int)TestObject_Abstract_FieldIndex.KeyRefDict, ex);
                }
            }
            if (copyMask?.ValRefDict.Overall ?? true)
            {
                ...
                when (doMasks)
                {
                    errorMask().SetNthException((int)TestObject_Abstract_FieldIndex.ValRefDict, ex);
                }
            }
            if (copyMask?.DictKeyedValue.Overall != CopyOption.Skip)
            {
                ...
                when (doMasks)
                {
                    errorMask().SetNthException((int)TestObject_Abstract_FieldIndex.DictKeyedValue, ex);
                }
            }
        }
        ...
        public static void Write_XML(
            ...
            string name = null)
        {
            TestObject_Abstract_ErrorMask errMaskRet = null;
            Write_XML_Internal(
                writer: writer,
                name: name,
                item: item,
                errorMask: doMasks ? () => errMaskRet ?? (errMaskRet = new TestObject_Abstract_ErrorMask()) : default(Func<TestObject_Abstract_ErrorMask>));
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Loqui.Tests.TestObject_Abstract"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Loqui.Tests.TestObject_Abstract");
                    }
