...
namespace Loqui.Tests
{
    ...
    public partial class TestObject_HasBeenSet_RPC : ITestObject_HasBeenSet_RPC, ILoquiObjectSetter, INotifyPropertyChanged, IEquatable<TestObject_HasBeenSet_RPC>
    {
        ...
        {
            if (!root.Name.LocalName.Equals("Loqui.Tests.TestObject_HasBeenSet_RPC"))
            {
                var ex = new ArgumentException($"Skipping field that did not match proper type. Type: {root.Name.LocalName}, expected: Loqui.Tests.TestObject_HasBeenSet_RPC.");
                if (!doMasks) throw ex;
            ...
            switch (name)
            {
                ...
                case "UnsafeLoqui":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_RPC_FieldIndex.UnsafeLoqui, suberrorMask);
                        }
                        if (tryGet.Succeeded)
                        {
                    ...
                    {
                        if (!doMasks) throw;
                        errorMask().SetNthException((ushort)TestObject_HasBeenSet_RPC_FieldIndex.UnsafeLoqui, ex);
                    }
                    break;
                case "UnsafeNull":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_RPC_FieldIndex.UnsafeNull, suberrorMask);
                        }
                        if (tryGet.Succeeded)
                        {
                    ...
                    {
                        if (!doMasks) throw;
                        errorMask().SetNthException((ushort)TestObject_HasBeenSet_RPC_FieldIndex.UnsafeNull, ex);
                    }
                    break;
                case "P2IntN":
                    try
                ...
                case "EnumNull":
                    ...
                    {
                        if (!doMasks) throw;
                        errorMask().SetNthException((ushort)TestObject_HasBeenSet_RPC_FieldIndex.EnumNull, ex);
                    }
                    break;
                case "WildCard":
                    try
                ...
                case "WildCardLoqui":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_RPC_FieldIndex.WildCardLoqui, suberrorMask);
                        }
                        if (tryGet.Succeeded)
                        {
                    ...
                    {
                        if (!doMasks) throw;
                        errorMask().SetNthException((ushort)TestObject_HasBeenSet_RPC_FieldIndex.WildCardLoqui, ex);
                    }
                    break;
                case "WildCardNull":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_RPC_FieldIndex.WildCardNull, suberrorMask);
                        }
                        if (tryGet.Succeeded)
                        {
                    ...
                    {
                        if (!doMasks) throw;
                        errorMask().SetNthException((ushort)TestObject_HasBeenSet_RPC_FieldIndex.WildCardNull, ex);
                    }
                    break;
                case "Ref":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_RPC_FieldIndex.Ref, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "Ref_NotNull":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_RPC_FieldIndex.Ref_NotNull, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "Ref_Singleton":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_RPC_FieldIndex.Ref_Singleton, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "RefGetter":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_RPC_FieldIndex.RefGetter, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "RefGetter_NotNull":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_RPC_FieldIndex.RefGetter_NotNull, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "RefSetter":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_RPC_FieldIndex.RefSetter, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "RefSetter_NotNull":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_RPC_FieldIndex.RefSetter_NotNull, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "RefSetter_Singleton":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_RPC_FieldIndex.RefSetter_Singleton, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "List":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_RPC_FieldIndex.List, suberrorMask);
                        }
                ...
                case "RefList":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_RPC_FieldIndex.RefList, suberrorMask);
                        }
                        if (listTryGet.Succeeded)
                        {
...
namespace Loqui.Tests.Internals
{
    ...
    public static class TestObject_HasBeenSet_RPCCommon
    {
            ...
            Func<TestObject_HasBeenSet_RPC_ErrorMask> errorMask)
        {
            try
            {
                using (new ElementWrapper(writer, "Loqui.Tests.TestObject_HasBeenSet_RPC"))
                {
                    ...
                    if (item.RefGetter_Singleton_Property.HasBeenSet)
                    {
                        try
                        {
                            if (item.RefGetter_Singleton_Property.HasBeenSet)
                            {
                                ...
                                if (suberrorMask != null)
                                {
                                    errorMask().SetNthMask((ushort)TestObject_HasBeenSet_RPC_FieldIndex.RefGetter_Singleton, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                                }
                            }
                        }
                        catch (Exception ex)
                    ...
                    if (item.Dict.HasBeenSet)
                    {
                        try
                        {
                            if (item.Dict.HasBeenSet)
                            {
                                ...
                                if (errorMaskObj != null)
                                {
                                    errorMask().SetNthMask((ushort)TestObject_HasBeenSet_RPC_FieldIndex.Dict, errorMaskObj);
                                }
                            }
                        }
                        catch (Exception ex)
                    ...
                    if (item.RefDict.HasBeenSet)
                    {
                        try
                        {
                            if (item.RefDict.HasBeenSet)
                            {
                                ...
                                if (errorMaskObj != null)
                                {
                                    errorMask().SetNthMask((ushort)TestObject_HasBeenSet_RPC_FieldIndex.RefDict, errorMaskObj);
                                }
                            }
                        }
                        catch (Exception ex)
                    ...
                    if (item.KeyRefDict.HasBeenSet)
                    {
                        try
                        {
                            if (item.KeyRefDict.HasBeenSet)
                            {
                                ...
                                if (errorMaskObj != null)
                                {
                                    errorMask().SetNthMask((ushort)TestObject_HasBeenSet_RPC_FieldIndex.KeyRefDict, errorMaskObj);
                                }
                            }
                        }
                        catch (Exception ex)
                    ...
                    if (item.ValRefDict.HasBeenSet)
                    {
                        try
                        {
                            if (item.ValRefDict.HasBeenSet)
                            {
                                ...
                                if (errorMaskObj != null)
                                {
                                    errorMask().SetNthMask((ushort)TestObject_HasBeenSet_RPC_FieldIndex.ValRefDict, errorMaskObj);
                                }
                            }
                        }
                        catch (Exception ex)
                    ...
                    if (item.DictKeyedValue.HasBeenSet)
                    {
                        try
                        {
                            if (item.DictKeyedValue.HasBeenSet)
                            {
                                ...
                                if (errorMaskObj != null)
                                {
                                    errorMask().SetNthMask((ushort)TestObject_HasBeenSet_RPC_FieldIndex.DictKeyedValue, errorMaskObj);
                                }
                            }
                        }
                        catch (Exception ex)
