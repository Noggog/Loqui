...
namespace Loqui.Tests
{
    ...
    public partial class TestObject_Derivative_RPC : ITestObject_Derivative_RPC, ILoquiObjectSetter, INotifyPropertyChanged, IEquatable<TestObject_Derivative_RPC>
    {
        ...
        {
            if (!root.Name.LocalName.Equals("Loqui.Tests.TestObject_Derivative_RPC"))
            {
                var ex = new ArgumentException($"Skipping field that did not match proper type. Type: {root.Name.LocalName}, expected: Loqui.Tests.TestObject_Derivative_RPC.");
                if (!doMasks) throw ex;
...
namespace Loqui.Tests.Internals
{
    ...
    public static class TestObject_Derivative_RPCCommon
    {
            ...
            Func<TestObject_Derivative_RPC_ErrorMask> errorMask)
        {
            try
            {
                using (new ElementWrapper(writer, "Loqui.Tests.TestObject_Derivative_RPC"))
                {
