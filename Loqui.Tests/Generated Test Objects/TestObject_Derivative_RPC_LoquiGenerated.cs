    ...
    public partial class TestObject_Derivative_RPC : ITestObject_Derivative_RPC, ILoquiObjectSetter, INotifyPropertyChanged, IEquatable<TestObject_Derivative_RPC>
    {
            ...
            bool doMasks)
        {
            ...
            var ret = Create_XML_Internal(
                root: root,
                errorMask: doMasks ? () => errMaskRet ?? (errMaskRet = new TestObject_Derivative_RPC_ErrorMask()) : default(Func<TestObject_Derivative_RPC_ErrorMask>));
            return (ret, errMaskRet);
        }

        public static TestObject_Derivative_RPC Create_XML(string path)
        {
        ...
        public static TestObject_Derivative_RPC Create_XML(Stream stream)
        {
        ...
        {
            LoquiXmlTranslation<TestObject_Derivative_RPC, TestObject_Derivative_RPC_ErrorMask>.Instance.CopyIn(
                root: root,
                item: this,
                skipProtected: true,
                doMasks: false,
            ...
            switch (name)
            {
                case "ByteArray":
                    item._ByteArray = ByteArrayXmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_Derivative_RPC_FieldIndex.ByteArray,
                        errorMask: errorMask).GetOrDefault(item._ByteArray);
                    break;
                case "ByteArrayNull":
                    item._ByteArrayNull = ByteArrayXmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_Derivative_RPC_FieldIndex.ByteArrayNull,
                ...
                case "ByteArrayNotNull":
                    item._ByteArrayNotNull = ByteArrayXmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_Derivative_RPC_FieldIndex.ByteArrayNotNull,
                ...
                case "UnsafeLoqui":
                    item._UnsafeLoqui = WildcardXmlTranslation.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Derivative_RPC_FieldIndex.UnsafeLoqui,
                ...
                case "UnsafeNull":
                    item._UnsafeNull = WildcardXmlTranslation.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Derivative_RPC_FieldIndex.UnsafeNull,
                ...
                case "DirectoryPathNull":
                    item._DirectoryPathNull = DirectoryPathXmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_Derivative_RPC_FieldIndex.DirectoryPathNull,
                        errorMask: errorMask).GetOrDefault(item._DirectoryPathNull);
                    break;
                case "UDoubleN":
                    item._UDoubleN = UDoubleXmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_Derivative_RPC_FieldIndex.UDoubleN,
                ...
                case "Enum":
                    item._Enum = EnumXmlTranslation<TestEnum>.Instance.Parse(
                        root,
                        nullable: false,
                        fieldIndex: (int)TestObject_Derivative_RPC_FieldIndex.Enum,
                ...
                case "EnumNull":
                    item._EnumNull = EnumXmlTranslation<TestEnum>.Instance.Parse(
                        root,
                        nullable: true,
                        fieldIndex: (int)TestObject_Derivative_RPC_FieldIndex.EnumNull,
                        errorMask: errorMask).GetOrDefault(item._EnumNull);
                    break;
                case "WildCard":
                    item._WildCard = WildcardXmlTranslation.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Derivative_RPC_FieldIndex.WildCard,
                ...
                case "WildCardLoqui":
                    item._WildCardLoqui = WildcardXmlTranslation.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Derivative_RPC_FieldIndex.WildCardLoqui,
                ...
                case "WildCardNull":
                    item._WildCardNull = WildcardXmlTranslation.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Derivative_RPC_FieldIndex.WildCardNull,
                ...
                case "Ref":
                    item._Ref = LoquiXmlTranslation<ObjectToRef, ObjectToRef_ErrorMask>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Derivative_RPC_FieldIndex.Ref,
                ...
                case "Ref_NotNull":
                    item._Ref_NotNull = LoquiXmlTranslation<ObjectToRef, ObjectToRef_ErrorMask>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Derivative_RPC_FieldIndex.Ref_NotNull,
                ...
                case "Ref_Singleton":
                    ...
                    ErrorMask.HandleErrorMask(
                        errorMask,
                        index: (int)TestObject_Derivative_RPC_FieldIndex.Ref_Singleton,
                ...
                case "RefGetter":
                    item._RefGetter = LoquiXmlTranslation<ObjectToRef, ObjectToRef_ErrorMask>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Derivative_RPC_FieldIndex.RefGetter,
                ...
                case "RefGetter_NotNull":
                    item._RefGetter_NotNull = LoquiXmlTranslation<ObjectToRef, ObjectToRef_ErrorMask>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Derivative_RPC_FieldIndex.RefGetter_NotNull,
                ...
                case "RefSetter":
                    item._RefSetter = LoquiXmlTranslation<ObjectToRef, ObjectToRef_ErrorMask>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Derivative_RPC_FieldIndex.RefSetter,
                ...
                case "RefSetter_NotNull":
                    item._RefSetter_NotNull = LoquiXmlTranslation<ObjectToRef, ObjectToRef_ErrorMask>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Derivative_RPC_FieldIndex.RefSetter_NotNull,
                ...
                case "RefSetter_Singleton":
                    ...
                    ErrorMask.HandleErrorMask(
                        errorMask,
                        index: (int)TestObject_Derivative_RPC_FieldIndex.RefSetter_Singleton,
                ...
                case "List":
                    var Listlist = ListXmlTranslation<Boolean, Exception>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Derivative_RPC_FieldIndex.List,
                        errorMask: errorMask,
                ...
                case "RefList":
                    var RefListlist = ListXmlTranslation<ObjectToRef, MaskItem<Exception, ObjectToRef_ErrorMask>>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Derivative_RPC_FieldIndex.RefList,
                        errorMask: errorMask,
                ...
                case "Dict":
                    var Dictdict = DictXmlTranslation<String, Boolean, Exception, Exception>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Derivative_RPC_FieldIndex.Dict,
                        errorMask: errorMask,
                ...
                case "RefDict":
                    var RefDictdict = DictXmlTranslation<ObjectToRef, ObjectToRef, MaskItem<Exception, ObjectToRef_ErrorMask>, MaskItem<Exception, ObjectToRef_ErrorMask>>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Derivative_RPC_FieldIndex.RefDict,
                        errorMask: errorMask,
                ...
                case "KeyRefDict":
                    var KeyRefDictdict = DictXmlTranslation<ObjectToRef, Boolean, MaskItem<Exception, ObjectToRef_ErrorMask>, Exception>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Derivative_RPC_FieldIndex.KeyRefDict,
                        errorMask: errorMask,
                        keyTransl: (XElement r, bool dictDoMasks, out MaskItem<Exception, ObjectToRef_ErrorMask> dictSubMask) =>
                        {
                            return LoquiXmlTranslation<ObjectToRef, ObjectToRef_ErrorMask>.Instance.Parse(
                ...
                case "ValRefDict":
                    var ValRefDictdict = DictXmlTranslation<String, ObjectToRef, Exception, MaskItem<Exception, ObjectToRef_ErrorMask>>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Derivative_RPC_FieldIndex.ValRefDict,
                        errorMask: errorMask,
                        keyTransl: (XElement r, bool dictDoMasks, out Exception dictSubMask) =>
                        {
                            return StringXmlTranslation.Instance.Parse(
                ...
                case "DictKeyedValue":
                    var DictKeyedValuedict = KeyedDictXmlTranslation<Int32, ObjectToRef, MaskItem<Exception, ObjectToRef_ErrorMask>>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Derivative_RPC_FieldIndex.DictKeyedValue,
                        errorMask: errorMask,
                        valTransl: (XElement r, bool dictDoMasks, out MaskItem<Exception, ObjectToRef_ErrorMask> dictSubMask) =>
                        {
                            return LoquiXmlTranslation<ObjectToRef, ObjectToRef_ErrorMask>.Instance.Parse(
...
namespace Loqui.Tests.Internals
{
    ...
    public class TestObject_Derivative_RPC_Registration : ILoquiRegistration
    {
        ...
        public const string FullName = "Loqui.Tests.TestObject_Derivative_RPC";
    ...
    public static partial class TestObject_Derivative_RPCCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Loqui.Tests.TestObject_Derivative_RPC"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Loqui.Tests.TestObject_Derivative_RPC");
                    }
                }
            }
            catch (Exception ex)
