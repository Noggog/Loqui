...
namespace Loqui.Tests
{
    ...
    public partial class TestObject_Notifying_Derivative : ITestObject_Notifying_Derivative, ILoquiObjectSetter, IEquatable<TestObject_Notifying_Derivative>
    {
        ...
        INotifyingItemGetter<Byte[]> ITestObject_Notifying_DerivativeGetter.ByteArraySingleton_Property => this.ByteArraySingleton_Property;
        #endregion
        #region BoolN
        ...
        INotifyingItemGetter<FilePath> ITestObject_Notifying_DerivativeGetter.FilePath_Property => this.FilePath_Property;
        #endregion
        #region FilePathNull
        ...
        INotifyingItemGetter<FilePath?> ITestObject_Notifying_DerivativeGetter.FilePathNull_Property => this.FilePathNull_Property;
        #endregion
        ...
        INotifyingItemGetter<DirectoryPath> ITestObject_Notifying_DerivativeGetter.DirectoryPath_Property => this.DirectoryPath_Property;
        #endregion
        ...
        INotifyingItemGetter<DirectoryPath?> ITestObject_Notifying_DerivativeGetter.DirectoryPathNull_Property => this.DirectoryPathNull_Property;
        #endregion
        #region UDoubleN
        ...
        #region Interface Members
        INotifyingDictionary<String, Boolean> ITestObject_Notifying_Derivative.Dict => _Dict;
        ...
        #region Interface Members
        INotifyingDictionary<ObjectToRef, ObjectToRef> ITestObject_Notifying_Derivative.RefDict => _RefDict;
        ...
        #region Interface Members
        INotifyingDictionary<ObjectToRef, Boolean> ITestObject_Notifying_Derivative.KeyRefDict => _KeyRefDict;
        ...
        #region Interface Members
        INotifyingDictionary<String, ObjectToRef> ITestObject_Notifying_Derivative.ValRefDict => _ValRefDict;
        ...
        #region Interface Members
        INotifyingKeyedCollection<Int32, ObjectToRef> ITestObject_Notifying_Derivative.DictKeyedValue => _DictKeyedValue;
        ...
        [DebuggerStepThrough]
        public static (TestObject_Notifying_Derivative Object, TestObject_Notifying_Derivative_ErrorMask ErrorMask) Create_XML(
            XElement root,
            bool doMasks)
        {
        ...
        public static TestObject_Notifying_Derivative Create_XML(string path)
        {
        ...
        public virtual void Write_XML(
            ...
            string name = null)
        {
            errorMask = (TestObject_Notifying_Derivative_ErrorMask)this.Write_XML_Internal(
                writer: writer,
                name: name,
                doMasks: true);
        }
            ...
            switch (name)
            {
                ...
                case "Enum":
                    item._Enum.SetIfSucceeded(EnumXmlTranslation<TestEnum>.Instance.Parse(
                        root,
                        nullable: false,
                        fieldIndex: (int)TestObject_Notifying_Derivative_FieldIndex.Enum,
                ...
                case "Ref_Singleton":
                    ...
                    ErrorMask.HandleErrorMask(
                        errorMask,
                        index: (int)TestObject_Notifying_Derivative_FieldIndex.Ref_Singleton,
                ...
                case "RefGetter":
                    item._RefGetter.SetIfSucceeded(LoquiXmlTranslation<ObjectToRef, ObjectToRef_ErrorMask>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Notifying_Derivative_FieldIndex.RefGetter,
                        errorMask: errorMask));
                    break;
                case "RefGetter_NotNull":
                    item._RefGetter_NotNull.SetIfSucceeded(LoquiXmlTranslation<ObjectToRef, ObjectToRef_ErrorMask>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Notifying_Derivative_FieldIndex.RefGetter_NotNull,
                        errorMask: errorMask));
                    break;
                ...
                case "RefSetter":
                    item._RefSetter.SetIfSucceeded(LoquiXmlTranslation<ObjectToRef, ObjectToRef_ErrorMask>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Notifying_Derivative_FieldIndex.RefSetter,
                        errorMask: errorMask));
                    break;
                case "RefSetter_NotNull":
                    item._RefSetter_NotNull.SetIfSucceeded(LoquiXmlTranslation<ObjectToRef, ObjectToRef_ErrorMask>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Notifying_Derivative_FieldIndex.RefSetter_NotNull,
                        errorMask: errorMask));
                    break;
                case "RefSetter_Singleton":
                    ...
                    ErrorMask.HandleErrorMask(
                        errorMask,
                        index: (int)TestObject_Notifying_Derivative_FieldIndex.RefSetter_Singleton,
                ...
                case "List":
                    item._List.SetIfSucceeded(ListXmlTranslation<Boolean, Exception>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Notifying_Derivative_FieldIndex.List,
                        errorMask: errorMask,
                ...
                case "RefList":
                    item._RefList.SetIfSucceeded(ListXmlTranslation<ObjectToRef, MaskItem<Exception, ObjectToRef_ErrorMask>>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Notifying_Derivative_FieldIndex.RefList,
                        errorMask: errorMask,
                ...
                case "Dict":
                    item._Dict.SetIfSucceeded(DictXmlTranslation<String, Boolean, Exception, Exception>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Notifying_Derivative_FieldIndex.Dict,
                        errorMask: errorMask,
                ...
                case "RefDict":
                    item._RefDict.SetIfSucceeded(DictXmlTranslation<ObjectToRef, ObjectToRef, MaskItem<Exception, ObjectToRef_ErrorMask>, MaskItem<Exception, ObjectToRef_ErrorMask>>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Notifying_Derivative_FieldIndex.RefDict,
                        errorMask: errorMask,
                ...
                case "KeyRefDict":
                    item._KeyRefDict.SetIfSucceeded(DictXmlTranslation<ObjectToRef, Boolean, MaskItem<Exception, ObjectToRef_ErrorMask>, Exception>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Notifying_Derivative_FieldIndex.KeyRefDict,
                        errorMask: errorMask,
                        keyTransl: (XElement r, bool dictDoMasks, out MaskItem<Exception, ObjectToRef_ErrorMask> dictSubMask) =>
                        {
                            return LoquiXmlTranslation<ObjectToRef, ObjectToRef_ErrorMask>.Instance.Parse(
                ...
                case "ValRefDict":
                    item._ValRefDict.SetIfSucceeded(DictXmlTranslation<String, ObjectToRef, Exception, MaskItem<Exception, ObjectToRef_ErrorMask>>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Notifying_Derivative_FieldIndex.ValRefDict,
                        errorMask: errorMask,
                        keyTransl: (XElement r, bool dictDoMasks, out Exception dictSubMask) =>
                        {
                            return StringXmlTranslation.Instance.Parse(
                ...
                case "DictKeyedValue":
                    item._DictKeyedValue.SetIfSucceeded(KeyedDictXmlTranslation<Int32, ObjectToRef, MaskItem<Exception, ObjectToRef_ErrorMask>>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_Notifying_Derivative_FieldIndex.DictKeyedValue,
                        errorMask: errorMask,
                        valTransl: (XElement r, bool dictDoMasks, out MaskItem<Exception, ObjectToRef_ErrorMask> dictSubMask) =>
                        {
                            return LoquiXmlTranslation<ObjectToRef, ObjectToRef_ErrorMask>.Instance.Parse(
            ...
            ITestObject_Notifying_DerivativeGetter def = null)
        {
            ...
            {
                ret = (TestObject_Notifying_Derivative)System.Activator.CreateInstance(item.GetType());
            }
            ret.CopyFieldsFrom(
                item,
                copyMask: copyMask,
        ...
        protected void SetNthObject(ushort index, object obj, NotifyingFireParameters cmds = null)
        {
            ...
            switch (enu)
            {
                case TestObject_Notifying_Derivative_FieldIndex.ByteArray:
                case TestObject_Notifying_Derivative_FieldIndex.ByteArrayNull:
                case TestObject_Notifying_Derivative_FieldIndex.ByteArrayNotNull:
                case TestObject_Notifying_Derivative_FieldIndex.ByteArraySingleton:
                ...
                case TestObject_Notifying_Derivative_FieldIndex.FilePath:
                case TestObject_Notifying_Derivative_FieldIndex.FilePathNull:
                case TestObject_Notifying_Derivative_FieldIndex.DirectoryPath:
                case TestObject_Notifying_Derivative_FieldIndex.DirectoryPathNull:
...
namespace Loqui.Tests.Internals
{
    ...
    public class TestObject_Notifying_Derivative_Registration : ILoquiRegistration
    {
        ...
        public static readonly Type GetterType = typeof(ITestObject_Notifying_DerivativeGetter);

        public static readonly Type SetterType = typeof(ITestObject_Notifying_Derivative);
        ...
        public static ushort? GetNameIndex(StringCaseAgnostic str)
        {
            ...
            {
                case "BYTEARRAY":
                    return (ushort)TestObject_Notifying_Derivative_FieldIndex.ByteArray;
                case "BYTEARRAYNULL":
                    return (ushort)TestObject_Notifying_Derivative_FieldIndex.ByteArrayNull;
                case "BYTEARRAYNOTNULL":
                    return (ushort)TestObject_Notifying_Derivative_FieldIndex.ByteArrayNotNull;
                case "BYTEARRAYSINGLETON":
                    return (ushort)TestObject_Notifying_Derivative_FieldIndex.ByteArraySingleton;
                case "BOOLN":
                ...
                case "FILEPATH":
                    return (ushort)TestObject_Notifying_Derivative_FieldIndex.FilePath;
                case "FILEPATHNULL":
                    return (ushort)TestObject_Notifying_Derivative_FieldIndex.FilePathNull;
                case "DIRECTORYPATH":
                    return (ushort)TestObject_Notifying_Derivative_FieldIndex.DirectoryPath;
                case "DIRECTORYPATHNULL":
                    return (ushort)TestObject_Notifying_Derivative_FieldIndex.DirectoryPathNull;
                case "UDOUBLEN":
    ...
    #region Extensions
    public static partial class TestObject_Notifying_DerivativeCommon
    {
            ...
            string name = null)
        {
            try
            {
                using (new ElementWrapper(writer, name ?? "Loqui.Tests.TestObject_Notifying_Derivative"))
                {
                    if (name != null)
                    {
                        writer.WriteAttributeString("type", "Loqui.Tests.TestObject_Notifying_Derivative");
                    }
                }
            }
            catch (Exception ex)
    ...
    #region Mask
    public class TestObject_Notifying_Derivative_Mask<T> : IMask<T>, IEquatable<TestObject_Notifying_Derivative_Mask<T>>
    {
        #region Ctors
        ...
        public override bool Equals(object obj)
        {
            if (!(obj is TestObject_Notifying_Derivative_Mask<T> rhs)) return false;
            return Equals(rhs);
        }

        public bool Equals(TestObject_Notifying_Derivative_Mask<T> rhs)
        {
            if (rhs == null) return false;
        ...
        protected void Translate_InternalFill<R>(TestObject_Notifying_Derivative_Mask<R> obj, Func<T, R> eval)
        {
    ...
    public class TestObject_Notifying_Derivative_ErrorMask : IErrorMask, IErrorMask<TestObject_Notifying_Derivative_ErrorMask>
    {
        #region Members
