            ...
            switch (name)
            {
                ...
                case "RefGetter_Singleton":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Notifying_Derivative_FieldIndex.RefGetter_Singleton, suberrorMask);
                        }
                    }
                    catch (Exception ex)
                    {
                        if (!doMasks) throw;
                        errorMask().SetNthException((ushort)TestObject_Notifying_Derivative_FieldIndex.RefGetter_Singleton, ex);
                    }
                    break;
                case "RefSetter":
                    try
