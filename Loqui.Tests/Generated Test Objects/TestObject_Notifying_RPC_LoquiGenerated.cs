...
namespace Loqui.Tests
{
    ...
    public partial class TestObject_Notifying_RPC : ITestObject_Notifying_RPC, ILoquiObjectSetter, INotifyPropertyChanged, IEquatable<TestObject_Notifying_RPC>
    {
        ...
        public virtual void Write_XML(Stream stream, out TestObject_Notifying_RPC_ErrorMask errorMask)
        {
        ...
        public virtual void Write_XML(string path, out TestObject_Notifying_RPC_ErrorMask errorMask)
        {
        ...
        public virtual void Write_XML(XmlWriter writer, out TestObject_Notifying_RPC_ErrorMask errorMask, string name = null)
        {
    ...
    public static class TestObject_Notifying_RPCCommon
    {
            ...
            NotifyingFireParameters? cmds)
        {
            ...
            if (copyMask?.ByteArrayNull ?? true)
            {
                ...
                when (doErrorMask)
                {
                    errorMask().SetNthException((ushort)TestObject_Notifying_RPC_FieldIndex.ByteArrayNull, ex);
                }
            }
            if (copyMask?.ByteArrayNotNull ?? true)
            {
                ...
                when (doErrorMask)
                {
                    errorMask().SetNthException((ushort)TestObject_Notifying_RPC_FieldIndex.ByteArrayNotNull, ex);
                }
            }
            ...
            if (copyMask?.FilePath ?? true)
            {
                ...
                when (doErrorMask)
                {
                    errorMask().SetNthException((ushort)TestObject_Notifying_RPC_FieldIndex.FilePath, ex);
                }
            }
            if (copyMask?.FilePathNull ?? true)
            {
                ...
                when (doErrorMask)
                {
                    errorMask().SetNthException((ushort)TestObject_Notifying_RPC_FieldIndex.FilePathNull, ex);
                }
            }
            if (copyMask?.DirectoryPath ?? true)
            {
                ...
                when (doErrorMask)
                {
                    errorMask().SetNthException((ushort)TestObject_Notifying_RPC_FieldIndex.DirectoryPath, ex);
                }
            }
            if (copyMask?.DirectoryPathNull ?? true)
            {
                ...
                when (doErrorMask)
                {
                    errorMask().SetNthException((ushort)TestObject_Notifying_RPC_FieldIndex.DirectoryPathNull, ex);
                }
            }
