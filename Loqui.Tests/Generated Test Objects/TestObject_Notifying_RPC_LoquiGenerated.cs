            ...
            switch (name)
            {
                ...
                case "UnsafeLoqui":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Notifying_RPC_FieldIndex.UnsafeLoqui, suberrorMask);
                        }
                        if (tryGet.Succeeded)
                        {
                ...
                case "UnsafeNull":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Notifying_RPC_FieldIndex.UnsafeNull, suberrorMask);
                        }
                        if (tryGet.Succeeded)
                        {
                ...
                case "WildCardLoqui":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Notifying_RPC_FieldIndex.WildCardLoqui, suberrorMask);
                        }
                        if (tryGet.Succeeded)
                        {
                ...
                case "List":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Notifying_RPC_FieldIndex.List, suberrorMask);
                        }
                ...
                case "RefList":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Notifying_RPC_FieldIndex.RefList, suberrorMask);
                        }
                        if (listTryGet.Succeeded)
                        {
...
namespace Loqui.Tests.Internals
{
    ...
    public static class TestObject_Notifying_RPCCommon
    {
            ...
            Func<TestObject_Notifying_RPC_ErrorMask> errorMask)
        {
            try
            {
                using (new ElementWrapper(writer, "Loqui.Tests.TestObject_Notifying_RPC"))
                {
                    ...
                    if (item.Dict.HasBeenSet)
                    {
                        try
                        {
                            if (item.Dict.HasBeenSet)
                            {
                                ...
                                if (errorMaskObj != null)
                                {
                                    errorMask().SetNthMask((ushort)TestObject_Notifying_RPC_FieldIndex.Dict, errorMaskObj);
                                }
                            }
                        }
                        catch (Exception ex)
                    ...
                    if (item.RefDict.HasBeenSet)
                    {
                        try
                        {
                            if (item.RefDict.HasBeenSet)
                            {
                                ...
                                if (errorMaskObj != null)
                                {
                                    errorMask().SetNthMask((ushort)TestObject_Notifying_RPC_FieldIndex.RefDict, errorMaskObj);
                                }
                            }
                        }
                        catch (Exception ex)
                    ...
                    if (item.KeyRefDict.HasBeenSet)
                    {
                        try
                        {
                            if (item.KeyRefDict.HasBeenSet)
                            {
                                ...
                                if (errorMaskObj != null)
                                {
                                    errorMask().SetNthMask((ushort)TestObject_Notifying_RPC_FieldIndex.KeyRefDict, errorMaskObj);
                                }
                            }
                        }
                        catch (Exception ex)
                    ...
                    if (item.ValRefDict.HasBeenSet)
                    {
                        try
                        {
                            if (item.ValRefDict.HasBeenSet)
                            {
                                ...
                                if (errorMaskObj != null)
                                {
                                    errorMask().SetNthMask((ushort)TestObject_Notifying_RPC_FieldIndex.ValRefDict, errorMaskObj);
                                }
                            }
                        }
                        catch (Exception ex)
                    ...
                    if (item.DictKeyedValue.HasBeenSet)
                    {
                        try
                        {
                            if (item.DictKeyedValue.HasBeenSet)
                            {
                                ...
                                if (errorMaskObj != null)
                                {
                                    errorMask().SetNthMask((ushort)TestObject_Notifying_RPC_FieldIndex.DictKeyedValue, errorMaskObj);
                                }
                            }
                        }
                        catch (Exception ex)
