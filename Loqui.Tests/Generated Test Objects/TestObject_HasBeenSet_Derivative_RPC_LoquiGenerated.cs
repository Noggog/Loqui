...
namespace Loqui.Tests
{
    ...
    public partial class TestObject_HasBeenSet_Derivative_RPC : ITestObject_HasBeenSet_Derivative_RPC, ILoquiObjectSetter, INotifyPropertyChanged, IEquatable<TestObject_HasBeenSet_Derivative_RPC>
    {
        ...
        ObjectToRef ITestObject_HasBeenSet_Derivative_RPCGetter.Ref_Singleton => this._Ref_Singleton.Item;
        ...
        IObjectToRefGetter ITestObject_HasBeenSet_Derivative_RPCGetter.RefGetter_Singleton => this._RefGetter_Singleton.Item;
        ...
        IObjectToRef ITestObject_HasBeenSet_Derivative_RPCGetter.RefSetter_Singleton => this._RefSetter_Singleton.Item;
            ...
            switch (name)
            {
                ...
                case "Unsafe":
                    try
                    {
                        ...
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Unsafe, suberrorMask);
                        }
                        if (tryGet.Succeeded)
                        {
                ...
                case "UnsafeLoqui":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.UnsafeLoqui, suberrorMask);
                        }
                        if (tryGet.Succeeded)
                        {
                    ...
                    {
                        if (!doMasks) throw;
                        errorMask().SetNthException((ushort)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.UnsafeLoqui, ex);
                    }
                    break;
                case "UnsafeNull":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.UnsafeNull, suberrorMask);
                        }
                        if (tryGet.Succeeded)
                        {
                    ...
                    {
                        if (!doMasks) throw;
                        errorMask().SetNthException((ushort)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.UnsafeNull, ex);
                    }
                    break;
                case "P2IntN":
                    try
                ...
                case "WildCard":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.WildCard, suberrorMask);
                        }
                        if (tryGet.Succeeded)
                        {
                ...
                case "WildCardLoqui":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.WildCardLoqui, suberrorMask);
                        }
                        if (tryGet.Succeeded)
                        {
                    ...
                    {
                        if (!doMasks) throw;
                        errorMask().SetNthException((ushort)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.WildCardLoqui, ex);
                    }
                    break;
                case "WildCardNull":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.WildCardNull, suberrorMask);
                        }
                        if (tryGet.Succeeded)
                        {
                    ...
                    {
                        if (!doMasks) throw;
                        errorMask().SetNthException((ushort)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.WildCardNull, ex);
                    }
                    break;
                case "Ref":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Ref, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "Ref_NotNull":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Ref_NotNull, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "Ref_Singleton":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Ref_Singleton, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "RefGetter":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RefGetter, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "RefGetter_NotNull":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RefGetter_NotNull, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "RefSetter":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RefSetter, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "RefSetter_NotNull":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RefSetter_NotNull, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "RefSetter_Singleton":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RefSetter_Singleton, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "List":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.List, suberrorMask);
                        }
                ...
                case "RefList":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RefList, suberrorMask);
                        }
                        if (listTryGet.Succeeded)
                        {
        ...
        public void Write_XML(XmlWriter writer, out TestObject_HasBeenSet_Derivative_RPC_ErrorMask errorMask, string name = null)
        {
            TestObject_HasBeenSet_Derivative_RPCCommon.Write_XML(
                writer: writer,
                name: name,
...
namespace Loqui.Tests.Internals
{
    ...
    public static class TestObject_HasBeenSet_Derivative_RPCCommon
    {
            ...
            Func<TestObject_HasBeenSet_Derivative_RPC_ErrorMask> errorMask)
        {
            try
            {
                using (new ElementWrapper(writer, "Loqui.Tests.TestObject_HasBeenSet_Derivative_RPC"))
                {
