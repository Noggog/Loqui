...
namespace Loqui.Tests
{
    ...
    public partial class TestObject_HasBeenSet_Derivative_RPC : ITestObject_HasBeenSet_Derivative_RPC, ILoquiObjectSetter, INotifyPropertyChanged, IEquatable<TestObject_HasBeenSet_Derivative_RPC>
    {
        ...
        #region Interface Members
        INotifyingKeyedCollection<Int32, ObjectToRef> ITestObject_HasBeenSet_Derivative_RPC.DictKeyedValue => _DictKeyedValue;
            ...
            switch (name)
            {
                case "ByteArray":
                    item._ByteArray.SetIfSucceeded(ByteArrayXmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.ByteArray,
                        errorMask: errorMask));
                    break;
                case "ByteArrayNull":
                    item._ByteArrayNull.SetIfSucceeded(ByteArrayXmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.ByteArrayNull,
                        errorMask: errorMask));
                    break;
                case "ByteArrayNotNull":
                    item._ByteArrayNotNull.SetIfSucceeded(ByteArrayXmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.ByteArrayNotNull,
                        errorMask: errorMask));
                    break;
                case "ByteArraySingleton":
                    item._ByteArraySingleton.SetIfSucceeded(ByteArrayXmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.ByteArraySingleton,
                        errorMask: errorMask));
                    break;
                case "BoolN":
                    item._BoolN.SetIfSucceeded(BooleanXmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.BoolN,
                        errorMask: errorMask));
                    break;
                case "Bool":
                    item._Bool.SetIfSucceeded(BooleanXmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Bool,
                        errorMask: errorMask));
                    break;
                case "CharN":
                    item._CharN.SetIfSucceeded(CharXmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.CharN,
                        errorMask: errorMask));
                    break;
                case "Char":
                    item._Char.SetIfSucceeded(CharXmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Char,
                        errorMask: errorMask));
                    break;
                case "DateTimeNull":
                    item._DateTimeNull.SetIfSucceeded(DateTimeXmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.DateTimeNull,
                        errorMask: errorMask));
                    break;
                case "DateTime":
                    item._DateTime.SetIfSucceeded(DateTimeXmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.DateTime,
                        errorMask: errorMask));
                    break;
                case "DoubleN":
                    item._DoubleN.SetIfSucceeded(DoubleXmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.DoubleN,
                        errorMask: errorMask));
                    break;
                case "DoubleN_Ranged":
                    item._DoubleN_Ranged.SetIfSucceeded(DoubleXmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.DoubleN_Ranged,
                        errorMask: errorMask));
                    break;
                case "Double":
                    item._Double.SetIfSucceeded(DoubleXmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Double,
                        errorMask: errorMask));
                    break;
                case "Double_Ranged":
                    item._Double_Ranged.SetIfSucceeded(DoubleXmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Double_Ranged,
                        errorMask: errorMask));
                    break;
                case "FloatN":
                    item._FloatN.SetIfSucceeded(FloatXmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.FloatN,
                        errorMask: errorMask));
                    break;
                case "FloatN_Ranged":
                    item._FloatN_Ranged.SetIfSucceeded(FloatXmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.FloatN_Ranged,
                        errorMask: errorMask));
                    break;
                case "Float":
                    item._Float.SetIfSucceeded(FloatXmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Float,
                        errorMask: errorMask));
                    break;
                case "Float_Ranged":
                    item._Float_Ranged.SetIfSucceeded(FloatXmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Float_Ranged,
                        errorMask: errorMask));
                    break;
                case "Int16N":
                    item._Int16N.SetIfSucceeded(Int16XmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Int16N,
                        errorMask: errorMask));
                    break;
                case "Int16N_Ranged":
                    item._Int16N_Ranged.SetIfSucceeded(Int16XmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Int16N_Ranged,
                        errorMask: errorMask));
                    break;
                case "Int16":
                    item._Int16.SetIfSucceeded(Int16XmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Int16,
                        errorMask: errorMask));
                    break;
                case "Int16_Ranged":
                    item._Int16_Ranged.SetIfSucceeded(Int16XmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Int16_Ranged,
                        errorMask: errorMask));
                    break;
                case "Int32N":
                    item._Int32N.SetIfSucceeded(Int32XmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Int32N,
                        errorMask: errorMask));
                    break;
                case "Int32N_Ranged":
                    item._Int32N_Ranged.SetIfSucceeded(Int32XmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Int32N_Ranged,
                        errorMask: errorMask));
                    break;
                case "Int32":
                    item._Int32.SetIfSucceeded(Int32XmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Int32,
                        errorMask: errorMask));
                    break;
                case "Int32_Ranged":
                    item._Int32_Ranged.SetIfSucceeded(Int32XmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Int32_Ranged,
                        errorMask: errorMask));
                    break;
                case "Int64N":
                    item._Int64N.SetIfSucceeded(Int64XmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Int64N,
                        errorMask: errorMask));
                    break;
                case "Int64N_Ranged":
                    item._Int64N_Ranged.SetIfSucceeded(Int64XmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Int64N_Ranged,
                        errorMask: errorMask));
                    break;
                case "Int64":
                    item._Int64.SetIfSucceeded(Int64XmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Int64,
                        errorMask: errorMask));
                    break;
                case "Int64_Ranged":
                    item._Int64_Ranged.SetIfSucceeded(Int64XmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Int64_Ranged,
                        errorMask: errorMask));
                    break;
                case "Int8N":
                    item._Int8N.SetIfSucceeded(Int8XmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Int8N,
                        errorMask: errorMask));
                    break;
                case "Int8N_Ranged":
                    item._Int8N_Ranged.SetIfSucceeded(Int8XmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Int8N_Ranged,
                        errorMask: errorMask));
                    break;
                case "Int8":
                    item._Int8.SetIfSucceeded(Int8XmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Int8,
                        errorMask: errorMask));
                    break;
                case "Int8_Ranged":
                    item._Int8_Ranged.SetIfSucceeded(Int8XmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Int8_Ranged,
                        errorMask: errorMask));
                    break;
                case "Unsafe":
                    item._Unsafe.SetIfSucceeded(WildcardXmlTranslation.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Unsafe,
                        errorMask: errorMask).Bubble<bool>(i => (bool)i));
                    break;
                case "UnsafeLoqui":
                    item._UnsafeLoqui.SetIfSucceeded(WildcardXmlTranslation.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.UnsafeLoqui,
                ...
                case "UnsafeNull":
                    item._UnsafeNull.SetIfSucceeded(WildcardXmlTranslation.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.UnsafeNull,
                        errorMask: errorMask).Bubble<ObjectToRef>(i => (ObjectToRef)i));
                    break;
                case "P2IntN":
                    item._P2IntN.SetIfSucceeded(P2IntXmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.P2IntN,
                        errorMask: errorMask));
                    break;
                case "P2Int":
                    item._P2Int.SetIfSucceeded(P2IntXmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.P2Int,
                        errorMask: errorMask));
                    break;
                case "P3DoubleN":
                    item._P3DoubleN.SetIfSucceeded(P3DoubleXmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.P3DoubleN,
                        errorMask: errorMask));
                    break;
                case "P3Double":
                    item._P3Double.SetIfSucceeded(P3DoubleXmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.P3Double,
                        errorMask: errorMask));
                    break;
                case "P3IntN":
                    item._P3IntN.SetIfSucceeded(P3IntXmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.P3IntN,
                        errorMask: errorMask));
                    break;
                case "P3Int":
                    item._P3Int.SetIfSucceeded(P3IntXmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.P3Int,
                        errorMask: errorMask));
                    break;
                case "PercentN":
                    item._PercentN.SetIfSucceeded(PercentXmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.PercentN,
                        errorMask: errorMask));
                    break;
                case "Percent":
                    item._Percent.SetIfSucceeded(PercentXmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Percent,
                        errorMask: errorMask));
                    break;
                case "RangeInt8N":
                    item._RangeInt8N.SetIfSucceeded(RangeInt8XmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RangeInt8N,
                        errorMask: errorMask));
                    break;
                case "RangeInt8":
                    item._RangeInt8.SetIfSucceeded(RangeInt8XmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RangeInt8,
                        errorMask: errorMask));
                    break;
                case "RangeInt16N":
                    item._RangeInt16N.SetIfSucceeded(RangeInt16XmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RangeInt16N,
                        errorMask: errorMask));
                    break;
                case "RangeInt16":
                    item._RangeInt16.SetIfSucceeded(RangeInt16XmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RangeInt16,
                        errorMask: errorMask));
                    break;
                case "RangeInt32N":
                    item._RangeInt32N.SetIfSucceeded(RangeInt32XmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RangeInt32N,
                        errorMask: errorMask));
                    break;
                case "RangeInt32":
                    item._RangeInt32.SetIfSucceeded(RangeInt32XmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RangeInt32,
                        errorMask: errorMask));
                    break;
                case "RangeInt64N":
                    item._RangeInt64N.SetIfSucceeded(RangeInt64XmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RangeInt64N,
                        errorMask: errorMask));
                    break;
                case "RangeInt64":
                    item._RangeInt64.SetIfSucceeded(RangeInt64XmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RangeInt64,
                        errorMask: errorMask));
                    break;
                case "RangeUInt8N":
                    item._RangeUInt8N.SetIfSucceeded(RangeUInt8XmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RangeUInt8N,
                        errorMask: errorMask));
                    break;
                case "RangeUInt8":
                    item._RangeUInt8.SetIfSucceeded(RangeUInt8XmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RangeUInt8,
                        errorMask: errorMask));
                    break;
                case "RangeUInt16N":
                    item._RangeUInt16N.SetIfSucceeded(RangeUInt16XmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RangeUInt16N,
                        errorMask: errorMask));
                    break;
                case "RangeUInt16":
                    item._RangeUInt16.SetIfSucceeded(RangeUInt16XmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RangeUInt16,
                        errorMask: errorMask));
                    break;
                case "RangeUInt32N":
                    item._RangeUInt32N.SetIfSucceeded(RangeUInt32XmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RangeUInt32N,
                        errorMask: errorMask));
                    break;
                case "RangeUInt32":
                    item._RangeUInt32.SetIfSucceeded(RangeUInt32XmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RangeUInt32,
                        errorMask: errorMask));
                    break;
                case "RangeUInt64N":
                    item._RangeUInt64N.SetIfSucceeded(RangeUInt64XmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RangeUInt64N,
                        errorMask: errorMask));
                    break;
                case "RangeUInt64":
                    item._RangeUInt64.SetIfSucceeded(RangeUInt64XmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RangeUInt64,
                        errorMask: errorMask));
                    break;
                case "String":
                    item._String.SetIfSucceeded(StringXmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.String,
                        errorMask: errorMask));
                    break;
                case "FilePath":
                    item._FilePath.SetIfSucceeded(FilePathXmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.FilePath,
                        errorMask: errorMask));
                    break;
                case "FilePathNull":
                    item._FilePathNull.SetIfSucceeded(FilePathXmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.FilePathNull,
                        errorMask: errorMask));
                    break;
                case "DirectoryPath":
                    item._DirectoryPath.SetIfSucceeded(DirectoryPathXmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.DirectoryPath,
                        errorMask: errorMask));
                    break;
                case "DirectoryPathNull":
                    item._DirectoryPathNull.SetIfSucceeded(DirectoryPathXmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.DirectoryPathNull,
                        errorMask: errorMask));
                    break;
                case "UDoubleN":
                    item._UDoubleN.SetIfSucceeded(UDoubleXmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.UDoubleN,
                        errorMask: errorMask));
                    break;
                case "UDoubleN_Ranged":
                    item._UDoubleN_Ranged.SetIfSucceeded(UDoubleXmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.UDoubleN_Ranged,
                        errorMask: errorMask));
                    break;
                case "UDouble":
                    item._UDouble.SetIfSucceeded(UDoubleXmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.UDouble,
                        errorMask: errorMask));
                    break;
                case "UDouble_Ranged":
                    item._UDouble_Ranged.SetIfSucceeded(UDoubleXmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.UDouble_Ranged,
                        errorMask: errorMask));
                    break;
                case "UInt16N":
                    item._UInt16N.SetIfSucceeded(UInt16XmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.UInt16N,
                        errorMask: errorMask));
                    break;
                case "UInt16N_Ranged":
                    item._UInt16N_Ranged.SetIfSucceeded(UInt16XmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.UInt16N_Ranged,
                        errorMask: errorMask));
                    break;
                case "UInt16":
                    item._UInt16.SetIfSucceeded(UInt16XmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.UInt16,
                        errorMask: errorMask));
                    break;
                case "UInt16_Ranged":
                    item._UInt16_Ranged.SetIfSucceeded(UInt16XmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.UInt16_Ranged,
                        errorMask: errorMask));
                    break;
                case "UInt32N":
                    item._UInt32N.SetIfSucceeded(UInt32XmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.UInt32N,
                        errorMask: errorMask));
                    break;
                case "UInt32N_Ranged":
                    item._UInt32N_Ranged.SetIfSucceeded(UInt32XmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.UInt32N_Ranged,
                        errorMask: errorMask));
                    break;
                case "UInt32":
                    item._UInt32.SetIfSucceeded(UInt32XmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.UInt32,
                        errorMask: errorMask));
                    break;
                case "UInt32_Ranged":
                    item._UInt32_Ranged.SetIfSucceeded(UInt32XmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.UInt32_Ranged,
                        errorMask: errorMask));
                    break;
                case "UInt64N":
                    item._UInt64N.SetIfSucceeded(UInt64XmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.UInt64N,
                        errorMask: errorMask));
                    break;
                case "UInt64N_Ranged":
                    item._UInt64N_Ranged.SetIfSucceeded(UInt64XmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.UInt64N_Ranged,
                        errorMask: errorMask));
                    break;
                case "UInt64":
                    item._UInt64.SetIfSucceeded(UInt64XmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.UInt64,
                        errorMask: errorMask));
                    break;
                case "UInt64_Ranged":
                    item._UInt64_Ranged.SetIfSucceeded(UInt64XmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.UInt64_Ranged,
                        errorMask: errorMask));
                    break;
                case "UInt8N":
                    item._UInt8N.SetIfSucceeded(ByteXmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.UInt8N,
                        errorMask: errorMask));
                    break;
                case "UInt8N_Ranged":
                    item._UInt8N_Ranged.SetIfSucceeded(ByteXmlTranslation.Instance.Parse(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.UInt8N_Ranged,
                        errorMask: errorMask));
                    break;
                case "UInt8":
                    item._UInt8.SetIfSucceeded(ByteXmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.UInt8,
                        errorMask: errorMask));
                    break;
                case "UInt8_Ranged":
                    item._UInt8_Ranged.SetIfSucceeded(ByteXmlTranslation.Instance.ParseNonNull(
                        root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.UInt8_Ranged,
                        errorMask: errorMask));
                    break;
                case "Enum":
                    item._Enum.SetIfSucceeded(EnumXmlTranslation<TestEnum>.Instance.Parse(
                        root,
                        nullable: false,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Enum,
                ...
                case "Ref_Singleton":
                    ...
                    ErrorMask.HandleErrorMask(
                        errorMask,
                        index: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Ref_Singleton,
                ...
                case "RefGetter":
                    item._RefGetter.SetIfSucceeded(LoquiXmlTranslation<ObjectToRef, ObjectToRef_ErrorMask>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RefGetter,
                        errorMask: errorMask));
                    break;
                case "RefGetter_NotNull":
                    item._RefGetter_NotNull.SetIfSucceeded(LoquiXmlTranslation<ObjectToRef, ObjectToRef_ErrorMask>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RefGetter_NotNull,
                        errorMask: errorMask));
                    break;
                ...
                case "RefSetter":
                    item._RefSetter.SetIfSucceeded(LoquiXmlTranslation<ObjectToRef, ObjectToRef_ErrorMask>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RefSetter,
                        errorMask: errorMask));
                    break;
                case "RefSetter_NotNull":
                    item._RefSetter_NotNull.SetIfSucceeded(LoquiXmlTranslation<ObjectToRef, ObjectToRef_ErrorMask>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RefSetter_NotNull,
                        errorMask: errorMask));
                    break;
                case "RefSetter_Singleton":
                    ...
                    ErrorMask.HandleErrorMask(
                        errorMask,
                        index: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RefSetter_Singleton,
                ...
                case "List":
                    item._List.SetIfSucceeded(ListXmlTranslation<Boolean, Exception>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.List,
                        errorMask: errorMask,
                ...
                case "RefList":
                    item._RefList.SetIfSucceeded(ListXmlTranslation<ObjectToRef, MaskItem<Exception, ObjectToRef_ErrorMask>>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RefList,
                        errorMask: errorMask,
                ...
                case "Dict":
                    item._Dict.SetIfSucceeded(DictXmlTranslation<String, Boolean, Exception, Exception>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.Dict,
                        errorMask: errorMask,
                ...
                case "RefDict":
                    item._RefDict.SetIfSucceeded(DictXmlTranslation<ObjectToRef, ObjectToRef, MaskItem<Exception, ObjectToRef_ErrorMask>, MaskItem<Exception, ObjectToRef_ErrorMask>>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.RefDict,
                        errorMask: errorMask,
                ...
                case "KeyRefDict":
                    item._KeyRefDict.SetIfSucceeded(DictXmlTranslation<ObjectToRef, Boolean, MaskItem<Exception, ObjectToRef_ErrorMask>, Exception>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.KeyRefDict,
                        errorMask: errorMask,
                        keyTransl: (XElement r, bool dictDoMasks, out MaskItem<Exception, ObjectToRef_ErrorMask> dictSubMask) =>
                        {
                            return LoquiXmlTranslation<ObjectToRef, ObjectToRef_ErrorMask>.Instance.Parse(
                ...
                case "ValRefDict":
                    item._ValRefDict.SetIfSucceeded(DictXmlTranslation<String, ObjectToRef, Exception, MaskItem<Exception, ObjectToRef_ErrorMask>>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.ValRefDict,
                        errorMask: errorMask,
                        keyTransl: (XElement r, bool dictDoMasks, out Exception dictSubMask) =>
                        {
                            return StringXmlTranslation.Instance.Parse(
                ...
                case "DictKeyedValue":
                    item._DictKeyedValue.SetIfSucceeded(KeyedDictXmlTranslation<Int32, ObjectToRef, MaskItem<Exception, ObjectToRef_ErrorMask>>.Instance.Parse(
                        root: root,
                        fieldIndex: (int)TestObject_HasBeenSet_Derivative_RPC_FieldIndex.DictKeyedValue,
                        errorMask: errorMask,
                        valTransl: (XElement r, bool dictDoMasks, out MaskItem<Exception, ObjectToRef_ErrorMask> dictSubMask) =>
                        {
                            return LoquiXmlTranslation<ObjectToRef, ObjectToRef_ErrorMask>.Instance.Parse(
