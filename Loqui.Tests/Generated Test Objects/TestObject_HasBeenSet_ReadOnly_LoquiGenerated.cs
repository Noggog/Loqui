            ...
            switch (name)
            {
                ...
                case "UnsafeLoqui":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_ReadOnly_FieldIndex.UnsafeLoqui, suberrorMask);
                        }
                        if (tryGet.Succeeded)
                        {
                    ...
                    {
                        if (!doMasks) throw;
                        errorMask().SetNthException((ushort)TestObject_HasBeenSet_ReadOnly_FieldIndex.UnsafeLoqui, ex);
                    }
                    break;
                case "UnsafeNull":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_ReadOnly_FieldIndex.UnsafeNull, suberrorMask);
                        }
                        if (tryGet.Succeeded)
                        {
                    ...
                    {
                        if (!doMasks) throw;
                        errorMask().SetNthException((ushort)TestObject_HasBeenSet_ReadOnly_FieldIndex.UnsafeNull, ex);
                    }
                    break;
                case "P2IntN":
                    try
                ...
                case "WildCardLoqui":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_HasBeenSet_ReadOnly_FieldIndex.WildCardLoqui, suberrorMask);
                        }
                        if (tryGet.Succeeded)
                        {
                    ...
                    {
                        if (!doMasks) throw;
                        errorMask().SetNthException((ushort)TestObject_HasBeenSet_ReadOnly_FieldIndex.WildCardLoqui, ex);
                    }
                    break;
                case "WildCardNull":
                    try
...
namespace Loqui.Tests.Internals
{
    ...
    public static class TestObject_HasBeenSet_ReadOnlyCommon
    {
            ...
            Func<TestObject_HasBeenSet_ReadOnly_ErrorMask> errorMask)
        {
            try
            {
                using (new ElementWrapper(writer, "Loqui.Tests.TestObject_HasBeenSet_ReadOnly"))
                {
                    ...
                    if (item.Dict.HasBeenSet)
                    {
                        try
                        {
                            if (item.Dict.HasBeenSet)
                            {
                                ...
                                if (errorMaskObj != null)
                                {
                                    errorMask().SetNthMask((ushort)TestObject_HasBeenSet_ReadOnly_FieldIndex.Dict, errorMaskObj);
                                }
                            }
                        }
                        catch (Exception ex)
                    ...
                    if (item.RefDict.HasBeenSet)
                    {
                        try
                        {
                            if (item.RefDict.HasBeenSet)
                            {
                                ...
                                if (errorMaskObj != null)
                                {
                                    errorMask().SetNthMask((ushort)TestObject_HasBeenSet_ReadOnly_FieldIndex.RefDict, errorMaskObj);
                                }
                            }
                        }
                        catch (Exception ex)
                    ...
                    if (item.KeyRefDict.HasBeenSet)
                    {
                        try
                        {
                            if (item.KeyRefDict.HasBeenSet)
                            {
                                ...
                                if (errorMaskObj != null)
                                {
                                    errorMask().SetNthMask((ushort)TestObject_HasBeenSet_ReadOnly_FieldIndex.KeyRefDict, errorMaskObj);
                                }
                            }
                        }
                        catch (Exception ex)
                    ...
                    if (item.ValRefDict.HasBeenSet)
                    {
                        try
                        {
                            if (item.ValRefDict.HasBeenSet)
                            {
                                ...
                                if (errorMaskObj != null)
                                {
                                    errorMask().SetNthMask((ushort)TestObject_HasBeenSet_ReadOnly_FieldIndex.ValRefDict, errorMaskObj);
                                }
                            }
                        }
                        catch (Exception ex)
                    ...
                    if (item.DictKeyedValue.HasBeenSet)
                    {
                        try
                        {
                            if (item.DictKeyedValue.HasBeenSet)
                            {
                                ...
                                if (errorMaskObj != null)
                                {
                                    errorMask().SetNthMask((ushort)TestObject_HasBeenSet_ReadOnly_FieldIndex.DictKeyedValue, errorMaskObj);
                                }
                            }
                        }
                        catch (Exception ex)
