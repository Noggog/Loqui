...
namespace Loqui.Tests
{
    ...
    public partial class TestObject_ReadOnly : ITestObject_ReadOnly, ILoquiObjectSetter, IEquatable<TestObject_ReadOnly>
    {
        ...
        {
            if (!root.Name.LocalName.Equals("Loqui.Tests.TestObject_ReadOnly"))
            {
                var ex = new ArgumentException($"Skipping field that did not match proper type. Type: {root.Name.LocalName}, expected: Loqui.Tests.TestObject_ReadOnly.");
                if (!doMasks) throw ex;
            ...
            switch (name)
            {
                ...
                case "UnsafeLoqui":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_ReadOnly_FieldIndex.UnsafeLoqui, suberrorMask);
                        }
                        if (tryGet.Succeeded)
                        {
                    ...
                    {
                        if (!doMasks) throw;
                        errorMask().SetNthException((ushort)TestObject_ReadOnly_FieldIndex.UnsafeLoqui, ex);
                    }
                    break;
                case "UnsafeNull":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_ReadOnly_FieldIndex.UnsafeNull, suberrorMask);
                        }
                        if (tryGet.Succeeded)
                        {
                    ...
                    {
                        if (!doMasks) throw;
                        errorMask().SetNthException((ushort)TestObject_ReadOnly_FieldIndex.UnsafeNull, ex);
                    }
                    break;
                case "P2IntN":
                    try
                ...
                case "EnumNull":
                    ...
                    {
                        if (!doMasks) throw;
                        errorMask().SetNthException((ushort)TestObject_ReadOnly_FieldIndex.EnumNull, ex);
                    }
                    break;
                case "WildCard":
                    try
                ...
                case "WildCardLoqui":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_ReadOnly_FieldIndex.WildCardLoqui, suberrorMask);
                        }
                        if (tryGet.Succeeded)
                        {
                    ...
                    {
                        if (!doMasks) throw;
                        errorMask().SetNthException((ushort)TestObject_ReadOnly_FieldIndex.WildCardLoqui, ex);
                    }
                    break;
                case "WildCardNull":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_ReadOnly_FieldIndex.WildCardNull, suberrorMask);
                        }
                        if (tryGet.Succeeded)
                        {
                    ...
                    {
                        if (!doMasks) throw;
                        errorMask().SetNthException((ushort)TestObject_ReadOnly_FieldIndex.WildCardNull, ex);
                    }
                    break;
                case "Ref":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_ReadOnly_FieldIndex.Ref, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "Ref_NotNull":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_ReadOnly_FieldIndex.Ref_NotNull, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "Ref_Singleton":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_ReadOnly_FieldIndex.Ref_Singleton, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "RefGetter":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_ReadOnly_FieldIndex.RefGetter, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "RefGetter_NotNull":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_ReadOnly_FieldIndex.RefGetter_NotNull, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "RefSetter":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_ReadOnly_FieldIndex.RefSetter, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "RefSetter_NotNull":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_ReadOnly_FieldIndex.RefSetter_NotNull, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "RefSetter_Singleton":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_ReadOnly_FieldIndex.RefSetter_Singleton, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
...
namespace Loqui.Tests.Internals
{
    ...
    public static class TestObject_ReadOnlyCommon
    {
            ...
            Func<TestObject_ReadOnly_ErrorMask> errorMask)
        {
            try
            {
                using (new ElementWrapper(writer, "Loqui.Tests.TestObject_ReadOnly"))
                {
                    ...
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_ReadOnly_FieldIndex.RefGetter_Singleton, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                    ...
                    try
                    {
                        ...
                        if (errorMaskObj != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_ReadOnly_FieldIndex.Dict, errorMaskObj);
                        }
                    }
                    catch (Exception ex)
                    {
                    ...
                    try
                    {
                        ...
                        if (errorMaskObj != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_ReadOnly_FieldIndex.RefDict, errorMaskObj);
                        }
                    }
                    catch (Exception ex)
                    {
                    ...
                    try
                    {
                        ...
                        if (errorMaskObj != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_ReadOnly_FieldIndex.KeyRefDict, errorMaskObj);
                        }
                    }
                    catch (Exception ex)
                    {
                    ...
                    try
                    {
                        ...
                        if (errorMaskObj != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_ReadOnly_FieldIndex.ValRefDict, errorMaskObj);
                        }
                    }
                    catch (Exception ex)
                    {
                    ...
                    try
                    {
                        ...
                        if (errorMaskObj != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_ReadOnly_FieldIndex.DictKeyedValue, errorMaskObj);
                        }
                    }
                    catch (Exception ex)
                    {
