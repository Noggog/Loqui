            ...
            switch (name)
            {
                ...
                case "List":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_ReadOnly_FieldIndex.List, suberrorMask);
                        }
                ...
                case "RefList":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_ReadOnly_FieldIndex.RefList, suberrorMask);
                        }
                        if (listTryGet.Succeeded)
                        {
