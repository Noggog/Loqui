...
namespace Loqui.Tests
{
    ...
    public partial class TestObject_Notifying : ITestObject_Notifying, ILoquiObjectSetter, IEquatable<TestObject_Notifying>
    {
        ...
        {
            if (!root.Name.LocalName.Equals("Loqui.Tests.TestObject_Notifying"))
            {
                var ex = new ArgumentException($"Skipping field that did not match proper type. Type: {root.Name.LocalName}, expected: Loqui.Tests.TestObject_Notifying.");
                if (!doMasks) throw ex;
            ...
            switch (name)
            {
                ...
                case "UnsafeLoqui":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Notifying_FieldIndex.UnsafeLoqui, suberrorMask);
                        }
                        if (tryGet.Succeeded)
                        {
                ...
                case "UnsafeNull":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Notifying_FieldIndex.UnsafeNull, suberrorMask);
                        }
                        if (tryGet.Succeeded)
                        {
                ...
                case "WildCardLoqui":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Notifying_FieldIndex.WildCardLoqui, suberrorMask);
                        }
                        if (tryGet.Succeeded)
                        {
                ...
                case "WildCardNull":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Notifying_FieldIndex.WildCardNull, suberrorMask);
                        }
                        if (tryGet.Succeeded)
                        {
                ...
                case "Ref":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Notifying_FieldIndex.Ref, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "Ref_NotNull":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Notifying_FieldIndex.Ref_NotNull, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "Ref_Singleton":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Notifying_FieldIndex.Ref_Singleton, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "RefGetter":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Notifying_FieldIndex.RefGetter, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "RefGetter_NotNull":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Notifying_FieldIndex.RefGetter_NotNull, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "RefSetter":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Notifying_FieldIndex.RefSetter, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "RefSetter_NotNull":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Notifying_FieldIndex.RefSetter_NotNull, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "RefSetter_Singleton":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Notifying_FieldIndex.RefSetter_Singleton, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "List":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Notifying_FieldIndex.List, suberrorMask);
                        }
                ...
                case "RefList":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Notifying_FieldIndex.RefList, suberrorMask);
                        }
                        if (listTryGet.Succeeded)
                        {
...
namespace Loqui.Tests.Internals
{
    ...
    public static class TestObject_NotifyingCommon
    {
            ...
            Func<TestObject_Notifying_ErrorMask> errorMask)
        {
            try
            {
                using (new ElementWrapper(writer, "Loqui.Tests.TestObject_Notifying"))
                {
                    ...
                    if (item.RefGetter_Singleton_Property.HasBeenSet)
                    {
                        try
                        {
                            if (item.RefGetter_Singleton_Property.HasBeenSet)
                            {
                                ...
                                if (suberrorMask != null)
                                {
                                    errorMask().SetNthMask((ushort)TestObject_Notifying_FieldIndex.RefGetter_Singleton, new MaskItem<Exception, ObjectToRef_ErrorMask>(null, suberrorMask));
                                }
                            }
                        }
                        catch (Exception ex)
                    ...
                    if (item.Dict.HasBeenSet)
                    {
                        try
                        {
                            if (item.Dict.HasBeenSet)
                            {
                                ...
                                if (errorMaskObj != null)
                                {
                                    errorMask().SetNthMask((ushort)TestObject_Notifying_FieldIndex.Dict, errorMaskObj);
                                }
                            }
                        }
                        catch (Exception ex)
                    ...
                    if (item.RefDict.HasBeenSet)
                    {
                        try
                        {
                            if (item.RefDict.HasBeenSet)
                            {
                                ...
                                if (errorMaskObj != null)
                                {
                                    errorMask().SetNthMask((ushort)TestObject_Notifying_FieldIndex.RefDict, errorMaskObj);
                                }
                            }
                        }
                        catch (Exception ex)
                    ...
                    if (item.KeyRefDict.HasBeenSet)
                    {
                        try
                        {
                            if (item.KeyRefDict.HasBeenSet)
                            {
                                ...
                                if (errorMaskObj != null)
                                {
                                    errorMask().SetNthMask((ushort)TestObject_Notifying_FieldIndex.KeyRefDict, errorMaskObj);
                                }
                            }
                        }
                        catch (Exception ex)
                    ...
                    if (item.ValRefDict.HasBeenSet)
                    {
                        try
                        {
                            if (item.ValRefDict.HasBeenSet)
                            {
                                ...
                                if (errorMaskObj != null)
                                {
                                    errorMask().SetNthMask((ushort)TestObject_Notifying_FieldIndex.ValRefDict, errorMaskObj);
                                }
                            }
                        }
                        catch (Exception ex)
                    ...
                    if (item.DictKeyedValue.HasBeenSet)
                    {
                        try
                        {
                            if (item.DictKeyedValue.HasBeenSet)
                            {
                                ...
                                if (errorMaskObj != null)
                                {
                                    errorMask().SetNthMask((ushort)TestObject_Notifying_FieldIndex.DictKeyedValue, errorMaskObj);
                                }
                            }
                        }
                        catch (Exception ex)
    ...
    #region Mask
    public class TestObject_Notifying_Mask<T> : IMask<T>
    {
        #region Ctors
