            ...
            switch (name)
            {
                ...
                case "Dict":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Notifying_ReadOnly_FieldIndex.Dict, suberrorMask);
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "RefDict":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Notifying_ReadOnly_FieldIndex.RefDict, suberrorMask);
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "KeyRefDict":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Notifying_ReadOnly_FieldIndex.KeyRefDict, suberrorMask);
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "ValRefDict":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Notifying_ReadOnly_FieldIndex.ValRefDict, suberrorMask);
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "DictKeyedValue":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Notifying_ReadOnly_FieldIndex.DictKeyedValue, suberrorMask);
                        }
                    }
                    catch (Exception ex)
                    {
...
namespace Loqui.Tests.Internals
{
    ...
    public static class TestObject_Notifying_ReadOnlyCommon
    {
            ...
            Func<TestObject_Notifying_ReadOnly_ErrorMask> errorMask)
        {
            try
            {
                using (new ElementWrapper(writer, nameof(TestObject_Notifying_ReadOnly)))
                {
