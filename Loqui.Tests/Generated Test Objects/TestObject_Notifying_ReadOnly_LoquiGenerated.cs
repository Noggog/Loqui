            ...
            switch (name)
            {
                ...
                case "Ref_Singleton":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Notifying_ReadOnly_FieldIndex.Ref_Singleton, suberrorMask);
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "RefSetter_Singleton":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Notifying_ReadOnly_FieldIndex.RefSetter_Singleton, suberrorMask);
                        }
                    }
                    catch (Exception ex)
                    {
                    ...
                    if (item.RefGetter_Singleton_Property.HasBeenSet)
                    {
                        try
                        {
                            if (item.RefGetter_Singleton_Property.HasBeenSet)
                            {
                                ...
                                if (suberrorMask != null)
                                {
                                    errorMask().SetNthMask((ushort)TestObject_Notifying_ReadOnly_FieldIndex.RefGetter_Singleton, suberrorMask);
                                }
                            }
                        }
                        catch (Exception ex)
