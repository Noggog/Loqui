            ...
            switch (name)
            {
                ...
                case "List":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Derivative_FieldIndex.List, suberrorMask);
                        }
                ...
                case "RefList":
                    try
                    {
                        ...
                        if (suberrorMask != null)
                        {
                            errorMask().SetNthMask((ushort)TestObject_Derivative_FieldIndex.RefList, suberrorMask);
                        }
                        if (listTryGet.Succeeded)
                        {
