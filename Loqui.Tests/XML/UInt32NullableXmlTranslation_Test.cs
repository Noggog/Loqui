...
{
    public class UInt32NullableXmlTranslation_Test : TypicalXmlTranslation_Test<UInt32?, UInt32NullableXmlTranslation_Test>
    {
        ...
        public override IXmlTranslation<UInt32?> GetTranslation()
        {
