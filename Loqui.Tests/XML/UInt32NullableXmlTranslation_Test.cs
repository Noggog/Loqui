...
{
    public class UInt32NullableXmlTranslation_Test : TypicalXmlTranslation_Test<UInt32?, Exception, UInt32NullableXmlTranslation_Test>
    {
        ...
        public override string ExpectedName => "UInt32N";

        public override IXmlTranslation<UInt32?, Exception> GetTranslation()
        {
            return new UInt32XmlTranslation();
        }
