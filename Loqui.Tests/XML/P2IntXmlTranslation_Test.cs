...
{
    public class P2IntXmlTranslation_Test : TypicalXmlTranslation_Test<P2Int, Exception, P2IntXmlTranslation_Test>
    {
        ...
        public override string ExpectedName => "P2Int";

        public override IXmlTranslation<P2Int, Exception> GetTranslation()
        {
