...
{
    public class DoubleNullableXmlTranslation_Test : TypicalXmlTranslation_Test<double?, Exception, DoubleNullableXmlTranslation_Test>
    {
        ...
        public override string ExpectedName => "DoubleN";

        public override IXmlTranslation<double?, Exception> GetTranslation()
        {
