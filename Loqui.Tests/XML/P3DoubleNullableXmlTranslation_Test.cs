...
{
    public class P3DoubleNullableXmlTranslation_Test : TypicalXmlTranslation_Test<P3Double?, Exception, P3DoubleNullableXmlTranslation_Test>
    {
        ...
        public override string ExpectedName => "P3DoubleN";

        public override IXmlTranslation<P3Double?, Exception> GetTranslation()
        {
