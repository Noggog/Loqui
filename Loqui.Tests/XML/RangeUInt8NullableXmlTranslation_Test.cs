...
{
    public class RangeUInt8NullableXmlTranslation_Test : TypicalXmlTranslation_Test<RangeUInt8?, Exception, RangeUInt8NullableXmlTranslation_Test>
    {
        public static readonly RangeUInt8 TYPICAL_VALUE = new RangeUInt8(5, 97);
        public override RangeUInt8? TypicalValue => TYPICAL_VALUE;
        public static readonly RangeUInt8 ZERO_VALUE = new RangeUInt8(0, 0);
        public const string MIN = "Min";
        public const string MAX = "Max";

        public override string ExpectedName => "RangeUInt8N";

        public override IXmlTranslation<RangeUInt8?, Exception> GetTranslation()
        {
            return new RangeUInt8XmlTranslation();
        }

        public override XElement GetTypicalElement(RangeUInt8? value, string name = null)
        {
