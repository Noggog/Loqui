...
{
    public class RangeUInt8NullableXmlTranslation_Test : TypicalXmlTranslation_Test<RangeUInt8?, RangeUInt8NullableXmlTranslation_Test>
    {
        ...
        public override IXmlTranslation<RangeUInt8?> GetTranslation()
        {
