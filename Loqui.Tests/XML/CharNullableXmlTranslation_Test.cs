...
{
    public class CharNullableXmlTranslation_Test : TypicalXmlTranslation_Test<char?, Exception, CharNullableXmlTranslation_Test>
    {
        public const char TYPICAL_VALUE = 'i';
        public override char? TypicalValue => TYPICAL_VALUE;

        public override string ExpectedName => "CharN";

        public override IXmlTranslation<char?, Exception> GetTranslation()
        {
