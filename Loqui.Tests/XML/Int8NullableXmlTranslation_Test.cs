...
{
    public class Int8NullableXmlTranslation_Test : TypicalXmlTranslation_Test<sbyte?, Int8NullableXmlTranslation_Test>
    {
        ...
        public override IXmlTranslation<sbyte?> GetTranslation()
        {
