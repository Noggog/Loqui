...
{
    public class RangeUInt64XmlTranslation_Test : TypicalXmlTranslation_Test<RangeUInt64, Exception, RangeUInt64XmlTranslation_Test>
    {
        ...
        public override string ExpectedName => "RangeUInt64";

        public override IXmlTranslation<RangeUInt64, Exception> GetTranslation()
        {
