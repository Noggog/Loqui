...
{
    public class RangeInt8XmlTranslation_Test : TypicalXmlTranslation_Test<RangeInt8, Exception, RangeInt8XmlTranslation_Test>
    {
        public static readonly RangeInt8 TYPICAL_VALUE = new RangeInt8(5, 97);
        public override RangeInt8 TypicalValue => TYPICAL_VALUE;
        ...
        public override string ExpectedName => "RangeInt8";

        public override IXmlTranslation<RangeInt8, Exception> GetTranslation()
        {
