...
{
    public class Int64NullableXmlTranslation_Test : TypicalXmlTranslation_Test<Int64?, Int64NullableXmlTranslation_Test>
    {
        ...
        public override IXmlTranslation<Int64?> GetTranslation()
        {
