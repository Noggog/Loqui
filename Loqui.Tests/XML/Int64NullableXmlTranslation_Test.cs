...
{
    public class Int64NullableXmlTranslation_Test : TypicalXmlTranslation_Test<Int64?, Exception, Int64NullableXmlTranslation_Test>
    {
        public const Int64 TYPICAL_VALUE = 4;
        public override Int64? TypicalValue => TYPICAL_VALUE;
        public const Int64 NEGATIVE_VALUE = -4;
        public const Int64 MIN_VALUE = Int64.MinValue;
        public const Int64 MAX_VALUE = Int64.MaxValue;

        public override string ExpectedName => "Int64N";

        public override IXmlTranslation<Int64?, Exception> GetTranslation()
        {
            return new Int64XmlTranslation();
        }
