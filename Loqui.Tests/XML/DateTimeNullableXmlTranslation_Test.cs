...
{
    public class DateTimeNullableXmlTranslation_Test : TypicalXmlTranslation_Test<DateTime?, DateTimeNullableXmlTranslation_Test>
    {
        ...
        public override string ExpectedName => "DateTimeN";

        public override IXmlTranslation<DateTime?> GetTranslation()
        {
        ...
        public override string StringConverter(DateTime? item)
        {
            ...
            return item.Value.ToString(@"MM/dd/yyyy HH:mm:ss.fffffff");
        }
