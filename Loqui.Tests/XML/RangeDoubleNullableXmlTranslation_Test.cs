...
{
    public class RangeDoubleNullableXmlTranslation_Test : TypicalXmlTranslation_Test<RangeDouble?, Exception, RangeDoubleNullableXmlTranslation_Test>
    {
        public static readonly RangeDouble TYPICAL_VALUE = new RangeDouble(0.456, 7994);
        public override RangeDouble? TypicalValue => TYPICAL_VALUE;
        ...
        public override string ExpectedName => "RangeDoubleN";

        public override IXmlTranslation<RangeDouble?, Exception> GetTranslation()
        {
