...
{
    public class RangeUInt8XmlTranslation_Test : TypicalXmlTranslation_Test<RangeUInt8, Exception, RangeUInt8XmlTranslation_Test>
    {
        ...
        public override string ExpectedName => "RangeUInt8";
