...
{
    public class RangeInt16XmlTranslation_Test : TypicalXmlTranslation_Test<RangeInt16, Exception, RangeInt16XmlTranslation_Test>
    {
        ...
        public override string ExpectedName => "RangeInt16";
