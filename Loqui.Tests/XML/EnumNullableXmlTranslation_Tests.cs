...
{
    public class EnumNullableXmlTranslation_Tests : TypicalXmlTranslation_Test<TestEnum?, EnumNullableXmlTranslation_Tests>
    {
        ...
        public override IXmlTranslation<TestEnum?> GetTranslation()
        {
