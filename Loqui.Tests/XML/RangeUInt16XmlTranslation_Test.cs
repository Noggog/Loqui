...
{
    public class RangeUInt16XmlTranslation_Test : TypicalXmlTranslation_Test<RangeUInt16, Exception, RangeUInt16XmlTranslation_Test>
    {
        ...
        public override string ExpectedName => "RangeUInt16";
