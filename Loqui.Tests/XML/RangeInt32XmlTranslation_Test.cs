...
{
    public class RangeInt32XmlTranslation_Test : TypicalXmlTranslation_Test<RangeInt32, Exception, RangeInt32XmlTranslation_Test>
    {
        ...
        public override string ExpectedName => "RangeInt32";
