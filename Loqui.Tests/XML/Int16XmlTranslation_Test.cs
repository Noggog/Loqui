...
{
    public class Int16XmlTranslation_Test : TypicalXmlTranslation_Test<Int16, Exception, Int16XmlTranslation_Test>
    {
        public const Int16 TYPICAL_VALUE = 4;
        public override Int16 TypicalValue => TYPICAL_VALUE;
        ...
        public override string ExpectedName => "Int16";

        public override IXmlTranslation<Int16, Exception> GetTranslation()
        {
