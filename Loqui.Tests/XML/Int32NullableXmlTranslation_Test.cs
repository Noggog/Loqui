...
{
    public class Int32NullableXmlTranslation_Test : TypicalXmlTranslation_Test<Int32?, Exception, Int32NullableXmlTranslation_Test>
    {
        ...
        public override IXmlTranslation<Int32?, Exception> GetTranslation() => new Int32XmlTranslation();
