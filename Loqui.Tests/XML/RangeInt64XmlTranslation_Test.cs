...
{
    public class RangeInt64XmlTranslation_Test : TypicalXmlTranslation_Test<RangeInt64, RangeInt64XmlTranslation_Test>
    {
        ...
        public override string ExpectedName => "RangeInt64";

        public override IXmlTranslation<RangeInt64> GetTranslation()
        {
