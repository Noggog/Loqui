...
{
    public class RangeUInt16NullableXmlTranslation_Test : TypicalXmlTranslation_Test<RangeUInt16?, Exception, RangeUInt16NullableXmlTranslation_Test>
    {
        ...
        public override string ExpectedName => "RangeUInt16N";

        public override IXmlTranslation<RangeUInt16?, Exception> GetTranslation()
        {
            return new RangeUInt16XmlTranslation();
        }

        public override XElement GetTypicalElement(RangeUInt16? value, string name = null)
        {
