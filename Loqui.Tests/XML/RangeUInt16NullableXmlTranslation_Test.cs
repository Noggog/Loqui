...
{
    public class RangeUInt16NullableXmlTranslation_Test : TypicalXmlTranslation_Test<RangeUInt16?, RangeUInt16NullableXmlTranslation_Test>
    {
        ...
        public override IXmlTranslation<RangeUInt16?> GetTranslation()
        {
