...
{
    public class RangeInt32NullableXmlTranslation_Test : TypicalXmlTranslation_Test<RangeInt32?, Exception, RangeInt32NullableXmlTranslation_Test>
    {
        ...
        public override string ExpectedName => "RangeInt32N";

        public override IXmlTranslation<RangeInt32?, Exception> GetTranslation()
        {
            return new RangeInt32XmlTranslation();
        }
