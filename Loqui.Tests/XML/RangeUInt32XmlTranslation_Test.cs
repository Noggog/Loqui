...
{
    public class RangeUInt32XmlTranslation_Test : TypicalXmlTranslation_Test<RangeUInt32, Exception, RangeUInt32XmlTranslation_Test>
    {
        ...
        public override string ExpectedName => "RangeUInt32";
