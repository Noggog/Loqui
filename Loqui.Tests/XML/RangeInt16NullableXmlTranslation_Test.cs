...
{
    public class RangeInt16NullableXmlTranslation_Test : TypicalXmlTranslation_Test<RangeInt16?, RangeInt16NullableXmlTranslation_Test>
    {
        ...
        public override IXmlTranslation<RangeInt16?> GetTranslation()
        {
