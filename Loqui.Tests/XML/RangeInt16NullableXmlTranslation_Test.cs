...
{
    public class RangeInt16NullableXmlTranslation_Test : TypicalXmlTranslation_Test<RangeInt16?, Exception, RangeInt16NullableXmlTranslation_Test>
    {
        public static readonly RangeInt16 TYPICAL_VALUE = new RangeInt16(5, 7994);
        public override RangeInt16? TypicalValue => TYPICAL_VALUE;
        public static readonly RangeInt16 ZERO_VALUE = new RangeInt16(0, 0);
        public static readonly RangeInt16 NEGATIVE_VALUE = new RangeInt16(-67, -6);
        public const string MIN = "Min";
        public const string MAX = "Max";

        public override string ExpectedName => "RangeInt16N";

        public override IXmlTranslation<RangeInt16?, Exception> GetTranslation()
        {
            return new RangeInt16XmlTranslation();
        }

        public override XElement GetTypicalElement(RangeInt16? value, string name = null)
        {
