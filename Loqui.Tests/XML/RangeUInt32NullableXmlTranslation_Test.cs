...
{
    public class RangeUInt32NullableXmlTranslation_Test : TypicalXmlTranslation_Test<RangeUInt32?, RangeUInt32NullableXmlTranslation_Test>
    {
        ...
        public override IXmlTranslation<RangeUInt32?> GetTranslation()
        {
