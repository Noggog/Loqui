...
{
    public class UInt32XmlTranslation_Test : TypicalXmlTranslation_Test<UInt32, Exception, UInt32XmlTranslation_Test>
    {
        ...
        public override string ExpectedName => "UInt32";
